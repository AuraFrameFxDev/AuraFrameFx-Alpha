...
class AiContentApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun generateText(generateTextRequest: GenerateTextRequest) : GenerateTextResponse {
        val localVarResponse = generateTextWithHttpInfo(generateTextRequest = generateTextRequest)
    ...
    fun generateTextWithHttpInfo(generateTextRequest: GenerateTextRequest) : ApiResponse<GenerateTextResponse?> {
        val localVariableConfig = generateTextRequestConfig(generateTextRequest = generateTextRequest)
    ...
    /**
     * To obtain the request config of the operation generateText
     *
     * @param generateTextRequest 
     * @return RequestConfig
     */
    fun generateTextRequestConfig(generateTextRequest: GenerateTextRequest) : RequestConfig<GenerateTextRequest> {
