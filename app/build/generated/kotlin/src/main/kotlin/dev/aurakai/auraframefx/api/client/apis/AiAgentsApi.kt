...
class AiAgentsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun processAgentRequest(agentType: AgentType, agentProcessRequest: AgentProcessRequest) : AgentMessage {
        val localVarResponse = processAgentRequestWithHttpInfo(agentType = agentType, agentProcessRequest = agentProcessRequest)
    ...
    fun processAgentRequestWithHttpInfo(agentType: AgentType, agentProcessRequest: AgentProcessRequest) : ApiResponse<AgentMessage?> {
        val localVariableConfig = processAgentRequestRequestConfig(agentType = agentType, agentProcessRequest = agentProcessRequest)
    ...
    /**
     * To obtain the request config of the operation processAgentRequest
     *
     * @param agentType Type of AI agent to interact with
     * @param agentProcessRequest 
     * @return RequestConfig
     */
    fun processAgentRequestRequestConfig(agentType: AgentType, agentProcessRequest: AgentProcessRequest) : RequestConfig<AgentProcessRequest> {
