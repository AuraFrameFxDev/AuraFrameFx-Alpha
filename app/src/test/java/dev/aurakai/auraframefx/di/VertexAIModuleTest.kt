...
class VertexAIModuleTest {
    ...
    inner class GenerativeModelProviderTests {
        ...
        fun shouldHandleVariousValidModelNames() {
            // Given
            val vertexAI = mockVertexAI
            val modelNames = listOf("gemini-1.5-flash", "gemini-pro", "gemini-pro-vision", "text-bison")
    ...
    inner class GenerationConfigProviderTests {
        ...
        fun shouldProvideGenerationConfigWithCustomParameters() {
            ...
            // When
            val result = vertexAIModule.provideGenerationConfig(temperature, maxOutputTokens, topP, topK)
    ...
    inner class PerformanceTests {
        ...
        fun shouldCreateVertexAIInstanceWithinReasonableTime() {
            ...
            assertTrue(duration < 5000, "VertexAI creation should take less than 5 seconds, took ${duration}ms")
        }
        ...
        fun shouldHandleRepeatedCallsEfficiently() {
            ...
            assertTrue(averageTime < 100, "Average creation time should be less than 100ms, was ${averageTime}ms")
        }
    }
    ...
    inner class ConfigurationValidationTests {
        ...
        fun shouldValidateProjectIdFormat() {
            // Given
            val validProjectIds = listOf("test-project-123", "my-project", "project123", "test_project")
        ...
        fun shouldValidateLocationFormat() {
            // Given
            val validLocations = listOf("us-central1", "us-east1", "europe-west1", "asia-southeast1")
