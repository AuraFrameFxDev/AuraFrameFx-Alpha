 ...
 * Displays the Oracle Drive control screen, providing UI controls and status information for managing the Oracle Drive service.
 *
 * This composable allows users to view connection and service status, inspect diagnostics logs, refresh the service state, and enable or disable modules by package name. UI elements are enabled or disabled based on connection and loading states, and error messages are shown when actions fail.
 *
 * @param viewModel The ViewModel providing Oracle Drive control state and actions. Defaults to the current Compose ViewModel instance.
 */
@Composable
