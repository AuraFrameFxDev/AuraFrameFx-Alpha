 ...
 */
/**
 * Displays the Oracle Drive control screen for monitoring and managing the Oracle Drive service.
 *
 * Provides UI elements to view service connection status, refresh service state, inspect diagnostics logs,
 * and enable or disable modules by package name. The screen reflects real-time service state and handles
 * user actions asynchronously, displaying loading indicators and error messages as needed.
 *
 * @param viewModel The ViewModel providing service state and actions for the Oracle Drive control UI.
 */
@Composable
