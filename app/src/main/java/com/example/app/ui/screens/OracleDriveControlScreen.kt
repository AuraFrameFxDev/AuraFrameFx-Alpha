 ...
 * Displays the Oracle Drive control screen, providing UI controls and status information for managing the Oracle Drive service.
 *
 * The screen shows service connection status, current and detailed status, diagnostics log, and allows enabling or disabling modules by package name. It handles service binding and unbinding based on lifecycle, displays loading and error states, and interacts with the provided ViewModel for all service operations.
 *
