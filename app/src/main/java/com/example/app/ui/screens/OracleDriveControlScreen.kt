 ...
 * Displays the Oracle Drive control screen, providing UI controls and status information for managing the Oracle Drive service.
 *
 * This composable shows the service connection status, current and detailed service status, diagnostics log, and allows enabling or disabling modules by package name. It manages service binding and unbinding based on lifecycle events and displays error messages for failed operations.
 *
