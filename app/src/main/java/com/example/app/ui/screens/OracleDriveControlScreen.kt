 ...
 * Displays the Oracle Drive control screen, providing UI controls and status information for managing the Oracle Drive service.
 *
 * This composable shows the service connection status, current and detailed status, diagnostics log, and allows enabling or disabling modules by package name. It handles service binding and unbinding based on lifecycle, displays loading and error states, and enables user actions such as refreshing status and toggling modules.
 *
 * @param viewModel The ViewModel that manages Oracle Drive service state and actions.
 */
@Composable
