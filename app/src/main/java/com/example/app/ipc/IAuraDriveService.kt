 ...
 *
 * The returned string contains diagnostic or monitoring information about the current state of the service.
 *
...
override fun getDetailedInternalStatus(): String = "Not implemented"
                        /**
 * Retrieves an empty list of diagnostic log entries, as this stub does not provide diagnostics information.
 *
