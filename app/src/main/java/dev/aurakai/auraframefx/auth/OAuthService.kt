...
class OAuthService(
     ...
     *
     * @return An intent for starting the OAuth sign-in process, or null if not implemented.
     */
     ...
     *
     * @param _data The intent data returned from the sign-in activity, typically containing authentication information.
     ...
     *
     * @return A result object representing the outcome of the sign-out operation, or `null` if not implemented.
     */
     ...
     *
     * @return A result object representing the outcome of the revoke operation, or `null` if not implemented.
     */
