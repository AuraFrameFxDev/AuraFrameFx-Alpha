...
class OAuthService(
    ...
    /**
     * Returns an intent that initiates the OAuth sign-in flow.
     *
     * @return An intent to start the sign-in process, or `null` if not implemented.
     */
     ...
     *
     * @return A result object representing the outcome of the sign-out operation, or `null` if unimplemented.
     */
     ...
     *
     * @return A result object representing the outcome of the revoke operation, or `null` if unimplemented.
     */
