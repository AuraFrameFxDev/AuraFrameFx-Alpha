...
class OAuthService(
     ...
     *
     * @param _data The intent data returned from the sign-in activity, typically containing authentication results.
     ...
     *
     * @return A result object indicating the outcome of the revocation operation, or `null` if unimplemented.
     */
