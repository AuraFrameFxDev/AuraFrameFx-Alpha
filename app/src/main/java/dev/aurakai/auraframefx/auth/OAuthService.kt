...
class OAuthService(
     ...
     *
     * @return A result object indicating the outcome of the sign-out operation, or `null` if unimplemented.
     */
     ...
     *
     * @return A result object indicating the outcome of the revoke operation, or `null` if unimplemented.
     */
