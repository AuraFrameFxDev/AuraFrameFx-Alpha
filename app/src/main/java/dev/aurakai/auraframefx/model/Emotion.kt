...
enum class Emotion {
    ...
    companion object {
        /**
 * Selects and returns a random Emotion from all defined values.
 *
 ...
 */
        ...
        /**
             * Retrieves the Emotion that matches the provided string, ignoring case.
             *
             * Returns NEUTRAL if no matching Emotion is found.
             *
             * @param name The string to match against defined Emotion names.
             * @return The corresponding Emotion, or NEUTRAL if no match exists.
             */
