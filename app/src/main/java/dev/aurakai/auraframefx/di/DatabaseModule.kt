...
object DatabaseModule {
     ...
     *
     * Creates and configures the `AppDatabase` using the application context and a fixed database name. Uses destructive migration as a fallback; proper migration strategies should be implemented for production environments.
     *
