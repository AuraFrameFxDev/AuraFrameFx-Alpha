...
object DatabaseModule {
    ...
    /**
     * Provides a singleton instance of the Room `AppDatabase` configured with the application context.
     *
     * The database is named "aura_frame_fx_database" and uses a fallback to destructive migration strategy.
     *
