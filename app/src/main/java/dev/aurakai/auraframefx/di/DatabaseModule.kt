...
object DatabaseModule {
     ...
     *
     * Configures and returns the `AppDatabase` using the application context and a fixed database name.
     * Uses destructive migration as a fallback; implement proper migration strategies before production deployment.
     *
