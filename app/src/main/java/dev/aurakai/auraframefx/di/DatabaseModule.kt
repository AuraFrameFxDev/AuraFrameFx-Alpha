...
object DatabaseModule {
     ...
     *
     * Builds the database named "aura_frame_fx_database" using the application context and applies a fallback to destructive migration if no migration is specified.
     *
