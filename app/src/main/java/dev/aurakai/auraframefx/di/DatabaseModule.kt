...
object DatabaseModule {
    ...
    /**
     * Provides a singleton instance of the Room database configured for the application.
     *
     * Builds the `AppDatabase` using the application context and a fixed database name, applying destructive migration as a fallback. For production environments, proper migration strategies should be implemented instead of destructive migration.
     *
    ...
    /**
     * Provides an instance of AgentMemoryDao from the specified AppDatabase.
     *
