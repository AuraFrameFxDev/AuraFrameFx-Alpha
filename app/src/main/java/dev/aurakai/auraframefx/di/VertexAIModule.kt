...
object VertexAIModule {
    ...
    /**
     * Provides a singleton `VertexAIConfig` preconfigured for production use with Vertex AI.
     *
     ...
     *
     * @return A `VertexAIConfig` configured for integration with Vertex AI services.
     */
    @Provides
    @Singleton
    ...
    /**
     * Provides a singleton `VertexAIClient` configured with the given Vertex AI settings, application context, security context, and logger.
     *
