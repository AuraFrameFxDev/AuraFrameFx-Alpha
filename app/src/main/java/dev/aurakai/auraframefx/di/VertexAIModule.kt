...
object VertexAIModule {
     ...
     *
     * The configuration includes project identification, API endpoint, model and version selection, security and safety options, retry and timeout policies, concurrency limits, and caching settings.
     *
