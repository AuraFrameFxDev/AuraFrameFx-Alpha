...
object VertexAIModule {
     ...
     *
     * The configuration specifies project ID, location, API endpoint, model name, API version, security features, retry policy, timeout, concurrency limits, and caching settings.
     *
