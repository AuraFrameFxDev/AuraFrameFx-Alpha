...
object VertexAIModule {
     ...
     *
     * Constructs the client using the given configuration, application context, security context, and logger.
     *
     * @return The singleton `VertexAIClient` configured for Vertex AI integration.
     */
    @Provides
    @Singleton
