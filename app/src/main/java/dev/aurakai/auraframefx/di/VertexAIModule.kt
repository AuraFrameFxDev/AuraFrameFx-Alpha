...
object VertexAIModule {
     ...
     *
     * The configuration includes settings such as project ID, location, API endpoint, model name, API version, security options, retry and timeout limits, concurrency, and caching.
     *
