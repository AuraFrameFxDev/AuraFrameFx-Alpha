...
object VertexAIModule {
     ...
     *
     * The returned client is suitable for use throughout the application and is managed by Dagger Hilt's dependency injection.
     *
     * @return A singleton `VertexAIClient` implementation.
     */
    @Provides
    @Singleton
