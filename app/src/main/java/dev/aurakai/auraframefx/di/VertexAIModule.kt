...
object VertexAIModule {
     ...
     *
     * @return A `VertexAIConfig` object ready for use with Vertex AI services.
     */
    @Provides
    @Singleton
    ...
    /**
     * Provides a singleton instance of `VertexAIClient` configured for Vertex AI services.
     *
     * Returns a `VertexAIClientImpl` constructed with the given configuration, application context, security context, and logger.
     *
     * @return A `VertexAIClient` instance ready for use with Vertex AI services.
     */
    @Provides
    @Singleton
