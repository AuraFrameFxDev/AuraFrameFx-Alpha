...
object TrinityModule {
    ...
    /**
     * Provides a singleton GenesisBridgeService for connecting AI services with the Trinity Python backend.
     *
     ...
     *
     * @return A GenesisBridgeService instance configured for Trinity integration.
     */
    @Provides
    @Singleton
