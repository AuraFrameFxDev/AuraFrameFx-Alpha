...
object LoggingModule {
    ...
    /**
     * Provides a singleton AuraFxLogger instance configured with the application context and KaiAIService.
     *
     * @return An AuraFxLogger configured for application-wide logging.
     */
    @Provides
    @Singleton
