...
object LoggingModule {
    ...
    /**
     * Provides a singleton instance of AuraFxLogger configured with the application context and KaiAIService.
     *
     * @return A singleton AuraFxLogger for use throughout the application.
     */
    @Provides
    @Singleton
