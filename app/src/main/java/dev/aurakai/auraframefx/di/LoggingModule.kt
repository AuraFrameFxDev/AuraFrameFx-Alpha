...
object LoggingModule {
    ...
    /**
     * Provides a singleton AuraFxLogger instance for application-wide logging.
     *
     * @return An AuraFxLogger configured with the application context and KaiAIService.
     */
    @Provides
    @Singleton
