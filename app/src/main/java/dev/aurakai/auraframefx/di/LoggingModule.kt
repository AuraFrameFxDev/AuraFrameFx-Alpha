...
object LoggingModule {
     ...
     * @param kaiService The KaiAIService dependency used by the logger implementation.
     * @return An AuraFxLogger implementation configured with the provided dependencies.
     */
    @Provides
    @Singleton
