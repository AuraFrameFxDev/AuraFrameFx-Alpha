...
object DataStoreModule {
     ...
     *
     * The DataStore is backed by a file named "aura_settings" in the application's preferences directory.
     *
     * @return A DataStore instance for managing key-value preferences.
     */
    @Provides
    @Singleton
