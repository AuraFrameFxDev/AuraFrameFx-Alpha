...
object DataStoreModule {
    ...
    /**
     * Provides a singleton instance of DataStore for storing preferences using the "aura_settings" file.
     *
     * @return A configured DataStore instance for preferences storage.
     */
    @Provides
    @Singleton
