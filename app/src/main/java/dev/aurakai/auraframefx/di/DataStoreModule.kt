...
object DataStoreModule {
    ...
    /**
     * Provides a singleton DataStore for storing application preferences in a file named "aura_settings".
     *
     * @return A DataStore instance configured for preference storage.
     */
    @Provides
    @Singleton
