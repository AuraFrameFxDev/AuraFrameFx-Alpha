...
object DataStoreModule {
    ...
    /**
     * Provides a singleton DataStore of Preferences backed by the "aura_settings" file.
     *
     * @return A DataStore instance for storing and retrieving application preferences.
     */
    @Provides
    @Singleton
