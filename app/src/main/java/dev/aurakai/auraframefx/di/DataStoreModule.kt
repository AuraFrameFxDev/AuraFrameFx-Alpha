...
object DataStoreModule {
    ...
    /**
     * Provides a singleton DataStore for application preferences.
     *
     * The DataStore stores preferences in a file named "aura_settings" located in the application's storage directory.
     *
