...
object DataStoreModule {
    ...
    /**
     * Provides a singleton DataStore for storing application preferences.
     *
     * The DataStore uses a file named "aura_settings" in the application's storage directory to persist preferences.
     *
