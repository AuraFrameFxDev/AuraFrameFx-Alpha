...
object DataStoreModule {
    ...
    /**
     * Provides a singleton instance of DataStore for storing application preferences.
     *
     * Creates a DataStore backed by a preferences file named "aura_settings" in the application's context.
     * 
     * @param context The application context used to determine the storage location.
