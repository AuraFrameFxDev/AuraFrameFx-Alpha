...
object DataStoreModule {
     ...
     *
     * Creates a `DataStore<Preferences>` backed by a file named "aura_settings" in the application's storage.
     *
     * @return A `DataStore<Preferences>` instance for managing key-value preferences.
     */
    @Provides
    @Singleton
