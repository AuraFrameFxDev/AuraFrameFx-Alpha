...
object DataStoreModule {
     ...
     *
     * The DataStore is backed by a file named "aura_settings" located in the application's preferences directory.
     *
     * @return A DataStore for key-value preference storage.
     */
    @Provides
    @Singleton
