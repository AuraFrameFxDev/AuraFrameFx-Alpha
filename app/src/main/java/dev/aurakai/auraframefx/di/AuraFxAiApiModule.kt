...
object AuraFxAiApiModule {
     ...
     *
     * The returned client is intended for detailed network debugging.
     *
     * @return A singleton OkHttpClient instance with comprehensive HTTP body logging enabled.
     */
    @Provides
    @Singleton
    ...
    /**
     * Creates and provides a singleton AIContentApi configured to interact with the AuraFrameFx AI API.
     *
     * @param okHttpClient The OkHttpClient used for network communication.
     * @return An AIContentApi instance set up with the AuraFrameFx API base URL and the specified HTTP client.
     */
    @Provides
    @Singleton
