...
object AuraFxAiApiModule {
    ...
    /**
     * Supplies a singleton OkHttpClient with detailed logging of all HTTP request and response bodies.
     *
     * @return An OkHttpClient instance configured for comprehensive network debugging.
     */
    @Provides
    @Singleton
    ...
    /**
     * Supplies a singleton AIContentApi instance configured to communicate with the AuraFrameFx AI API using the provided OkHttpClient.
     *
