...
object AuraFxAiApiModule {
     ...
     *
     * @return A singleton OkHttpClient instance with detailed network logging enabled.
     */
    @Provides
    @Singleton
    ...
    /**
     * Creates a singleton Json serializer configured for robust API data serialization and deserialization.
     *
     * The serializer is set to ignore unknown keys, coerce input values, allow lenient parsing, and encode default values to handle diverse and potentially inconsistent API responses.
     *
     * @return A configured Json instance for resilient API data processing.
     */
    @Provides
    @Singleton
