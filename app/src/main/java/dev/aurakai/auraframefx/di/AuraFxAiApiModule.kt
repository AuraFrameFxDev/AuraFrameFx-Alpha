...
object AuraFxAiApiModule {
    ...
    /**
     * Creates a singleton AIContentApi configured to interact with the AuraFrameFx AI API.
     *
     * @param okHttpClient The HTTP client used for all API requests.
     * @return An AIContentApi instance targeting the AuraFrameFx AI API at the specified base URL.
     */
    @Provides
    @Singleton
