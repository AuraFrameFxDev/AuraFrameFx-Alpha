...
object AuraFxAiApiModule {
     ...
     *
     * @return An OkHttpClient instance configured for detailed network interaction logging.
     */
    @Provides
    @Singleton
    ...
    /**
     * Creates a singleton AIContentApi instance configured to communicate with the AuraFrameFx AI API using the provided OkHttpClient.
     *
