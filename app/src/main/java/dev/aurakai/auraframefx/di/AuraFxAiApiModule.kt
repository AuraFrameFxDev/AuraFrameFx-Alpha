...
object AuraFxAiApiModule {
    ...
    /**
     * Creates a singleton OkHttpClient with full HTTP request and response body logging enabled.
     *
     * @return An OkHttpClient instance configured for detailed network request logging.
     */
    @Provides
    @Singleton
