...
object AuraFxAiApiModule {
     ...
     *
     * The serializer is set to ignore unknown keys, coerce input values, allow lenient parsing, and encode default values to handle diverse API responses reliably.
     *
