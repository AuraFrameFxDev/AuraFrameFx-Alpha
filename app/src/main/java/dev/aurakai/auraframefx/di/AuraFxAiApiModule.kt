...
object AuraFxAiApiModule {
    ...
    /**
     * Returns a singleton Json serializer configured for robust API data processing.
     *
     * The serializer is set to ignore unknown keys, coerce input values, allow lenient parsing, and encode default values to ensure flexible and resilient serialization and deserialization of API responses.
     *
     ...
     *
     * @param okHttpClient The HTTP client used for API communication.
