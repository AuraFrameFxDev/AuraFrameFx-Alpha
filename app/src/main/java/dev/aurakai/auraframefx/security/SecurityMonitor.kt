...
class SecurityMonitor @Inject constructor(
    ...
    /**
     * Monitors security state changes and reports each as a security event to Genesis.
     *
    ...
    /**
     * Monitors encryption status changes and reports status updates and encryption failures to Genesis.
     *
     ...
     *
     * Collects updates to the permissions state, identifies denied permissions, and sends a warning event to Genesis if any are detected.
     */
     ...
     *
     * Returns a map containing the number of active threats, the timestamp of the last scan, the current security status, and a beta mode flag. If retrieval fails, the map includes an error message.
     *
