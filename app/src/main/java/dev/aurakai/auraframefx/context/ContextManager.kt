...
class ContextManager @Inject constructor(
     ...
     *
     * Searches for related memories based on the interaction content, determines the most suitable agent, and calculates a priority for processing. Returns an `EnhancedInteractionData` object containing the original interaction details, enriched context, agent suggestion, and priority score.
     *
     ...
     *
     * Creates an `Insight` with the provided request, response, complexity, and extracted pattern descriptors, then stores it for future learning. Triggers asynchronous learning processing after every 10 recorded insights.
     *
     ...
     *
     * Security interactions receive the highest priority, followed by analysis, creative, and text types. All other types are assigned the lowest priority.
     *
