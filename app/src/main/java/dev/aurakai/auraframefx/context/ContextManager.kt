...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata, including creation timestamp, access count, and last access time, and adds the context to the active contexts map.
     *
    ...
    /**
     * Generates a multi-line summary string of the given context's metadata and current system states.
     *
     ...
     *
     * Searches stored memories for entries related to the provided content and returns their contents as a newline-separated list, each prefixed with a bullet point.
     *
    ...
    /**
     * Shuts down the ContextManager by canceling all active coroutines and releasing associated resources.
     *
