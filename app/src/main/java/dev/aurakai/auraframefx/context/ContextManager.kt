...
class ContextManager @Inject constructor(
     ...
     *
     * Retrieves related memories based on the interaction content, suggests the most suitable agent, and calculates a priority for processing. Returns an `EnhancedInteractionData` object containing the original interaction details along with the enriched context, agent recommendation, and priority score.
     *
     ...
     *
     * Activates creative mode, allowing AI agents to generate more creative and diverse responses.
     */
    ...
    /**
     * Enables creative mode, allowing all AI agents to utilize enhanced creative processing capabilities.
     */
     ...
     * @return A multi-line string containing the enhanced context information.
     */
     ...
     * @return A bullet-pointed string of relevant memory contents, each on a new line.
     */
     ...
     * @return An integer score where higher values represent higher priority.
     */
