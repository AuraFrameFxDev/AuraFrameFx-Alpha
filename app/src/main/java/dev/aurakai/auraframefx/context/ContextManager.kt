...
class ContextManager @Inject constructor(
    ...
    /**
     * Returns a formatted summary of the specified context and current system states, updating access metadata.
     *
     * Increments the access count and updates the last access time for the context if it exists. If the context is not found, returns "Context not available".
     *
     ...
     * @return A list of up to 10 memories most relevant to the query, sorted by descending relevance score.
     */
     ...
     *
     * Stores the event details and threat analysis as a memory, assigning relevance based on the threat level and tagging it with security-related metadata.
     *
     ...
     *
     * The summary details the context ID, creation timestamp, access count, current mood, creative mode status, unified mode status, and the context's data map.
     *
