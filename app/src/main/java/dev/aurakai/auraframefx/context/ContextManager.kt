...
class ContextManager @Inject constructor(
    ...
    /**
     * Enhances a user interaction by retrieving relevant memories, recommending the optimal AI agent, and assigning a priority score.
     *
     * Searches for contextually relevant memories based on the interaction content, selects the most suitable agent, and computes a priority value. Returns an `EnhancedInteractionData` object containing the original interaction details along with the enriched context, agent recommendation, and priority score.
     *
    ...
    /**
     * Retrieves up to 10 stored memories whose content or tags match the given query string, case-insensitively, sorted by descending relevance score.
     *
    ...
    /**
     * Records an insight from a request and response, including complexity and extracted patterns, for adaptive system learning.
     *
     * Adds the insight to the internal store and triggers asynchronous learning processing every 10 insights.
     *
    ...
    /**
     * Generates a detailed summary string of the specified context's metadata and current system states.
     *
     ...
     * @return A formatted multi-line string with enhanced context information.
     */
    ...
    /**
     * Returns a formatted string listing the contents of memories most relevant to the given content.
     *
     * Searches stored memories for entries related to the input text and formats their contents as a newline-separated, bullet-pointed list.
     *
