...
class ContextManager @Inject constructor(
     ...
     *
     * Searches stored memories for information related to the interaction content, suggests the most suitable AI agent, and calculates a priority value. Returns an `EnhancedInteractionData` object containing the original content, enriched context, agent recommendation, and priority score.
     *
    ...
    /**
     * Generates a multi-line summary of the given context's metadata and current system states.
     *
     ...
     *
     * Summarizes the user input and agent response, tags the memory as high confidence, and adds it to the memory store for future retrieval.
     *
    ...
    /**
     * Shuts down the ContextManager by canceling all active coroutines and releasing resources.
     *
