...
class ContextManager @Inject constructor(
     ...
     *
     * @param query The substring to search for within memory content and tags.
    ...
    /**
     * Generates a detailed summary string of the given context's metadata and current system states.
     *
    ...
    /**
     * Retrieves and formats memories relevant to the provided content as a bullet-pointed list.
     *
     * Searches stored memories for entries related to the input text and returns their contents as a newline-separated string, each prefixed with a bullet point.
     *
     ...
     *
     * @param interaction The interaction data containing user input to analyze for agent selection.
     * @return The name of the recommended AI agent: "aura", "kai", or "genesis".
     */
