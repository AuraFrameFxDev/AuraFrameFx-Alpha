...
class ContextManager @Inject constructor(
    ...
    /**
     * Generates a multi-line string summarizing the provided context's metadata and current system states.
     *
    ...
    /**
     * Calculates and returns a priority score for an interaction based on its type.
     *
     ...
     *
     * @param interaction The interaction whose type determines the priority score.
     ...
     *
     * Only entries with a confidence score above 0.8 are stored as memories, including user input, agent response, agent type, and relevant tags.
     *
     ...
     *
     * @return A list of feature descriptor strings summarizing the request and response.
     */
