...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata including creation time, access count, and last access time, then stores the context in the active contexts map.
     *
    ...
    /**
     * Builds a formatted multi-line summary string of the given context's metadata and current system states.
     *
     ...
     *
     * @param interaction The interaction data containing user input.
     ...
     *
     * Call this method when the ContextManager is no longer needed to ensure proper cleanup and resource management.
     */
    fun cleanup() {
