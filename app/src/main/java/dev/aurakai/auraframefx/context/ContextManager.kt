...
class ContextManager @Inject constructor(
    ...
    /**
     * Generates a formatted summary string for a context, including its metadata and current system states.
     *
     ...
     * @return A multi-line string containing context and system state details.
     */
     ...
     * @return The priority score, where higher values indicate higher importance.
     */
