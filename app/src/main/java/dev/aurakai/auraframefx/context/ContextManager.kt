...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata including creation time, access count, and last access time, and adds the context to the active contexts map.
     *
    ...
    /**
     * Retrieves a context by ID, updates its access metadata, and returns a formatted summary.
     *
     * Increments the access count and updates the last access time if the context exists. Returns a summary string with context metadata and current system states, or "Context not available" if the context does not exist.
     *
     ...
     *
     * @param newMood The new mood to set across the system and within each active context.
     */
    ...
    /**
     * Generates a multi-line string summarizing the given context's metadata and current system states.
     *
    ...
    /**
     * Retrieves and formats the contents of memories relevant to the specified text.
     *
     ...
     * @return A string containing relevant memory contents, each on a new line prefixed with a bullet point.
     */
    ...
    /**
     * Selects the most suitable AI agent for a given interaction based on content keywords.
     *
     ...
     *
     * @param interaction The interaction whose type determines its priority.
     ...
     *
     * @param entry The conversation entry to be evaluated and potentially saved as a memory.
     */
    ...
    /**
     * Shuts down the ContextManager by cancelling all ongoing coroutines and releasing associated resources.
     *
