...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata including creation timestamp, access count, and last access time, and registers the context in the active contexts map.
     *
    ...
    /**
     * Selects the most suitable AI agent for a given interaction based on keywords in the interaction content.
     *
