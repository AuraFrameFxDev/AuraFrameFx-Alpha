...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata, including creation time and access tracking, and stores the context in the active contexts map.
     *
    ...
    /**
     * Returns a formatted summary of the specified context, updating its metadata and including current system states.
     *
     * Increments the access count and updates the last access time for the context. If the context does not exist, returns "Context not available".
     *
     * @param contextId The unique identifier of the context to summarize.
     * @return A formatted overview of the context and system states, or "Context not available" if the context is missing.
     */
     ...
     *
     * Searches stored memories for information related to the interaction content, suggests the most suitable AI agent, and calculates a priority score. Returns an `EnhancedInteractionData` object containing the original interaction details along with the enriched context, agent recommendation, and priority score.
     *
    ...
    /**
     * Retrieves up to 10 stored memories whose content or tags contain the specified query string, ranked by relevance.
     *
     ...
     * @return A multi-line string containing context metadata and relevant system states.
     */
     ...
     * @return A formatted string listing the contents of relevant memories, each prefixed with a bullet point.
     */
    ...
    /**
     * Generates simple feature descriptors from the request and response for use in learning models.
     *
