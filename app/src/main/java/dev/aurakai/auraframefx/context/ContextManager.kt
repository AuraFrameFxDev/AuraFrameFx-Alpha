...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes context metadata and adds the context to the active contexts map for tracking and future retrieval.
     *
     ...
     * @return An enhanced string summary of the context, or "Context not available" if the context does not exist.
     */
     ...
     *
     * Analyzes the interaction content to find related memories, selects the most suitable agent based on content, and calculates a priority score. Returns an `EnhancedInteractionData` object containing these enhancements.
     *
     ...
     *
     * Also extracts and stores any high-confidence memories from the interaction for future retrieval.
     */
     ...
     *
     * Creates a memory object containing the event details and threat analysis, assigns a relevance score based on the threat level, and tags it for security context.
     */
     ...
     * @return The name of the suggested agent ("aura", "kai", or "genesis").
     */
     ...
     *
     * Assigns higher integer values to more critical interaction types, with "security" being the highest.
     *
