...
class ContextManager @Inject constructor(
     ...
     *
     * Searches stored memories for context related to the interaction, selects the most appropriate AI agent based on content, and determines a processing priority. Returns an `EnhancedInteractionData` object containing the original interaction, enriched context, agent suggestion, and priority.
     *
     * @param interaction The user interaction to enhance.
     * @return An `EnhancedInteractionData` object with enriched context, agent recommendation, and priority score.
     */
     ...
     *
     * Also extracts and stores memories from the interaction if the agent's confidence is high enough for future retrieval and learning.
     */
     ...
     *
     * Creates an `Insight` with the provided request, response, complexity, and extracted pattern descriptors, then adds it to the internal insight store. Triggers asynchronous learning processing after every 10 recorded insights.
     *
     ...
     *
     * Stores the event details, threat analysis, a relevance score determined by threat level, and security-related tags as a memory.
     *
    ...
    /**
     * Builds a formatted summary string of the specified context's metadata and current system states.
     *
     ...
     *
     * Assigns higher scores to security and analysis interactions, with lower scores for creative, text, or other types.
     *
     ...
     *
     * A memory is created from the entry if its confidence score exceeds 0.8, capturing user input, agent response, agent type, and relevant tags.
     *
    ...
    /**
     * Generates simple pattern descriptors from the request and response strings for use in learning models.
     *
