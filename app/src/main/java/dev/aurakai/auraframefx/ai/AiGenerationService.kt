...
class AiGenerationService(
    ...
    /**
     * Generates AI-driven text based on the provided prompt and parameters.
     *
     ...
     * @param temperature The sampling temperature for controlling randomness. Defaults to 0.7.
