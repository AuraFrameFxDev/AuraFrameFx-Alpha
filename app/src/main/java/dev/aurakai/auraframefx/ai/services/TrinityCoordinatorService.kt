...
class TrinityCoordinatorService @Inject constructor(
     ...
     *
     * Initiates the given fusion type in the Genesis persona, optionally using context parameters, and emits a single response indicating whether the activation succeeded or failed.
     *
     ...
     *
     * Cancels all ongoing operations and terminates the Genesis bridge service to ensure a clean shutdown.
     */
    fun shutdown() {
        scope.cancel()
