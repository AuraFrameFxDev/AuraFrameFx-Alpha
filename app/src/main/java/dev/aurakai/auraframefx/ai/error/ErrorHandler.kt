...
class ErrorHandler @Inject constructor(
    ...
    /**
     * Handles an error by classifying its type, recording its details, updating error statistics, and initiating recovery actions.
     *
     ...
     * @return The recorded AIError instance representing the error.
     */
    fun handleError(
        error: Throwable,
        agent: AgentType,
