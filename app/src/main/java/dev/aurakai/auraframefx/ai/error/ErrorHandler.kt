...
class ErrorHandler @Inject constructor(
    ...
    /**
     * Categorizes, records, and tracks an error, then initiates appropriate recovery actions.
     *
     ...
     * @param metadata Additional metadata about the error; values are stringified.
