...
class MemoryManager @Inject constructor(
     ...
     *
     * The results are sorted by descending timestamp and capped at the maximum number of items allowed by the memory retrieval configuration.
     *
     ...
     *
     * @param task The task identifier for which the context window is requested.
