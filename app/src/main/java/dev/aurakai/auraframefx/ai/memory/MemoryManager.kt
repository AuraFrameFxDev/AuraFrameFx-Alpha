...
class MemoryManager @Inject constructor(
     ...
     *
     * The returned items are sorted by descending timestamp and limited to the maximum number of items configured.
     *
     ...
     * sorts them by descending timestamp, and limits the result to the maximum chain length.
     *
