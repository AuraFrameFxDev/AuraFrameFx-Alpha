...
class MemoryManager @Inject constructor(
     ...
     *
     * Filters memory items to include only those whose timestamps fall within the maximum chain length duration from the current time, sorts them by most recent, and limits the result to the configured maximum chain length.
     *
