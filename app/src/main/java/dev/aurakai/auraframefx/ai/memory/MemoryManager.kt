...
class MemoryManager @Inject constructor(
     ...
     *
     * Calculates and sets the total number of memory items, the count of recent items within the configured chain length duration, the total size of all memory content, and the current timestamp as the last update time.
     */
