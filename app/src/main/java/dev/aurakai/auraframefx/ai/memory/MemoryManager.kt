...
class MemoryManager @Inject constructor(
     ...
     *
     * The returned items are sorted by descending timestamp and limited to the maximum number configured.
     *
     * @param query The criteria for filtering and retrieving memory items.
     ...
     *
     * @return The latest `MemoryStats` containing totals and usage metrics.
     */
    ...
    /**
     * Updates the memory statistics with the current total item count, recent item count, and aggregate memory size.
     *
     * Recent items are determined by whether their timestamps fall within the configured maximum chain length from the current time.
     */
