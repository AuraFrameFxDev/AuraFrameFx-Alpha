...
class MemoryManager @Inject constructor(
    ...
    /**
     * Retrieves a list of recent memory items within the configured context window for a given task.
     *
     * The returned list contains memory items whose timestamps fall within the maximum chain length duration,
     * sorted by most recent first and limited to the configured maximum chain length.
     *
