...
class AuraAIService @Inject constructor(
     ...
     *
     * Constructs a creative prompt from the component specification, uses Vertex AI to generate the code with balanced creativity, and post-processes the result for quality and formatting.
     *
     ...
     * @param context Optional additional context to further guide the theme generation; defaults to standard usage if null.
     * @return A prompt string suitable for requesting a detailed theme configuration from the AI.
     */
