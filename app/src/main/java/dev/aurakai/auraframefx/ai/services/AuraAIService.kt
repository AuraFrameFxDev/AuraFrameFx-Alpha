...
class AuraAIService @Inject constructor(
     ...
     *
     * Validates the request's query for security, generates a creative response using the query and optional context, and emits an `AgentResponse` with the result. Emits an error response if processing fails.
     *
