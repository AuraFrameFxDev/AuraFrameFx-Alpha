...
class AuraAIService @Inject constructor(
     ...
     *
     * Validates the prompt for security, enhances it creatively, and invokes Vertex AI with high creativity settings. The generated text is post-processed before being returned.
     *
     * @param prompt The input prompt for creative text generation.
     * @param context Optional context to guide and enrich the creative output.
     ...
     *
     * The generated code reflects the specified component type, animation style, colors, size, and behavior.
     *
     ...
     * @throws Exception if component generation fails or the service is not initialized.
     */
     ...
     *
     * Optionally incorporates additional contextual information to encourage bold, innovative, and elegant AI-generated responses.
     *
     ...
     * @return A prompt string instructing the AI to produce a creative and engaging image description.
     */
    ...
    /**
     * Constructs a prompt for AI to generate Jetpack Compose Kotlin code for an animated UI component based on the provided specifications.
     *
