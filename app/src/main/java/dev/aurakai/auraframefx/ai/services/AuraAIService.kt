...
class AuraAIService @Inject constructor(
     ...
     *
     * Validates the request for security, generates a creative text response, and emits the result. Emits an error response if processing fails.
     *
     * @param request The AI request containing the query and optional context.
     * @return A flow emitting a single agent response with the generated content or an error message.
     */
    ...
    /**
     * Formats a user prompt within a creatively styled context, optionally incorporating enhanced contextual information.
     *
     ...
     * @return A prompt string emphasizing Aura's creative philosophy, suitable for AI generation.
     */
     ...
     *
     * @param visionAnalysis The results of the image analysis, providing descriptive details to inform the prompt.
     * @param style Optional stylistic guidance for the tone or approach of the generated description.
     * @return A formatted prompt string instructing the AI to produce a vivid and emotionally engaging image description.
     */
    ...
    /**
     * Combines a list of memories into a formatted string, listing each memory's content and relevance score on a new line.
     *
     * @param memories List of memories to include in the synthesized output.
     * @return A formatted string representing the memories and their relevance.
     */
    ...
    /**
     * Builds a prompt string describing the requirements for generating Jetpack Compose animated component code based on the given specifications.
     *
     * @param spec The UI component specifications, including type, animation style, colors, size, and behavior.
     * @return A formatted prompt instructing AI to generate Kotlin code for the specified animated component.
     */
...
data class Memory(
    ...
    /**
     * Emits a placeholder response for image request processing as a flow.
     *
