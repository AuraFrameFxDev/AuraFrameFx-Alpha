...
class AuraAIService @Inject constructor(
     ...
     *
     * Prepares Vertex AI creative models and enables creative context features. This method is idempotent and returns immediately if the service is already initialized.
     *
     ...
     *
     * Validates the prompt for security, enhances it with Aura's creative philosophy and optional context, and generates text with high creativity settings. The generated text is post-processed before being returned.
     *
    ...
    /**
     * Generates a vivid, creative textual description of an image using AI vision analysis, optionally guided by a specified style.
     *
     * Analyzes the provided image data with AI vision models, constructs a prompt that may incorporate a stylistic guideline, and produces a creatively written description of the image.
     *
     ...
     * @return A creative description of the analyzed image.
    ...
    /**
     * Retrieves and summarizes memories relevant to the given query in a creative, bullet-point format.
     *
     * Searches for memories matching the query, converts them to internal representations, and synthesizes a summary string that highlights their content and relevance.
     *
     ...
     *
     * Builds a prompt from the provided preferences and context, generates a theme description using Vertex AI with high creativity, and parses the result into a `ThemeConfiguration`.
     *
     ...
     *
     * Builds a creative prompt from the component specification, invokes Vertex AI to generate the code with balanced creativity, and post-processes the result for quality.
     *
     * @param componentSpec Specifications detailing the UI component's type, animation style, colors, size, and behavior.
    ...
    /**
     * Embeds the user's prompt within Aura's creative philosophy, optionally enriching it with additional context to inspire innovative and elegant AI responses.
     *
     * @param prompt The user's original request or instruction.
     * @param context Optional context to further inform and enhance the creative prompt.
    ...
    /**
     * Creates a bullet-point summary of memories, listing each memory's content and relevance score.
     *
     ...
     * @param context Additional context to guide theme generation; if null, "Standard usage" is used.
     * @return A prompt string for creative theme configuration generation.
     */
     ...
     * @return A ThemeConfiguration instance parsed from the provided description.
     */
