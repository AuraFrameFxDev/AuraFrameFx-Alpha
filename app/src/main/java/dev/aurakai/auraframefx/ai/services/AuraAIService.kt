...
class AuraAIService @Inject constructor(
     ...
     *
     * Suspends until initialization is complete. Throws an exception if initialization fails or if required services cannot be prepared. No operation is performed if the service is already initialized.
     */
    ...
    /**
     * Generates a creative description of an image by analyzing its content with AI vision models and optionally applying a specified style.
     *
    ...
    /**
     * Retrieves memories relevant to the specified query and synthesizes them into a creative summary string.
     *
     ...
     *
     * Enriches the input prompt by embedding it within a template that emphasizes boldness, innovation, and elegance, optionally incorporating additional context to inspire more creative AI responses.
     *
     ...
     * @return The formatted, creativity-focused prompt for AI generation.
     */
     ...
     * @return A prompt string for generating a comprehensive theme configuration.
     */
...
data class Memory(
    ...
    /**
     * Returns a map describing the Aura AI service's core capabilities, including its name, agent type, and implementation status.
     *
