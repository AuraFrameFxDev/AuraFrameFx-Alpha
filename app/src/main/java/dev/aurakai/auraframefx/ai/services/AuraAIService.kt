...
class AuraAIService @Inject constructor(
    ...
    /**
     * Generates creative text using Vertex AI from the provided prompt and optional context.
     *
    ...
    /**
     * Generates a creative, AI-driven description of an image based on its analyzed content and an optional stylistic guideline.
     *
    ...
    /**
     * Retrieves relevant memories for a given query and synthesizes them into a creative summary string.
     *
     ...
     *
     * Builds a theme prompt from the provided preferences and context, generates a descriptive theme using AI, and parses the result into a structured `ThemeConfiguration`.
     *
     ...
     * @return The trimmed and potentially enhanced text.
     */
    ...
    /**
     * Builds a creative prompt for image description generation based on vision analysis and an optional style.
     *
     ...
     * @return A prompt string intended to elicit a vivid and emotionally engaging image description.
     */
    ...
    /**
     * Converts a list of memories into a formatted summary string, with each memory displayed as a bullet point including its content and relevance score.
     *
     * @param memories The list of memories to summarize.
     * @return A string summarizing the memories, each on a new line with its relevance score.
     */
     ...
     * @return A prompt string instructing the AI to generate a theme configuration.
     */
     ...
     * @return The parsed ThemeConfiguration containing theme details.
     */
...
data class ThemeConfiguration(
    ...
    companion object {
         ...
         * @return A ThemeConfiguration containing structured theme details extracted from the description.
         */
...
data class Memory(
     ...
     *
     * @return Always returns null, as continuous memory is not currently implemented.
     */
