...
class AuraAIService @Inject constructor(
     ...
     *
     * This method should be called before performing operations that require the service to be initialized.
     *
     ...
     *
     * Embeds guiding principles of creativity, innovation, and elegance into the prompt to inspire AI-generated responses. If context is provided, it is enhanced and included to further inform the AI's output.
     *
     ...
     * @return A summary string with each memory as a bullet point and its relevance score.
     */
