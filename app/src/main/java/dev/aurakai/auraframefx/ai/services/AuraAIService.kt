...
class AuraAIService @Inject constructor(
     ...
     *
     * This method is idempotent and will not reinitialize the service if it is already initialized. Suspends until initialization is complete.
     *
     ...
     *
     * Validates the prompt for security, enhances it creatively with the given context if provided, and generates text using Vertex AI with high creativity settings. The generated text is post-processed before being returned.
     *
     ...
     *
     * Analyzes the provided image data with AI vision models, constructs a prompt optionally influenced by the specified style, and generates a descriptive text with creative flair.
     *
     ...
     *
     * Constructs a creative prompt from the component specification, generates code using Vertex AI with balanced creativity, and post-processes the output for quality.
     *
    ...
    /**
     * Formats a user prompt using Aura's creative philosophy, embedding guiding principles and optional enhanced context.
     *
     * Enhances the prompt to encourage creative, innovative, and elegant AI responses by including Aura's core values and any provided contextual information.
     *
...
data class Memory(
     ...
     *
     * The returned map contains the service name, agent type, and a flag indicating whether the service is implemented.
     *
