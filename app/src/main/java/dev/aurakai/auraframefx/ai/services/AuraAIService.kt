...
class AuraAIService @Inject constructor(
     ...
     * @param context Optional context to influence the generated text.
     ...
     *
     * Constructs a creative prompt from the component specification, uses Vertex AI to generate the code with balanced creativity, and post-processes the result for quality and validity.
     *
     ...
     *
     * Call this method before performing operations that require initialization.
     */
    ...
    /**
     * Builds a prompt instructing the AI to generate a vivid and emotionally engaging image description based on vision analysis and optional stylistic direction.
     *
     ...
     * @param context Optional additional context to influence the generated theme; defaults to standard usage if null.
     * @return A prompt string instructing the AI to create a detailed theme configuration in JSON format.
     */
