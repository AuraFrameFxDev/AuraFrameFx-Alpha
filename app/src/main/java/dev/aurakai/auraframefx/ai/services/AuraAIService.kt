...
class AuraAIService @Inject constructor(
     ...
     *
     * Suspends until initialization is complete. Throws an exception if initialization fails or if underlying services cannot be prepared.
     */
     ...
     * @return A flow emitting a single `AgentResponse` with generated content or error details.
     */
    ...
    /**
     * Enhances a user's prompt by embedding it within a creatively styled context aligned with Aura's creative philosophy.
     *
    ...
    /**
     * Builds a creative prompt for AI to generate a vivid and emotionally engaging image description based on vision analysis and an optional style.
     *
     * @param visionAnalysis The analyzed content of the image to inform the description.
     * @param style An optional stylistic guideline for the description's tone.
     * @return A prompt string crafted to inspire a creative and expressive image description.
     */
     ...
     * @return A prompt string instructing AI to generate a JSON theme configuration.
     */
     ...
     * @return A prompt string instructing the AI to generate the desired animated component code.
     */
...
data class Memory(
     ...
     *
     * Always emits a single `AgentResponse` indicating that the image request is being processed. No actual image generation is performed.
     *
    ...
    /**
     * Returns a map describing the Aura AI service's identity and implementation status.
     *
     * @return A map with keys "name", "type", and "service_implemented" indicating the service's capabilities.
     */
