...
class TaskExecutionManager @Inject constructor(
     ...
     *
     * Uses the specified agent preference if valid; otherwise, selects an agent by analyzing keywords in the task type. Defaults to Genesis if no preference or keywords match.
     *
