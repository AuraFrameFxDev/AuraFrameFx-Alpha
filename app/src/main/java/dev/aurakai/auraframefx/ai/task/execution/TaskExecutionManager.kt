...
class TaskExecutionManager @Inject constructor(
     ...
     *
     * Introduces a short delay between processing cycles to reduce resource usage, and a longer delay after exceptions to provide error backoff.
     */
     ...
     *
     * Polls the priority queue for a task whose scheduled time has arrived. If the task is not yet ready, it is re-queued. If the maximum number of concurrent tasks is reached or the queue is empty, no task is processed.
     */
