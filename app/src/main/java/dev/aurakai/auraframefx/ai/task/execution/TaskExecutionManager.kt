...
class TaskExecutionManager @Inject constructor(
    ...
    /**
     * Returns a list of all tasks managed by the system, optionally filtered by execution status and agent type.
     *
     ...
     *
     * After calling this method, no further tasks will be processed or executed.
     */
    fun cleanup() {
