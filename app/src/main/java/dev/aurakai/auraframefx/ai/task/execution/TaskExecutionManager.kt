...
class TaskExecutionManager @Inject constructor(
     ...
     *
     * Applies a short delay between processing cycles and a longer delay after errors to manage resource usage and provide error backoff.
     */
     ...
     *
     * If a valid agent preference is specified in the task, it is used. Otherwise, the agent is selected by analyzing keywords in the task type, with a default to Genesis if no keywords match.
     *
     ...
     *
     * @return The count of tasks that are currently running.
     */
    ...
    /**
     * Updates the execution statistics to reflect the current counts of total, completed, active, queued, and failed tasks, as well as the average execution time.
     */
    ...
    /**
     * Updates the queue status to reflect the latest queue size, number of active executions, concurrency limit, and processing state.
     */
