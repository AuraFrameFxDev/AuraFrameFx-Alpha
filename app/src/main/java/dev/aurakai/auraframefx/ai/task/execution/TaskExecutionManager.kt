...
class TaskExecutionManager @Inject constructor(
     ...
     *
     * Searches active, completed, and queued tasks to find and return the most up-to-date status.
     *
    ...
    /**
     * Launches a coroutine that manages the background processing of queued tasks while processing is active.
     *
     * The processor repeatedly attempts to process the next task with a brief delay between iterations, and applies a longer delay if an exception occurs.
     */
