...
class TaskExecutionManager @Inject constructor(
     ...
     *
     * Uses the specified agent preference if valid; otherwise, selects an agent by matching keywords in the task type. Defaults to Genesis if no preference or keyword match is found.
     *
     ...
     *
     * @return The number of tasks in execution.
     */
