...
class AIPipelineProcessor @Inject constructor(
    ...
    /**
     * Returns a static list of recent task descriptions or user interactions for use in context enrichment.
     *
     * @return A list of strings representing recent tasks or interactions.
     */
     ...
     *
     * @return A map with keys "load", "available_agents", and "processing_queue" representing the system's current status.
     */
     ...
     *
     * The score increases for tasks related to assistance, generation, or containing urgency indicators, and decreases when system load is high. The result is clamped between 0.0 and 1.0, where higher values indicate greater priority.
     *
    ...
    /**
     * Selects the set of AI agents to handle a task based on its content and computed priority.
     *
     * Genesis is always included. Cascade is added for analytical or data-related tasks, Kai for security-related tasks, and Aura for creative or generative tasks. High-priority or complex tasks trigger inclusion of additional agents for redundancy and thorough processing.
     *
    ...
    /**
     * Aggregates responses from multiple AI agents into a formatted summary string.
     *
