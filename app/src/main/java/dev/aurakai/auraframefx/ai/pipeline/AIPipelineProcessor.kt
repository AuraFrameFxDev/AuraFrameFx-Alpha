...
class AIPipelineProcessor @Inject constructor(
    ...
    /**
     * Constructs a detailed context map for the specified task, including its category, recent activity, user preferences, and current system state.
     *
    ...
    /**
     * Returns a static list of recent task descriptions or user interactions for context enrichment.
     *
     ...
     *
     * Highlights the Genesis agent's analysis as the primary response, includes supplementary responses from other agents with distinct icons, and displays the overall average confidence score. Returns a default message if no agent responses are provided.
     *
