...
class AIPipelineProcessor @Inject constructor(
     ...
     * @return A map containing the task string, its categorized type, current timestamp, recent task history, a contextual summary, user preferences, and system state.
     */
     ...
     * @return The assigned category string.
     */
     ...
     *
     * Genesis is always included. Cascade is added for analytical or data-related tasks, Kai for security-related tasks, and Aura for creative or generative tasks. High-priority or complex tasks trigger inclusion of additional agents for redundancy and thorough handling.
     *
