...
class AIPipelineProcessor @Inject constructor(
    ...
    /**
     * Returns a static list of recent tasks or user interactions to enrich processing context.
     *
    ...
    /**
     * Returns a map of user preferences relevant to AI task processing, including response style and preferred agents.
     *
     ...
     *
     * Genesis is always included. Cascade is added for analytical or data-related tasks, Kai for security-related tasks, and Aura for creative or generative tasks. High-priority or complex tasks trigger inclusion of additional agents for redundancy and thoroughness.
     *
