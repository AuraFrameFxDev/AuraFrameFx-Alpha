...
class AIPipelineProcessor @Inject constructor(
    ...
    /**
     * Constructs a contextual information map for a given task, including its category, recent history, user preferences, and system state.
     *
     * @param task The task description to contextualize.
     * @return A map containing the task, its categorized type, timestamp, recent history, a descriptive context string, user preferences, and current system state.
     */
    ...
    /**
     * Retrieves a list of recent task contexts and user interactions for contextual awareness in AI processing.
     *
     * @return A list of strings summarizing recent tasks and user interactions.
     */
    ...
    /**
     * Retrieves the current operational state of the system, including load status, available agent count, and processing queue size.
     *
     ...
     *
     * Adjusts a base priority value according to the task's category, current system load, and the presence of urgency indicators in the task description.
     *
     ...
     *
     * Agents are selected by analyzing keywords in the task description, the urgency indicated by the priority score, and the complexity of the task. The Genesis agent is always included. Additional agents are added for tasks involving analysis, security, or creative work, as well as for high-priority or complex tasks.
     *
    ...
    /**
     * Generates a formatted summary of multiple agent responses, prioritizing the Genesis agent's analysis and including supplementary inputs from other agents with icons.
     *
     * Groups responses by agent type, presents the Genesis response first if available, appends other agent responses with corresponding icons, and concludes with an overall average confidence score.
     *
