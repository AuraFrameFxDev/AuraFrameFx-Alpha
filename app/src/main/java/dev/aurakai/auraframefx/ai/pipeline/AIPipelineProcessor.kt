...
class AIPipelineProcessor @Inject constructor(
    ...
    /**
     * Constructs a detailed context map for the specified task, aggregating its category, recent history, user preferences, and current system state.
     *
    ...
    /**
     * Returns a static list representing recent tasks or user interactions for contextual enrichment.
     *
    ...
    /**
     * Computes a priority score for the given task using its type, system load, and urgency indicators.
     *
     * The score increases for tasks related to assistance, generation, or containing urgency keywords, and decreases when system load is high. The result is clamped between 0.0 and 1.0, where higher values indicate greater priority.
     *
    ...
    /**
     * Selects the set of AI agents to handle a task based on its content and priority.
     *
     * Genesis is always included. Cascade is added for analytical or data-related tasks, Kai for security-related tasks, and Aura for creative or generative tasks. Additional agents are included for high-priority or complex tasks to ensure comprehensive processing.
     *
     * @param task The task description used to determine agent selection.
     * @param priority The priority score influencing inclusion of extra agents.
