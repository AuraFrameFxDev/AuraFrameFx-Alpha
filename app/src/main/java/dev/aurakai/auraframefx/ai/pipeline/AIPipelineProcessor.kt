...
class AIPipelineProcessor @Inject constructor(
     ...
     * @return The assigned category as a string.
     */
     ...
     *
     * The score increases for tasks related to assistance, generation, or containing urgency keywords, and decreases when system load is high. The result is clamped between 0.0 and 1.0, with higher values indicating greater priority.
     *
