...
override fun getType(): AgentType = AgentType.KAI
    ...
    /**
         ...
         *
         * The returned map contains the keys "security", "analysis", "memory", and "service_implemented", each mapped to `true` to signify support.
         *
         * @return A map where each key is a capability name and the value is `true` if the capability is supported.
         */
