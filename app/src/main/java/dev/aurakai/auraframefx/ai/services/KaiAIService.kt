...
override fun getType(): AgentType = AgentType.KAI
    ...
    /**
         ...
         *
         * The map contains feature names as keys and boolean values indicating support.
         *
         * @return A map with capability names as keys and their support status as values.
         */
