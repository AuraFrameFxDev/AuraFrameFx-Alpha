...
interface AuraAIService {
     ...
     *
     * Uses default values for temperature and max_tokens if not specified in the options map.
     ...
     *
     * If options are provided, the "context" and "system_prompt" keys are used to customize the response. Returns a formatted string containing the prompt, context (if any), system prompt, and a fixed AI-generated response message. If an error occurs, returns an error message string.
     *
