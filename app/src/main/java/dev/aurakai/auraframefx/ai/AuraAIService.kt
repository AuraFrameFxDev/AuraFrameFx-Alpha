...
interface AuraAIService {
    ...
    /**
     * Generates AI-generated text from the given prompt using optional configuration settings.
     *
...
fun getMemory(memoryKey: String): String?
    ...
    /**
 * Persists a value associated with the given key for later retrieval.
 *
 * Implementations should ensure the value is stored in a way that allows consistent access using the same key.
 *
