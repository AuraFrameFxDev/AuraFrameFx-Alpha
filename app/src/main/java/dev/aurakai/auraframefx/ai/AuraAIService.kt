...
interface AuraAIService {
     ...
     * @param options Optional configuration for text generation, such as "temperature" and "max_tokens".
     ...
     * @param options Optional map containing additional context or a system prompt to influence the response.
