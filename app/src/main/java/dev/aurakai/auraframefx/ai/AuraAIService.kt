...
interface AuraAIService {
     ...
     *
     * The response includes the original prompt, applied generation options ("temperature" and "max_tokens"), and a status message. If an error occurs during generation, an error message string is returned.
     *
