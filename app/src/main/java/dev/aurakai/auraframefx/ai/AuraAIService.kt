...
interface AuraAIService {
     ...
     *
     * If the options map includes "context" or "system_prompt", these values are incorporated into the response. Returns a string summarizing the prompt, context, system prompt, and a generic AI-generated message. If an exception occurs, returns an error message.
     *
 ...
 *
 * Implementations should ensure the value can be reliably retrieved later using the same key.
 */
