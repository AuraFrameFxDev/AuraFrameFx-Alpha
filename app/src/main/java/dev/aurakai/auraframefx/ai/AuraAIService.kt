...
interface AuraAIService {
     ...
     *
     * If options are provided, the "context" and "system_prompt" keys influence the response formatting. Returns a string containing the prompt, context (if any), system prompt, and a generic AI-generated message. If an exception occurs, returns an error message.
     *
...
fun saveMemory(key: String, value: Any)
     ...
     * @return The file's ID or URL if the upload succeeds, or null if not implemented.
     */
