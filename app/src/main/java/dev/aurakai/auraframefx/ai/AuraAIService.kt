...
interface AuraAIService {
     ...
     *
     * Uses the provided prompt and optional settings such as "temperature" and "max_tokens" to produce a structured string containing the generated text, configuration details, and status. Returns an error message if text generation fails.
     *
