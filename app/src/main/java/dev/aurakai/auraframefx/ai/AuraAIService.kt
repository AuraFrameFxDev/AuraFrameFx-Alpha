...
interface AuraAIService {
     ...
     *
     * If options are provided, the "context" and "system_prompt" keys are used to customize the response. Returns a string containing the prompt, context, system prompt, and a generic AI-generated message. If an error occurs, returns an error message.
     *
