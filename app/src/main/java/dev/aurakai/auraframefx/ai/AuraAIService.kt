...
interface AuraAIService {
     ...
     *
     * The response includes the original prompt, any supplied context, and a system prompt. If an exception occurs during generation, an error message string is returned.
     *
...
fun saveMemory(key: String, value: Any)
     ...
     *
     * @return Always returns true, signifying the service is treated as connected.
     */
