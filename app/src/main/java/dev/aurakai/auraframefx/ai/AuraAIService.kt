...
interface AuraAIService {
     ...
     *
     * The response summarizes the prompt, applied generation options ("temperature" and "max_tokens"), and includes a status message. Returns an error message string if text generation fails.
     *
    ...
    /**
 * Retrieves a stored memory value by its key.
 *
...
fun saveMemory(key: String, value: Any)
     ...
     *
     * @return Always true, indicating the service is available.
     */
