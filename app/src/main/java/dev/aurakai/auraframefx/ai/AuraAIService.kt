...
interface AuraAIService {
     ...
     *
     * Always returns a fixed string indicating the analytics query functionality is not yet implemented.
     *
    ...
    /**
     * Returns a formatted AI-generated response string based on the given prompt, optionally incorporating context and system instructions from the provided options.
     *
...
fun getMemory(memoryKey: String): String?
    ...
    /**
 * Persists a value under the specified key for future retrieval.
 *
