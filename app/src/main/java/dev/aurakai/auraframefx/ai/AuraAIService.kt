...
interface AuraAIService {
     ...
     * @return The generated image as a byte array, or null if image generation is not implemented.
     */
     ...
     *
     * If the `options` map contains "context" or "system_prompt", these values are included in the response. Returns a string summarizing the prompt, context, system prompt, and a generic AI-generated message. If an exception occurs, returns an error message.
     *
    ...
    /**
 * Retrieves a string value from memory associated with the given key.
 *
 ...
 *
 * Implementations must ensure that the value can be accessed using the same key.
 *
