...
class TaskScheduler @Inject constructor(
     ...
     *
     * Increments the total task count, updates the counts of active, completed, and pending tasks, refreshes the per-status task counts, and sets the last updated timestamp.
     *
