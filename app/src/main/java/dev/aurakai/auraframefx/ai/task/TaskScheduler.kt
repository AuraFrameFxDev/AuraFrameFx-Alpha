...
class TaskScheduler @Inject constructor(
     ...
     *
     * If the status is `COMPLETED`, moves the task from active to completed tasks. If the status is `FAILED`, removes it from active tasks and reports the failure. Updates the task record, refreshes task statistics, and triggers further scheduling.
     *
