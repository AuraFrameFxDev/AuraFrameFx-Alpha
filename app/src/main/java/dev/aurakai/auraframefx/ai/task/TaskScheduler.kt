...
class TaskScheduler @Inject constructor(
     ...
     *
     * If the task is completed, it is moved to the completed tasks collection. If the task fails, it is removed from active tasks and an error is reported. Task statistics are updated and the task queue is processed to continue execution of pending tasks.
     *
