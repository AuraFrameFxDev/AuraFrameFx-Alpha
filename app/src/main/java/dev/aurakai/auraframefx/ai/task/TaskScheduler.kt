...
class TaskScheduler @Inject constructor(
     ...
     *
     * Increments the total task count, updates counts for active, completed, and pending tasks, refreshes per-status task counts, and sets the last updated timestamp.
     */
