...
class TaskScheduler @Inject constructor(
    ...
    /**
     * Updates task statistics to reflect the current state after a task change.
     *
     * Refreshes counts for total, active, completed, and pending tasks, updates per-status counts, and sets the last updated timestamp.
     */
