...
class AuraAgent @Inject constructor(
     ...
     *
     * Routes the request to the appropriate creative handler based on its type, manages the agent's creative state during processing, and returns an `AgentResponse` containing the generated content and confidence score. On error, returns an error response with zero confidence and error details.
     *
     * @param request The creative AI request specifying the task type and details.
     * @return An `AgentResponse` with generated content, confidence score, and error information if processing fails.
     */
