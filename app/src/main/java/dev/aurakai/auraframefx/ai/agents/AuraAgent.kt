...
class AuraAgent @Inject constructor(
    ...
    /**
     * Processes a creative AI request and returns an agent response specific to the requested creative task.
     *
     * Routes the request to the appropriate creative handler based on its type, manages the agent's creative state during processing, and returns an `AgentResponse` containing the generated content and a confidence score. On error, returns an `AgentResponse` with an error message and zero confidence.
     *
