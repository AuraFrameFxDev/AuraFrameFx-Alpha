...
class AuraAgent @Inject constructor(
     ...
     *
     * Routes the request to the appropriate creative handler based on its type, updates the agent's creative state, and returns an `AgentResponse` containing the generated content and a confidence score. On error, returns an `AgentResponse` with an error message and zero confidence.
     *
