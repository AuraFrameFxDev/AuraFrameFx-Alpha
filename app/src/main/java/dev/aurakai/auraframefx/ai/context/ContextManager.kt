...
class ContextManager @Inject constructor(
     ...
     *
     * Filters active context chains by agent if specified, sorts them by most recent update, and limits the results according to configuration and query parameters. If no chains are found, returns a new chain initialized with the query string. Related chains are included if they meet the minimum relevance threshold.
     *
    ...
    /**
     * Updates context statistics based on the current set of active context chains.
     *
