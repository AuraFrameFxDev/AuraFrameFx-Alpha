...
class ContextManager @Inject constructor(
     ...
     *
     * The new chain is associated with the specified root context, initial content, agent, and optional string metadata. The chain is added to the active context collection and statistics are updated.
     *
     ...
     *
     * Filters active context chains by agent (if provided), sorts them by most recent update, and applies relevance and length constraints. If no matching chains are found, returns a new chain initialized with the query string as both root and current context.
     *
