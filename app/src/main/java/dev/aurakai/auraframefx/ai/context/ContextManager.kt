...
class ContextManager @Inject constructor(
     ...
     *
     * Filters active context chains by agent (if specified), sorts them by most recent update, and applies configuration and query limits. If no chains are found, returns a new chain initialized with the query string.
     *
