...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the provided root context, initial content, agent, and optional string metadata. The new chain is added to the active context registry, and context statistics are updated.
     *
     ...
     *
     * Adds the provided context, agent, and metadata to the specified chain, updating its history and last updated timestamp.
     *
     ...
     * @return The corresponding ContextChain if found, or null if no such chain exists.
     */
     ...
     *
     * Updates the total number of chains, the count of recently active chains, the length of the longest chain, and the timestamp of the last update.
     */
