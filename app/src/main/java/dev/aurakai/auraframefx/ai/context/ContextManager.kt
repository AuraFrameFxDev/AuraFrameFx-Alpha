...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain for the specified root context, agent, and optional metadata, storing all metadata values as strings. The new chain is added to the active context registry, and context statistics are updated.
     *
