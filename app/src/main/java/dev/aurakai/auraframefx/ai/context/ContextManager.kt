...
class ContextManager @Inject constructor(
     ...
     *
     * The chain is associated with the specified root context, initial content, agent, and optional metadata. Metadata values are stored as strings.
     *
    ...
    /**
     * Retrieves the most relevant context chain and a list of related chains matching the given query.
     *
     ...
     *
     * Updates the total number of chains, the count of recently active chains based on a configurable time window, the length of the longest chain, and the timestamp of the last update.
     */
