...
class ContextManager @Inject constructor(
     ...
     * @return The matching ContextChain, or null if no active chain exists for the ID.
     */
    ...
    /**
     * Recalculates and updates statistics for all active context chains, including total count, number of recently active chains, longest chain length, and the last update timestamp.
     *
     * A chain is considered recently active if its last update occurred within a configurable time window defined by the context chaining configuration.
     */
