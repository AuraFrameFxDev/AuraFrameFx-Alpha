...
class ContextManager @Inject constructor(
    ...
    /**
     * Updates context chain statistics, including total count, number of recently updated chains, longest chain length, and last update timestamp.
     *
     * Recalculates these statistics based on the current set of active context chains and updates the internal state.
     */
