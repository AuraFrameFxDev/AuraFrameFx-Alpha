...
class ContextManager @Inject constructor(
    ...
    /**
     * Retrieves the active context chain with the specified ID.
     *
     * @param chainId The unique identifier of the context chain.
     * @return The corresponding ContextChain if found, or null if no active chain matches the ID.
     */
     ...
     *
     * Updates include the total number of chains, the count of recently active chains (those updated within a configurable time window), the length of the longest chain, and the current timestamp.
     */
