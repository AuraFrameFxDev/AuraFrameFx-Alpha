...
class ContextManager @Inject constructor(
     ...
     *
     * The new context node is added to the chain's history, and the current context, agent-context mapping, and last updated timestamp are updated. All metadata values are stored as strings.
     *
     ...
     * @return The active ContextChain if found, or null otherwise.
     */
    ...
    /**
     * Returns the most relevant active context chain and related chains matching the given query criteria.
     *
     ...
     *
     * A chain is considered recently active if its last update occurred within a configurable time window defined in the configuration.
     */
