...
class ContextManager @Inject constructor(
     ...
     *
     * Calculates the total number of chains, the number of recently active chains (updated within a configurable time window), the length of the longest chain, and sets the last update timestamp.
     */
