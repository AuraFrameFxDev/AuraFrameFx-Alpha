...
class ContextManager @Inject constructor(
    ...
    /**
     * Creates and registers a new context chain initialized with the specified root context, initial content, agent, and optional metadata.
     *
     * The new chain starts with a single context node containing the initial content and metadata. The chain is added to the active contexts and statistics are updated.
     *
    ...
    /**
     * Retrieves the most relevant context chain and a list of related chains matching the given query criteria.
     *
