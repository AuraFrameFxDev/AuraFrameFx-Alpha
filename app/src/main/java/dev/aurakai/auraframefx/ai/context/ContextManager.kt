...
class ContextManager @Inject constructor(
     ...
     * @param initialContext Content for the initial context node.
     ...
     *
     * Filters active context chains by agent (if specified), sorts them by most recent update, and limits the results according to configuration and query parameters. If no matching chains are found, initializes a new chain with the query string as its context. Related chains are further filtered by minimum relevance and limited in count.
     *
     ...
     *
     * Updates the total number of chains, the count of recently active chains based on a configurable time threshold, the length of the longest chain, and the timestamp of the last update.
     */
