...
class ContextManager @Inject constructor(
     ...
     *
     * Appends a context node with the provided context, agent, and metadata (all metadata values stored as strings) to the specified chain. Updates the chain's history, current context, agent-context mapping, and last updated timestamp.
     *
     ...
     * @return The matching ContextChain, or null if no chain exists for the specified ID.
     */
     ...
     *
     * Filters active context chains by agent if specified, sorts them by most recent update, and applies relevance and length constraints. If no matching chains are found, returns a new chain initialized with the query string as both root and current context.
     *
    ...
    /**
     * Updates statistics for all active context chains, including total count, number of recently active chains, longest chain length, and the last updated timestamp.
     *
