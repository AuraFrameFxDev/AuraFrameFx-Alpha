...
class ContextManager @Inject constructor(
     ...
     *
     * The new chain is associated with the specified root context, initial content, agent, and optional string metadata.
     *
     ...
     *
     * Updates the chain's current context, agent-to-context mapping, and last updated timestamp.
     *
