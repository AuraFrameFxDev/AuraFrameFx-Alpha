...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the provided root context identifier, initial context content, agent type, and optional metadata. All metadata values are stored as strings. The new chain is added to the active context registry, and context statistics are updated.
     *
    ...
    /**
     * Appends a new context node to an existing context chain, updating its history, current context, agent mapping, and timestamp.
     *
