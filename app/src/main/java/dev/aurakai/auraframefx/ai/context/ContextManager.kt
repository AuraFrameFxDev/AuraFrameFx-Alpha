...
class ContextManager @Inject constructor(
     ...
     *
     * The chain is associated with the specified root context, initial content, agent, and optional string metadata.
     *
     ...
     *
     * Updates the chain's history, agent-to-context mapping, and last updated timestamp. Throws an IllegalStateException if the specified context chain does not exist.
     *
