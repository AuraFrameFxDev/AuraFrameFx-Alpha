...
class ContextManager @Inject constructor(
    ...
    /**
     * Updates an existing context chain by appending a new context node with the given context, agent, and metadata.
     *
     * The chain's history, current context, agent-to-context mapping, and last updated timestamp are updated. All metadata values are stored as strings.
     *
    ...
    /**
     * Updates the context chain statistics, including total chains, recently active chains, longest chain length, and last update timestamp.
     *
