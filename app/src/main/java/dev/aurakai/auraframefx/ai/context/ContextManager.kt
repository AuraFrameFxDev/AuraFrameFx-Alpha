...
class ContextManager @Inject constructor(
     ...
     *
     * Updates the total number of chains, counts chains considered recently active based on a configurable time window, determines the longest chain length, and sets the last updated timestamp.
     */
