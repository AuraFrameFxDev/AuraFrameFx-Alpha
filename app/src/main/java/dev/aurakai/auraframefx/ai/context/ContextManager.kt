...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the specified root context, initial content, agent, and optional metadata. The chain is added to the active context registry, and context statistics are updated.
     *
     ...
     *
     * Filters active context chains by agent (if specified), sorts them by most recent update, and applies relevance and length constraints. If no relevant chains are found, returns a new chain initialized with the query string.
     *
