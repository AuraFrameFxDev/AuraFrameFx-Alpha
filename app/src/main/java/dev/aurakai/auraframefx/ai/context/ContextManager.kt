...
class ContextManager @Inject constructor(
     ...
     *
     * Filters active context chains by agent if specified, sorts them by most recent update, and limits the results according to configuration and query parameters. If no matching chains are found, a new chain is created using the query string as both root and current context. Related chains are filtered by minimum relevance and limited in number.
     *
    ...
    /**
     * Updates the context chain statistics, including total chains, number of recently active chains, longest chain length, and the timestamp of the last update.
     *
