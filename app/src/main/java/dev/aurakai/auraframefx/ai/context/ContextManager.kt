...
class ContextManager @Inject constructor(
     ...
     *
     * Adds a new context node with the specified context, agent, and metadata (all metadata values are stored as strings) to the chain's history. Updates the current context, agent-context mapping, and last updated timestamp.
     *
    ...
    /**
     * Updates statistics for all context chains, including total count, number of recently active chains, longest chain length, and the last updated timestamp.
     *
