...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the provided root context, initial content, agent, and optional metadata. All metadata values are converted to strings before storage. The new chain is added to the active context registry, and context statistics are updated.
     *
    ...
    /**
     * Appends a new context node to an existing context chain, updating its current context, agent mapping, and last updated timestamp.
     *
     * All metadata values are converted to strings before being stored. Throws an IllegalStateException if the specified context chain does not exist.
     *
    ...
    /**
     * Updates context chain statistics, including total count, number of recently active chains, longest chain length, and the last updated timestamp.
     *
