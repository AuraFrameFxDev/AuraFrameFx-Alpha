...
class ContextManager @Inject constructor(
     ...
     *
     * Filters active context chains by agent (if specified), sorts them by most recent update, and limits the results based on configuration and query parameters. If no chains are found, a new chain is initialized with the query string. Related chains are included if they meet the minimum relevance threshold.
     *
    ...
    /**
     * Updates context chain statistics, including total count, number of active chains, longest chain length, and last update time.
     *
     * Recalculates statistics for all active context chains and updates the internal state accordingly.
     */
