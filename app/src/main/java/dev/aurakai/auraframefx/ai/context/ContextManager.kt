...
class ContextManager @Inject constructor(
     ...
     *
     * Updates the specified chain by adding a new context node with the provided context string, agent, and metadata. The chain's history, agent-to-context mapping, and last updated timestamp are updated accordingly. All metadata values are stored as strings.
     *
    ...
    /**
     * Finds the most relevant context chain and related chains based on the provided query criteria.
     *
