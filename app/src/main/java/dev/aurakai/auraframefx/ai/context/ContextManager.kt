...
class ContextManager @Inject constructor(
     ...
     *
     * The new chain is associated with the specified root context, initial content, agent, and optional string metadata. The chain is added to the set of active context chains, and statistics are updated accordingly.
     *
    ...
    /**
     * Returns the context chain with the given unique ID, or null if no such chain exists.
     *
