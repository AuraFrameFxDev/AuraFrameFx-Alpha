...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the provided root context identifier, initial content, agent, and optional metadata (all metadata values are stored as strings). The new chain is added to the active context registry, and context statistics are updated.
     *
    ...
    /**
     * Updates statistics for all context chains, including total count, number of recently active chains, longest chain length, and the most recent update timestamp.
     *
