...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the provided root context, initial content, agent, and optional metadata. All metadata values are converted to strings for storage. The new chain is added to the active context registry, and context statistics are updated.
     *
    ...
    /**
     * Appends a new context node with the given context, agent, and metadata to an existing context chain.
     *
    ...
    /**
     * Updates the context chain statistics, including total chains, number of recently active chains, longest chain length, and last updated timestamp.
     *
