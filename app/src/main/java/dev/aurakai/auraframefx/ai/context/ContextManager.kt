...
class ContextManager @Inject constructor(
    ...
    /**
     * Creates and registers a new context chain initialized with a root context, initial content, agent, and optional metadata.
     *
     ...
     * @param metadata Optional metadata for the context node and chain.
     ...
     *
     * Adds the provided context, agent, and metadata to the chain's history, updates the current context and agent mapping, and refreshes the last updated timestamp.
     *
    ...
    /**
     * Retrieves the most relevant context chain and related chains matching the specified query criteria.
     *
     ...
     *
     * Updates the total number of chains, the count of recently active chains (those updated within a configurable time window), the length of the longest chain, and the timestamp of the last update.
     */
