...
class ContextManager @Inject constructor(
     ...
     *
     * Updates the specified context chain by adding a new context node with the provided context string, agent, and optional metadata. The chain's history, agent-to-context mapping, and last updated timestamp are updated accordingly. All metadata values are stored as strings.
     *
