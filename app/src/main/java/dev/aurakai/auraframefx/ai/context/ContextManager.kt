...
class ContextManager @Inject constructor(
     ...
     *
     * Updates the specified chain with a new context, agent, and optional metadata, refreshing its history and last updated timestamp. All metadata values are stored as strings.
     *
     ...
     *
     * @param chainId Unique identifier of the context chain.
