...
class ContextManager @Inject constructor(
     ...
     *
     * Initializes a context chain using the specified root context, initial content, agent, and optional metadata. The chain is added to the active context registry, and statistics are updated.
     *
    ...
    /**
     * Finds the most relevant context chain and related chains based on the specified query criteria.
     *
     ...
     *
     * Recalculates the total number of chains, the number of recently active chains, the length of the longest chain, and updates the last statistics update timestamp.
     */
