...
class ContextManager @Inject constructor(
    ...
    /**
     * Creates a new context chain initialized with a single context node.
     *
     * The chain is associated with the specified root context, initial content, agent, and optional metadata. Metadata values are stored as strings. The new chain is added to the active context collection and statistics are updated.
     *
    ...
    /**
     * Appends a new context node to an existing context chain with updated context, agent, and metadata.
     *
     * Updates the specified context chain by adding a new context node, refreshing the agent-to-context mapping, and updating the last modified timestamp.
     *
    ...
    /**
     * Returns the context chain for the given unique chain ID, or null if it does not exist.
     *
