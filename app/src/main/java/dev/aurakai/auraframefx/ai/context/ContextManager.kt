...
class ContextManager @Inject constructor(
     ...
     *
     * Filters active context chains by agent (if specified), sorts them by most recent update, and limits the results according to configuration and query parameters. If no chains are found, a new chain is initialized with the query string. Related chains are selected based on a minimum relevance threshold.
     *
     ...
     *
     * This method recalculates statistics based on the current set of active context chains and updates the state accordingly.
     */
