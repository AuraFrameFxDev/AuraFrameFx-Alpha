...
class ContextManager @Inject constructor(
     ...
     *
     * The chain is created with the specified root context, initial content, agent, and optional metadata (all metadata values are stored as strings). The new chain is added to the set of active contexts, and context statistics are updated.
     *
     ...
     * @param newContext The context string to add as a new node in the chain.
