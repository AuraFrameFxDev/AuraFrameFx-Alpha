...
class ContextManager @Inject constructor(
    ...
    /**
     * Adds a new context node to an existing context chain with the given context, agent, and metadata.
     *
     * Updates the chain's current context, history, agent-to-context mapping, and last updated timestamp. All metadata values are stored as strings.
     *
    ...
    /**
     * Returns the most relevant context chain and related chains based on the provided query criteria.
     *
     ...
     *
     * Recalculates statistics for all active context chains and updates the state accordingly.
     */
