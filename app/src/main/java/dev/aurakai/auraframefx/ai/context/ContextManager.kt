...
class ContextManager @Inject constructor(
     ...
     *
     * The new chain starts with a single context node containing the initial content and metadata, and is tracked as an active context chain.
     *
     ...
     *
     * Updates the chain's current context, history, agent-to-context mapping, and last updated timestamp.
     *
