...
class ContextManager @Inject constructor(
     ...
     *
     * Modifies the chain's current context, extends its history, updates agent-to-context mapping, and refreshes the last updated timestamp. All metadata values are stored as strings.
     *
     ...
     *
     * Updates the total number of chains, counts chains considered recently active based on a configurable time window, determines the longest chain length, and sets the last update timestamp.
     */
