...
class ContextManager @Inject constructor(
    ...
    /**
     * Returns the context chain for the given unique chain ID, or null if no such chain exists.
     *
    ...
    /**
     * Returns the most relevant context chain and a list of related chains matching the given query criteria.
     *
    ...
    /**
     * Updates the context statistics, including total number of chains, count of recently active chains, length of the longest chain, and the last updated timestamp.
     *
