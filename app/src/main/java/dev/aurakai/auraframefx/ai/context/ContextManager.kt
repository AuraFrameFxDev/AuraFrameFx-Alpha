...
class ContextManager @Inject constructor(
     ...
     *
     * The new chain contains a single context node with the provided content and metadata, and is added to the set of active context chains.
     *
    ...
    /**
     * Returns the active context chain for the given chain ID, or null if not found.
     *
