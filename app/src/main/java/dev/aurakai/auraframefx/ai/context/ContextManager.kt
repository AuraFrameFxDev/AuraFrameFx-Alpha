...
class ContextManager @Inject constructor(
     ...
     *
     * Updates the total number of chains, counts those considered active within a recent configurable time window, determines the length of the longest chain, and records the current timestamp as the last update.
     */
