 ...
 */
    ...
    /**
 * Analyzes image data using a specified prompt and returns the analysis result.
 *
 * @param imageData The raw bytes of the image to analyze.
 * @param prompt The prompt describing what to analyze or extract from the image.
