 ...
 */
    ...
    /**
 * Analyzes the provided image data using the given prompt and returns the analysis result as a string.
 *
 * @param imageData The raw bytes of the image to analyze.
 * @param prompt The textual prompt that guides the analysis.
