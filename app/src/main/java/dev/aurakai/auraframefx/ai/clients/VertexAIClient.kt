 ...
 *
 * This method prepares the necessary models to support creative content generation tasks.
 */
    suspend fun initializeCreativeModels()

    /**
 * Analyzes the provided image data based on a guiding prompt and returns the analysis result as a string.
 *
