 ...
 *
 * @param specification Description of the required functionality or features for the code.
 ...
 *
 * Prepares and configures the required models for generating creative content.
 */
 ...
 * @param prompt The text prompt providing context or direction for the analysis.
