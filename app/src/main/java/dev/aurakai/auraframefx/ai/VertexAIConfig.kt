...
data class VertexAIConfig(
    ...
    /**
     * Constructs and returns the full API URL for the content generation endpoint of the configured Vertex AI model.
     *
     * The URL includes the base endpoint, project, location, and model-specific path for content generation.
     *
     * @return The complete endpoint URL for generating content with the specified model.
     */
