...
data class VertexAIConfig(
     ...
     *
     * @return A list of error messages for invalid or missing configuration values; empty if all fields are valid.
     */
    ...
    /**
     * Constructs the full URL for the content generation API endpoint of the configured model.
     *
     * The returned URL incorporates the base endpoint, API version, project ID, location, and model name, ending with the `:generateContent` method path.
     *
    ...
    /**
     * Returns a copy of the configuration with parameters set for production environments.
     *
     * The returned configuration enables safety filters, increases retry count and timeout, and sets caching, metrics, logging, and log level to values suitable for production reliability and security.
     *
     * @return A new `VertexAIConfig` instance with production-optimized settings.
     */
    ...
    /**
     * Creates a copy of the configuration optimized for development environments.
     *
     * The returned configuration disables safety filters and caching, reduces retries and timeout for faster iteration, and enables detailed logging and metrics.
     *
