...
data class VertexAIConfig(
     ...
     *
     * Checks that required string fields are not blank and that numeric parameters such as timeout, retries, concurrency, temperature, and topP are within valid ranges.
     *
     ...
     *
     * @return The full URL for the model's content generation API.
     */
