...
data class VertexAIConfig(
    ...
    /**
     * Builds the full base URL for Vertex AI API requests using the configured endpoint, API version, project ID, and location.
     *
    ...
    /**
     * Builds the full URL for the Vertex AI content generation endpoint using the configured model.
     *
     * Combines the base endpoint, API version, project ID, location, and model name to form the complete URL for content generation requests.
     *
