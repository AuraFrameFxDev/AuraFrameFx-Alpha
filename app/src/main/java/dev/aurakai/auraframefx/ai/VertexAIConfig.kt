...
data class VertexAIConfig(
    ...
    /**
     * Constructs the full base URL for Vertex AI API requests using the configured endpoint, API version, project ID, and location.
     *
     * @return The complete base endpoint URL for Vertex AI API requests.
     */
    ...
    /**
     * Constructs the full URL for the Vertex AI content generation endpoint using the current configuration.
     *
     * Combines the base endpoint, API version, project ID, location, and model name to generate the complete request URL for content generation.
     *
    ...
    /**
     * Returns a copy of the configuration with recommended settings for production environments.
     *
     * The production configuration enables safety filters, increases retry and timeout limits, activates caching, metrics, and logging, and sets the log level to "WARN" for enhanced reliability and security.
     *
    ...
    /**
     * Returns a configuration copy optimized for development and testing environments.
     *
     * The development configuration disables safety filters and caching, reduces retries and timeouts for rapid iteration, and enables metrics and verbose logging.
     *
