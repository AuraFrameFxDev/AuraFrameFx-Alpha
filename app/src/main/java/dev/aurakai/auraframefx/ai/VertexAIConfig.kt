...
data class VertexAIConfig(
     ...
     *
     * Checks that required fields are set and numeric parameters are within acceptable ranges.
     *
    ...
    /**
     * Constructs and returns the full URL for the model's content generation API endpoint using the current configuration.
     *
