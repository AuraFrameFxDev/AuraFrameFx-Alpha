...
data class VertexAIConfig(
     ...
     *
     * Validates that required string fields are not blank and that numeric and generation parameters are within acceptable ranges.
     *
     * @return A list of error messages for each invalid field; returns an empty list if all fields are valid.
     */
    ...
    /**
     * Constructs the full URL for the content generation API endpoint of the configured Vertex AI model.
     *
     ...
     *
     * The production configuration enables safety filters, increases the retry count and timeout, activates caching, metrics, and logging, and sets the log level to "WARN" for reduced verbosity.
     *
     ...
     *
     * The development configuration disables safety filters and caching, reduces retries and timeout for quicker feedback, and enables detailed logging and metrics with a "DEBUG" log level.
     *
