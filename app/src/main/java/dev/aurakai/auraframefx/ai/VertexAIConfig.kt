...
data class VertexAIConfig(
     ...
     *
     * Validates that required fields are present and numeric parameters are within acceptable ranges.
     *
     ...
     *
     * @return The constructed base endpoint URL as a string.
     */
    ...
    /**
     * Returns the full URL for the content generation API endpoint for the configured model.
     *
     ...
     *
     * The development configuration disables safety filters and caching, reduces retries and timeout for faster iteration, and enables verbose logging and metrics for debugging.
     *
     * @return A new `VertexAIConfig` instance tailored for development environments.
     */
