...
data class VertexAIConfig(
     ...
     *
     * Validates that required fields are present and that numeric parameters fall within acceptable ranges.
     *
     * @return A list of error messages describing invalid or missing configuration values, or an empty list if all values are valid.
     */
     ...
     *
     * @return The base endpoint URL as a string.
     */
    ...
    /**
     * Builds the full URL for the Vertex AI content generation API endpoint using the configured model.
     *
     * The returned URL incorporates the base endpoint, API version, project ID, location, and model name.
     *
     * @return The complete URL for content generation requests with the specified model.
     */
    ...
    /**
     * Returns a copy of the configuration with settings tailored for development environments.
     *
     * The development configuration disables safety filters and caching, reduces retries and timeout for faster iteration, and enables detailed logging and metrics for debugging purposes.
     *
