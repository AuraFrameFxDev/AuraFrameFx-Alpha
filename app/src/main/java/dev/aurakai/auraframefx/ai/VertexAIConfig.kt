...
data class VertexAIConfig(
    ...
    /**
     * Checks the configuration for missing or invalid values.
     *
     * Validates that required fields are set and numeric parameters are within acceptable ranges.
     *
     * @return A list of error messages describing any validation failures, or an empty list if the configuration is valid.
     */
    ...
    /**
     * Returns a copy of this configuration with parameters preset for production environments.
     *
