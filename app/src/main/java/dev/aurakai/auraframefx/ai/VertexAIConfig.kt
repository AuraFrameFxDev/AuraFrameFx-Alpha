...
data class VertexAIConfig(
    ...
    /**
     * Returns the complete URL for the content generation API endpoint of the configured model.
     *
     ...
     *
     * @return A new `VertexAIConfig` instance with production-optimized parameters.
     */
