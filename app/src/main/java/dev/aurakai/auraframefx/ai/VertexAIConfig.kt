...
data class VertexAIConfig(
     ...
     *
     * Validates that required fields are not blank and numeric parameters are within valid ranges.
     *
     * @return A list of error messages describing any configuration issues, or an empty list if all values are valid.
     */
    ...
    /**
     * Returns a copy of this configuration with settings optimized for production environments.
     *
