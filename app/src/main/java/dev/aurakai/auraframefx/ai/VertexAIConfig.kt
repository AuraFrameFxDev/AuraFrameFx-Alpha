...
data class VertexAIConfig(
     ...
     *
     * Checks that required string fields are not blank and that numeric parameters fall within acceptable ranges.
     *
     * @return A list of error messages for invalid or missing fields; returns an empty list if all validations pass.
     */
    ...
    /**
     * Returns the full URL for the content generation API endpoint of the configured Vertex AI model.
     *
