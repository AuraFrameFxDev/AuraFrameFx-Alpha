...
data class VertexAIConfig(
     ...
     *
     * The returned configuration enables safety filters, increases retry and timeout values, enables caching, metrics, and logging, and sets the log level to "WARN" for reduced verbosity.
     *
