...
data class VertexAIConfig(
     ...
     *
     * The production configuration enables safety filters, increases retry attempts and timeout duration, and sets caching, metrics, and logging to values that prioritize reliability and security.
     *
