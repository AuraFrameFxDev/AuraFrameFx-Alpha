...
data class VertexAIConfig(
    ...
    /**
     * Validates the configuration and returns a list of error messages for any invalid or missing values.
     *
     * Checks that required string fields are not blank and that numeric parameters are within valid ranges.
     *
     * @return A list of error messages if any configuration values are invalid or missing; an empty list if the configuration is valid.
     */
    ...
    /**
     * Constructs and returns the base URL for Vertex AI API requests using the configured endpoint, API version, project ID, and location.
     *
     * @return The full base endpoint URL for Vertex AI API requests.
     */
     ...
     *
     * The returned URL incorporates the base endpoint, API version, project ID, location, and model name, ending with the `generateContent` action.
     *
