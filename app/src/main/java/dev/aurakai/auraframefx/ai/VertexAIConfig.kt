...
data class VertexAIConfig(
     ...
     *
     * The returned configuration disables safety filters and caching, reduces retry and timeout values for rapid iteration, and enables verbose logging and metrics to support debugging.
     *
