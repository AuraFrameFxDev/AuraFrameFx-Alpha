...
data class VertexAIConfig(
    ...
    /**
     * Returns the complete URL for the content generation API endpoint based on the current configuration.
     *
     * The URL includes the base endpoint, API version, project ID, location, and model name.
     *
     * @return The fully constructed endpoint URL for content generation requests.
     */
