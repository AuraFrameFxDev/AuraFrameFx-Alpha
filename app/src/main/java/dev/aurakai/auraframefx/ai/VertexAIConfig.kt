...
data class VertexAIConfig(
    ...
    /**
     * Builds the base URL for Vertex AI API requests based on the current configuration.
     *
     ...
     *
     * @return The fully constructed endpoint URL for invoking content generation with the specified model.
     */
     ...
     *
     * The production configuration enforces safety filters, increases retry attempts and request timeout, enables caching, metrics, and logging, and sets the log level to "WARN" to enhance reliability and security.
     *
