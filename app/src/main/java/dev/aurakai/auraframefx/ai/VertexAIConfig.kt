...
data class VertexAIConfig(
    ...
    /**
     * Returns the complete URL for the content generation endpoint of the configured Vertex AI model.
     *
     ...
     *
     * Enables safety filters, increases retry count and timeout, and configures caching, metrics, logging, and log level for production reliability.
     *
    ...
    /**
     * Returns a configuration copy tailored for development use.
     *
     * The development configuration disables safety filters and caching, lowers retry count and timeout for rapid iteration, and enables verbose logging and metrics.
     *
