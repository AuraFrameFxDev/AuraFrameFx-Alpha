...
data class VertexAIConfig(
     ...
     *
     * The returned URL includes the base endpoint, API version, project ID, location, and model name.
     *
     ...
     *
     * The production configuration enables safety filters, increases the retry count and timeout, activates caching, metrics, and logging, and sets the log level to "WARN" for improved reliability and security.
     *
