...
data class VertexAIConfig(
     ...
     *
     * The production configuration enables safety filters, increases the retry count to 5, sets the timeout to 60,000 ms, enables caching, metrics, and logging, and sets the log level to "WARN" for improved reliability and security.
     *
