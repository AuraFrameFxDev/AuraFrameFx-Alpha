...
data class VertexAIConfig(
     ...
     *
     * Checks that required fields are not blank and that numeric parameters are within acceptable ranges.
     *
     ...
     *
     * The returned configuration disables safety filters and caching, reduces retry and timeout values for rapid iteration, and enables detailed logging and metrics for debugging purposes.
     *
     * @return A new `VertexAIConfig` instance tailored for development use.
     */
