...
data class VertexAIConfig(
     ...
     *
     * @return A list of error messages describing configuration issues, or an empty list if valid.
     */
    ...
    /**
     * Constructs the full URL for the model's content generation API endpoint using the current configuration.
     *
     * @return The complete endpoint URL for invoking content generation with the specified model.
     */
    ...
    /**
     * Returns a configuration copy optimized for production use.
     *
     ...
     *
     * @return A new `VertexAIConfig` instance with production-focused settings.
     */
