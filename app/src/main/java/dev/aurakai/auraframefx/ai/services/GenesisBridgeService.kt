...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Sends a request to the Genesis Python backend to trigger the specified fusion ability, optionally including additional context.
     *
     ...
     *
     * @param request The AI request whose query is analyzed for fusion-related terms.
    ...
    /**
     * Sends a serialized request to the Genesis Python backend and returns its response.
     *
...
private class PythonProcessManager(
     ...
     *
     * Ensures the target directory exists and transfers all required Genesis backend files from the app's assets to internal storage. Logs a warning if any file cannot be copied.
     *
