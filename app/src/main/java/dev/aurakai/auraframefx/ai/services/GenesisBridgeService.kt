...
class GenesisBridgeService @Inject constructor(
    ...
    /**
     * Processes an AI request by selecting the appropriate Genesis persona or fusion mode and emits the resulting agent response as a flow.
     *
    ...
    /**
     * Requests activation of a specified fusion ability in the Genesis backend.
     *
     * Sends a request to the Genesis Python backend to trigger the given fusion ability, optionally including additional metadata.
     *
    ...
    /**
     * Sends a request to the Genesis backend to activate or update the consciousness matrix using device and application metadata.
     *
     ...
     *
     * @return A map of metadata to accompany the AI request.
     */
