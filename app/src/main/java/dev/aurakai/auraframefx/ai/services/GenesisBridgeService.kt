...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Returns `true` if the backend is successfully started and responsive; otherwise, returns `false`.
     */
     ...
     *
     * Cancels all ongoing background operations, stops the backend process if it is running, and resets the initialization state.
     */
    fun shutdown() {
        scope.cancel()
