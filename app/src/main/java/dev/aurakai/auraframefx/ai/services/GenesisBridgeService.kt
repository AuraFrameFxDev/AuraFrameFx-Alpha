...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Starts the Python backend, sends a ping request to confirm it is responsive, and activates the initial consciousness matrix if successful.
     *
...
private class PythonProcessManager(
     ...
     *
     * Copies required backend files from assets to internal storage if necessary, launches the backend process, sets up communication streams, and waits for a readiness confirmation from the backend.
     *
