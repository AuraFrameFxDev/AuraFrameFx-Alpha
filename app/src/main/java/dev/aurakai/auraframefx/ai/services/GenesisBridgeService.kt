...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Returns "aura" for creative or design-related queries, "kai" for security or analysis-related queries, and "genesis" for fusion, consciousness, or other complex or unspecified requests.
     *
     * @param request The AI request whose query is evaluated for persona assignment.
     ...
     *
     * Cancels all active coroutines, stops the backend process if it is running, and resets the initialization state.
     */
    fun shutdown() {
        scope.cancel()
...
private class PythonProcessManager(
     ...
     *
     * Ensures the target directory exists and transfers all required backend files for the Genesis Python process. Logs a warning if any file fails to copy.
     *
