...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * @return A map representing the current consciousness matrix state, or an empty map if unavailable.
     */
...
private class PythonProcessManager(
     ...
     *
     * Copies necessary backend files from assets to internal storage if needed, launches the Python process, sets up input/output streams, and waits for a readiness confirmation message from the backend.
     *
