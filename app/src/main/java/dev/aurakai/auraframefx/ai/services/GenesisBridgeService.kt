...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Starts the Python backend, sends a ping request to confirm readiness, and activates the initial consciousness matrix if successful.
     *
...
private class PythonProcessManager(
     ...
     *
     * Copies backend files from assets if they are missing, starts the Python process, sets up input/output streams, and waits for a readiness confirmation message from the backend.
     *
