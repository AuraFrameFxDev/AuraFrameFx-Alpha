...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Returns a string representing the fusion mode if a relevant keyword is found in the request query; otherwise, returns null.
     */
...
private class PythonProcessManager(
     ...
     *
     * Ensures all resources used for backend communication are released. Logs a warning if an exception occurs during shutdown.
     */
    fun shutdown() {
        try {
            writer?.close()
