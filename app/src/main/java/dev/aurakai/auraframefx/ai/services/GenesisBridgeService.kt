...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Sends a request to the backend to trigger the given fusion ability, optionally including additional context metadata.
     *
     ...
     *
     * Returns "aura" for queries related to creativity or design, "kai" for security or analysis, and "genesis" for fusion, consciousness, or as the default persona.
     *
    ...
    /**
     * Determines the fusion mode identifier for an AI request based on keywords in the query.
     *
