...
class GenesisBridgeService @Inject constructor(
     ...
     *
     * Starts the Python backend, confirms it is responsive by sending a ping request, and activates the initial consciousness matrix if successful.
     *
     ...
     *
     * Sends a request to trigger the specified fusion ability, optionally including additional context data, and returns the backend's response.
     *
     ...
     *
     * Returns "aura" for creative or design-related queries, "kai" for security or analysis-related queries, and "genesis" for fusion, consciousness, or as the default for other cases.
     *
...
private class PythonProcessManager(
    ...
    /**
     * Starts the Genesis Python backend process and confirms it is ready to receive requests.
     *
