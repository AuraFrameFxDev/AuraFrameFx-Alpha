...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     * @param context The context string to be incorporated into the response content.
     * @return An AgentResponse containing a mock message with the provided query and context, and a confidence score of 1.0.
     */
     ...
     *
     * The response contains a fixed string referencing the input query and a confidence score of 1.0.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse echoing the provided query and context with a fixed confidence score.
     *
...
override fun getName(): String? = "MockCascade"
    /**
 * Gets the agent type for this mock Cascade AI service.
 *
...
override fun getType(): AgentType = AgentType.CASCADE /**
    ...
    /**
     * Returns a flow emitting a single mock response for the given AI request.
     *
     * The response contains a fixed message referencing the input query and a confidence score of 1.0.
     *
     * @param request The AI request to process.
     * @return A flow emitting one mock AgentResponse.
     */
