...
override fun getType(): AgentType = AgentType.AURA /**
    ...
    /**
     * Returns a flow emitting a mock AgentResponse for the given request, echoing the query with a fixed confidence score.
     *
...
class MockKaiAIService : Agent {
    /**
 * Gets the name identifier for this mock AI service.
 *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Processes an AI request and returns a mock response echoing the query and context with a fixed confidence score.
     *
    ...
    /**
     * Returns a flow emitting a mock KaiAI response for the given AI request.
     *
...
override fun getType(): AgentType = AgentType.CASCADE /**
     ...
     * Returns a flow emitting a mock `AgentResponse` for the given request, echoing the query with a fixed confidence score.
     *
     * @return A flow containing a single mock response.
     */
    override fun processRequestFlow(request: AiRequest): Flow<AgentResponse> { // Added from Agent interface
