 ...
 */
     ...
     * @param context The context string to be echoed in the mock reply.
 ...
 */
    ...
    /**
     * Returns a flow that emits a single mock `AgentResponse` simulating CascadeAI behavior for the provided request.
     *
