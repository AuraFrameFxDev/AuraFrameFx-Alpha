...
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse for KaiAI, echoing the provided query and context with a fixed confidence score of 1.0.
     *
     * @param request The AI request whose query is echoed in the response content.
 ...
 *
 * @return The constant value {@link AgentType#CASCADE}.
 */
