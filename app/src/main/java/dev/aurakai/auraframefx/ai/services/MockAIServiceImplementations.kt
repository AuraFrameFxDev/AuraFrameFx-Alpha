 ...
 */
    ...
    /**
     * Generates a mock AgentResponse that echoes the input query and context with a fixed confidence score.
     *
    ...
    /**
     * Returns a flow emitting a single mock `AgentResponse` that echoes the input query with a fixed confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Returns a flow emitting a single mock `AgentResponse` for the given request, simulating a CascadeAI response.
     *
     * The emitted response includes the input query and a fixed confidence score of 1.0.
     *
     * @return A flow that emits one mock `AgentResponse`.
     */
    override fun processRequestFlow(request: AiRequest): Flow<AgentResponse> { // Added from Agent interface
