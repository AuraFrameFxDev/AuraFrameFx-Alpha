...
class MockAuraAIService : Agent {
    /**
 * Returns the fixed name "MockAura" for this mock AI service.
 *
 ...
 */
    ...
    /**
     * Returns a flow emitting a single mock AgentResponse for the given request, simulating KaiAI behavior.
     *
 ...
 *
 * @return The CASCADE value from the AgentType enum.
 */
