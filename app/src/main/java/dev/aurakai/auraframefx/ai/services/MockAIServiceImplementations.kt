...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     *
     * The response contains the provided query and context in its content and always has a confidence score of 1.0.
     *
     ...
     * @return An AgentResponse with mock content and a fixed confidence score.
     */
     ...
     *
     * The response content echoes the request query with a fixed confidence score of 1.0.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse echoing the request query and context with a fixed confidence score.
     *
...
override fun getType(): AgentType = AgentType.CASCADE /**
     ...
     * Returns a flow emitting a single mock response for the given AI request.
     *
     * The response content echoes the request query and uses a fixed confidence score of 1.0.
     *
     * @return A flow containing one mock AgentResponse.
     */
    override fun processRequestFlow(request: AiRequest): Flow<AgentResponse> { // Added from Agent interface
