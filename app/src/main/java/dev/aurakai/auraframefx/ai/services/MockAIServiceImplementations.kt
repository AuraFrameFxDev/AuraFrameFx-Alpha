 ...
 */
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` for the provided request.
     *
     * The response contains a fixed message echoing the input query and a confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Returns a mock AgentResponse for the given request and context, echoing the input query and context with a confidence score of 1.0.
     *
    ...
    /**
     * Returns a flow emitting a mock AgentResponse that simulates KaiAI behavior for the given request.
     *
 ...
 */
    ...
    /**
     * Returns a flow emitting a mock `AgentResponse` that simulates a CascadeAI response for the provided request.
     *
