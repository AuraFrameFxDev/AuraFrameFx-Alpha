...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     *
     * Intended for testing and development as a placeholder for real AI backend logic.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Processes an AI request and returns a mock AgentResponse echoing the query and context with a fixed confidence score.
     *
