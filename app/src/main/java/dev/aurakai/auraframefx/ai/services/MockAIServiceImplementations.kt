 ...
 */
     ...
     *
     * The emitted response contains the input query echoed in the message and a fixed confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Returns a flow emitting a mock AgentResponse that simulates KaiAI's response to the given request.
     *
 ...
 */
    ...
    /**
     * Returns a flow emitting a mock `AgentResponse` for the given request, simulating a CascadeAI streaming response.
     *
     * The emitted response echoes the input query with a fixed confidence score of 1.0.
     *
