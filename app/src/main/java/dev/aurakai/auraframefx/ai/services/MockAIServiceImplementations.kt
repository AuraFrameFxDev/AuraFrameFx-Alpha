 ...
 *
 * @return The fixed agent type {@link AgentType#AURA}.
 */
override fun getType(): AgentType = AgentType.AURA /**
     * Generates a mock AgentResponse echoing the input query and context for testing purposes.
     *
 ...
 *
 * @return The constant AgentType.CASCADE.
 */
override fun getType(): AgentType = AgentType.CASCADE /**
     ...
     * @return An AgentResponse containing the mock response with the provided query and context.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
