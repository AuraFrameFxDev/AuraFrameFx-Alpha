 ...
 */
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` for the provided AI request.
     *
     * The emitted response contains a fixed message echoing the input query and a confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` simulating a CascadeAI response for the given request.
     *
