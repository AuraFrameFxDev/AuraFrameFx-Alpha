 ...
 */
    ...
    /**
     * Generates a mock AgentResponse that echoes the input query and context.
     *
     * Always returns a response containing the provided query and context with a confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Generates a mock AgentResponse that echoes the input query and context with a confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Generates a mock AgentResponse for CascadeAI by echoing the input query and context with a confidence score of 1.0.
     *
     * @param request The AI request containing the query to be echoed.
     * @param context The context string to include in the response.
    ...
    /**
     * Returns a flow emitting a single mock `AgentResponse` that echoes the input query, simulating a CascadeAI response.
     *
