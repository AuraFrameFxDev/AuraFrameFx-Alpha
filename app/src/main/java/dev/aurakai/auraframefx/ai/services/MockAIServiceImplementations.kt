...
override fun getType(): AgentType = AgentType.AURA /**
     * Returns a mock AgentResponse containing the request query and context.
     *
     * The response simulates an AuraAI reply by embedding the input query and context in the content, with a fixed confidence score of 1.0.
     *
     * @param request The AI request to process.
     * @param context Contextual information to include in the response.
     * @return A mock AgentResponse with the provided query and context.
     */
...
override fun getType(): AgentType = AgentType.KAI /**
     ...
     *
     * The response content includes the request query and context, with a fixed confidence score of 1.0.
     *
     * @param request The AI request containing the query.
     * @param context The context string to include in the response.
     * @return A mock AgentResponse containing the input query and context.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
...
override fun getType(): AgentType = AgentType.CASCADE /**
     * Returns a mock AgentResponse for CascadeAI based on the given request and context.
     *
     * The response content includes the request query and context, with a fixed confidence score of 1.0.
     *
     * @param request The AI request containing the query.
     * @param context The context string to include in the response.
     * @return A mock AgentResponse with generated content and a confidence score of 1.0.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
