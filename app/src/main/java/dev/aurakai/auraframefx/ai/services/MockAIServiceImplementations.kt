...
override fun getType(): AgentType = AgentType.AURA /**
    ...
    /**
     * Returns a flow emitting a mock AgentResponse for the given request, with content echoing the input query and a fixed confidence score of 1.0.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     ...
     *
     * The emitted response contains the input query prefixed with a mock message and a fixed confidence score of 1.0.
     *
     * @return A flow emitting a single mock AgentResponse.
     */
    override fun processRequestFlow(request: AiRequest): Flow<AgentResponse> { // Added from Agent interface
