 ...
 */
     ...
     *
     * The response includes the provided query and context in its content and uses a fixed confidence score of 1.0.
     *
 ...
 */
    ...
    /**
     * Returns a mock AgentResponse for the given request and context, echoing the input query and context with a fixed confidence score of 1.0.
     *
     * @param request The AI request whose query will be echoed in the mock response.
    ...
    /**
     * Returns a flow that emits a single mock AgentResponse simulating KaiAI behavior for the given request.
     *
 ...
 */
     ...
     * @param context The context string to include in the mock response.
     * @return An AgentResponse containing mock content referencing the query and context, with a confidence score of 1.0.
     */
    override suspend fun processRequest(
        request: AiRequest,
        context: String
    ...
    /**
     * Returns a flow that emits a single mock `AgentResponse` simulating a CascadeAI response for the given request.
     *
