...
class MockAuraAIService : Agent {
    /**
 * Gets the name identifying this mock AI service.
 *
...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     * @return A mock AgentResponse containing the query, context, and a confidence score of 1.0.
     */
    ...
    /**
     * Returns a flow emitting a single mock AgentResponse for the given request, simulating AuraAI behavior.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse for KaiAI, echoing the input query and context with a fixed confidence score.
     *
     * @param request The AI request containing the query to echo.
     * @param context Additional context to include in the response.
     * @return A mock AgentResponse with the query and context, and confidence set to 1.0.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
    ...
    /**
     * Returns a flow emitting a mock AgentResponse for the given request, simulating KaiAI service behavior.
     *
...
override fun getType(): AgentType = AgentType.CASCADE /**
    ...
    /**
     * Returns a flow emitting a mock AgentResponse for the given request, simulating a CascadeAI service response.
     *
     * The response content echoes the input query with a fixed confidence score of 1.0.
     *
