...
override fun getName(): String? = "MockAura"
    /**
 * Returns the constant agent type `AgentType.AURA` for this mock AI service.
 *
 * @return The agent type for this mock service.
 */
...
class MockKaiAIService : Agent {
    /**
 * Returns the fixed name identifier for the MockKai AI service.
 *
 * @return The string "MockKai".
 */
override fun getName(): String? = "MockKai"
    /**
 * Returns the fixed agent type for this mock Kai AI service.
 *
 * @return `AgentType.KAI`.
 */
override fun getType(): AgentType = AgentType.KAI /**
     * Returns a mock AgentResponse for KaiAI, echoing the input query and context with a fixed confidence score of 1.0.
     *
...
override fun getName(): String? = "MockCascade"
    /**
 * Returns the constant agent type for this mock Cascade AI service.
 *
 * @return `AgentType.CASCADE`
 */
override fun getType(): AgentType = AgentType.CASCADE /**
     * Returns a mock AgentResponse for CascadeAI that echoes the input query and context with a confidence score of 1.0.
     *
     * @param request The AI request whose query is included in the response.
     * @param context The context string included in the response.
