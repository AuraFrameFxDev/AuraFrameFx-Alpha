 ...
 */
    ...
    /**
     * Returns a mock AgentResponse echoing the input query and context with a fixed confidence score.
     *
     * Used for testing and development, this method simulates an AI response by including the provided query and context in the response content.
     *
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` echoing the input query with a fixed confidence score.
     *
     * @return A flow emitting a single mock `AgentResponse` for the provided request.
     */
 ...
 */
    ...
    /**
 * Returns the agent type identifier for this mock Kai AI service.
 *
 ...
 */
    ...
    /**
     * Returns a flow that emits a mock AgentResponse echoing the input query, simulating KaiAI behavior.
     *
 ...
 *
 * @return The AgentType.CASCADE value indicating this is a Cascade mock agent.
 */
     ...
     * @return An AgentResponse containing mock content referencing the query and context, with confidence set to 1.0.
     */
    override suspend fun processRequest(
        request: AiRequest,
        context: String
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` for the given request, simulating a CascadeAI response.
     *
