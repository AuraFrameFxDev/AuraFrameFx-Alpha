...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     * @return A mock AgentResponse containing the input query, context, and a confidence score of 1.0.
     */
    ...
    /**
     * Returns a flow emitting a mock `AgentResponse` for the given request, echoing the input query with a fixed confidence score of 1.0.
     *
...
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse for the given request and context, echoing the input with a fixed confidence score of 1.0.
     *
    ...
    /**
     * Returns a flow emitting a mock AgentResponse for the given request, echoing the input query with a fixed confidence score.
     *
     * @return A Flow containing a single mock AgentResponse.
     */
    override fun processRequestFlow(request: AiRequest): Flow<AgentResponse> { // Added from Agent interface
