 ...
 *
 * @return The AgentType representing this mock AI service (AURA).
 */
override fun getType(): AgentType = AgentType.AURA /**
     * Generates a mock AgentResponse based on the provided AI request and context.
     *
...
class MockKaiAIService : Agent {
    /**
 * Gets the name of this mock AI service.
 *
 ...
 *
 * @return The AgentType.KAI value indicating this is a mock Kai agent.
 */
 ...
 * Gets the type of this agent.
 *
 * @return The AgentType.CASCADE enum value indicating this is a Cascade agent.
 */
override fun getType(): AgentType = AgentType.CASCADE /**
     * Processes an AI request and context, returning a mock AgentResponse for CascadeAI.
     *
     * @param request The AI request containing the query.
     * @param context Additional context to include in the response.
     * @return An AgentResponse with mock content reflecting the query and context, and a confidence score of 1.0.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
