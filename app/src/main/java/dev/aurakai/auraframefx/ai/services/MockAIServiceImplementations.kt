...
override fun getType(): AgentType = AgentType.AURA /**
     ...
     *
     * The response contains the provided query and context, with a fixed confidence score of 1.0.
     *
 ...
 *
 * @return The [`AgentType.KAI`][AgentType] enum value.
 */
override fun getType(): AgentType = AgentType.KAI /**
     ...
     * @return An AgentResponse with mock content and confidence set to 1.0.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
...
override fun getType(): AgentType = AgentType.CASCADE /**
     ...
     * @return An AgentResponse containing a mock response referencing the query and context, with confidence 1.0.
     */
    override suspend fun processRequest(request: AiRequest, context: String): AgentResponse { // Added context
        return AgentResponse(
