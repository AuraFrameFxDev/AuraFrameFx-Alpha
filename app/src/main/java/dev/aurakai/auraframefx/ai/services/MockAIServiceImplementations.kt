 ...
 *
 * @return The `AgentType.AURA` value.
 */
    ...
    /**
     * Returns a flow that emits a mock `AgentResponse` echoing the input query.
     *
     * The emitted response contains the request query prefixed with a fixed message and a confidence score of 1.0.
     *
