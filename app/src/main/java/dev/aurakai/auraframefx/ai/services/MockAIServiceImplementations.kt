...
override fun getName(): String? = "MockAura"
    /**
 * Gets the type of this mock AI agent.
 *
 * @return The AgentType value representing the Aura agent.
 */
override fun getType(): AgentType = AgentType.AURA /**
     ...
     * @return An AgentResponse echoing the input query and context with confidence 1.0.
     */
 ...
 *
 * @return The AgentType.KAI value representing this agent.
 */
override fun getType(): AgentType = AgentType.KAI /**
     * Returns a mock AgentResponse for the given AI request and context.
     *
     * The response content echoes the request query and context, with a fixed confidence score of 1.0.
     *
 ...
 *
 * @return The enum value representing the Cascade agent type.
 */
