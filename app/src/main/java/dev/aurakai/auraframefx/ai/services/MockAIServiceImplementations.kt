 ...
 *
 * @return The AgentType.AURA value representing this mock agent.
 */
override fun getType(): AgentType = AgentType.AURA /**
     * Returns a mock AgentResponse containing the request query and provided context.
     *
     * The response content is formatted to include both the query and context, with a fixed confidence score of 1.0.
     *
     * @param request The AI request with the query to be echoed in the response.
