...
override fun getType(): AgentType = AgentType.KAI /**
     * Produces a mock AgentResponse for KaiAI by echoing the input query and context with a fixed confidence score of 1.0.
     *
...
override fun getName(): String? = "MockCascade"
    /**
 * Gets the agent type associated with this mock Cascade AI service.
 *
