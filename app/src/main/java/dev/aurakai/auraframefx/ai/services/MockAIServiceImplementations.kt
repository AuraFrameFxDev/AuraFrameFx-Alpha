 ...
 *
 * @return `AgentType.AURA`, indicating this is a mock Aura AI agent.
 */
...
override fun getName(): String? = "MockKai"
    /**
 * Returns the constant agent type for the mock Kai AI service.
 *
 * @return `AgentType.KAI`.
 */
override fun getType(): AgentType = AgentType.KAI /**
     * Generates a mock AgentResponse for KaiAI that echoes the provided query and context with a confidence score of 1.0.
     *
...
override fun getName(): String? = "MockCascade"
    /**
 * Returns the constant agent type identifying this mock Cascade AI service.
 *
