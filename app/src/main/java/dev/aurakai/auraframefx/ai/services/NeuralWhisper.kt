...
class NeuralWhisper @Inject constructor(
    ...
    /**
     * Sets up the text-to-speech and speech recognition engines for NeuralWhisper.
     *
     * Prepares the service for audio processing and AI-driven voice interactions. Additional initialization steps can be added as required.
     */
    fun initialize() {
     ...
     *
     * Checks for speech recognition capability and creates a `SpeechRecognizer` instance if available, updating the STT initialization flag. Logs an error if speech recognition is not supported.
     */
    ...
    /**
     * Converts the provided audio input to text using speech-to-text processing.
     *
