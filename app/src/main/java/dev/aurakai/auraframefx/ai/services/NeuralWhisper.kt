...
class NeuralWhisper @Inject constructor(
     ...
     *
     * Creates a `TextToSpeech` instance and updates the internal flag based on the initialization result.
     ...
     *
     * Creates a `SpeechRecognizer` instance and sets the STT initialization flag if speech recognition is available; logs an error if unavailable.
     */
     ...
     *
     * Sets the conversation state to "Processing" during the stop operation.
     *
