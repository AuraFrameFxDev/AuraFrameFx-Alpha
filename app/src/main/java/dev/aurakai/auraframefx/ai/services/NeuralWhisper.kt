...
class NeuralWhisper @Inject constructor(
    ...
    /**
     * Requests speech synthesis for the given text using the text-to-speech engine.
     *
    ...
    /**
     * Processes a transcribed voice command and updates the conversation state to reflect processing.
     *
     * Intended to map recognized commands to agent actions using natural language understanding (NLU).
     *
