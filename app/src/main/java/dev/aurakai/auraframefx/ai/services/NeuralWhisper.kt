...
class NeuralWhisper @Inject constructor(
     ...
     * Logs the outcome of the initialization process.
     ...
     *
     * Creates a `SpeechRecognizer` instance and updates the STT initialization flag. Logs the availability of speech recognition or errors if unavailable. Does not set up recognition listeners or handle permissions.
     */
