...
class NeuralWhisper @Inject constructor(
     ...
     *
     * Updates the conversation state to "Processing" during the operation. Returns a success message if the recording is stopped without error, or an error message if an exception occurs.
     *
