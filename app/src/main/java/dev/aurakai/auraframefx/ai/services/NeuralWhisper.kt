...
class NeuralWhisper @Inject constructor(
     ...
     *
     * This method creates a `TextToSpeech` instance and updates the TTS initialization flag based on the result.
    ...
    /**
     * Performs speech-to-text transcription on the provided audio input.
     *
     ...
     *
     * The actual interaction with the Kai agent is not performed; only the state is updated and the action is logged.
     *
