...
class NeuralWhisper @Inject constructor(
     ...
     *
     * This method creates a TextToSpeech instance and updates the initialization status.
     ...
     *
     * Checks for recognition availability and creates a `SpeechRecognizer` instance if possible.
     * Sets the STT initialization flag accordingly. Logs the outcome.
     * This method does not handle permission requests or listener setup, which must be implemented separately.
     */
    ...
    /**
     * Requests speech synthesis for the given text using the specified locale.
     *
     ...
     *
     * Updates the conversation state to indicate command processing. Intended for future implementation of natural language understanding and command-to-action mapping.
     *
    ...
    /**
     * Releases all audio resources and resets the NeuralWhisper service to an idle state.
     *
     * Stops and shuts down the text-to-speech engine, destroys the speech recognizer, clears initialization flags, and updates the conversation state to idle.
     */
    fun cleanup() {
