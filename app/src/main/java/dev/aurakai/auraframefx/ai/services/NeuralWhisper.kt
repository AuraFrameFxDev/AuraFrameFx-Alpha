...
class NeuralWhisper @Inject constructor(
     ...
     * Actual listener setup and permission handling are not implemented.
     */
     ...
     *
     * The actual interaction with the Kai agent is not implemented; only the state is updated and the action is logged.
     *
