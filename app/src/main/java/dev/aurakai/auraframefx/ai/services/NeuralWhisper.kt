...
class NeuralWhisper @Inject constructor(
     ...
     *
     * Sets up the TTS instance with a callback to handle initialization results. Language, voice, and other configuration are pending implementation.
     */
     ...
     *
     * Returns the transcribed text as a String, or null if speech recognition is not initialized.
     *
