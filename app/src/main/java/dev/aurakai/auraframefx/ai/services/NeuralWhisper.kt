...
class NeuralWhisper @Inject constructor(
     ...
     * Sets the STT initialization flag accordingly. Does not set up a recognition listener or handle permissions.
     */
     ...
     *
     * Updates the conversation state to indicate that the command is being processed. Intended for future implementation of natural language understanding and mapping commands to actions.
     *
