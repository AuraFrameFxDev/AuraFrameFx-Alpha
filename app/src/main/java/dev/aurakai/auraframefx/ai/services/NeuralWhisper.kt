...
class NeuralWhisper @Inject constructor(
     ...
     *
     * Checks for speech recognition availability and creates a `SpeechRecognizer` instance if possible.
     * Sets the STT initialization status accordingly.
     */
     ...
     *
     * Returns the recognized text as a String, or null if speech recognition is not initialized or an error occurs.
     *
