...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Returns a flow that emits a response indicating retrieval of the agent's state history.
     *
     ...
     *
     * The returned map includes the agent's name, type, and a flag indicating that the service is implemented.
     *
