 ...
 *
 * @return The fixed agent name, "Cascade".
 */
...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized types ("state", "context", "vision", "processing") are processed by specialized flows; other types yield a default response indicating receipt of a basic query.
     *
     ...
     *
     * The response content includes both Aura and Kai outputs, and the confidence score is the average of their confidences.
     *
