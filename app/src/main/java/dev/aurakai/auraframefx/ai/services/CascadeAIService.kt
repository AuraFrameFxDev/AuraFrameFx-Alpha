...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Processes an AI request and emits agent responses as a flow, routing the request based on its type.
     *
     * Delegates handling to specialized internal flows for "state", "context", "vision", or "processing" request types. For other types, emits a default response indicating a basic query was processed.
     *
     ...
     *
     * @return A flow emitting an AgentResponse with the message "Processing state transition..." and a confidence score of 0.9.
     */
     ...
     *
     * @return A map with the keys "name" (String), "type" (String), and "service_implemented" (Boolean) describing the agent's capabilities.
     */
