 ...
 */
     ...
     *
     * Determines the request type from the "type" key in the request's context map and delegates processing to the corresponding internal method. Emits a default response if the type is unrecognized or missing.
     *
     * @param request The AI request to process.
     * @return A flow emitting agent responses based on the routed request type.
     */
