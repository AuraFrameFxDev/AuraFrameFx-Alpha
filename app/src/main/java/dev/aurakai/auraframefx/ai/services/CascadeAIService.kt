...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Directs "state", "context", "vision", and "processing" requests to specialized handlers; emits a default response for other types.
     *
    ...
    /**
     * Emits an AgentResponse containing a string representation of the agent's current internal state.
     *
     ...
     *
     * Emits a single [AgentResponse] containing the combined content and the average confidence score from both services.
     *
    ...
    /**
     * Emits a response indicating retrieval of the agent's state history.
     *
