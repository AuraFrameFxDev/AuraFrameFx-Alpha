...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Routes requests of type "state", "context", "vision", or "processing" to their respective internal processing flows. For unrecognized types, emits a default response containing the query.
     *
