...
class CascadeAIService @Inject constructor(
    ...
    /**
 * Returns the agent's name, which is always "Cascade".
 *
...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Produces a direct response to an AI request by combining the request's query and the provided context.
     *
     ...
     *
     * The response content lists the current state entries as a formatted string, with a confidence score of 1.0.
     *
     * @return A flow emitting one AgentResponse summarizing the agent's internal state.
     */
