...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * @return A [Flow] emitting a single [AgentResponse] indicating vision state processing with a confidence score of 0.9.
     */
     ...
     *
     * @return A map with keys "name", "type", and "service_implemented" describing the agent's capabilities.
     */
