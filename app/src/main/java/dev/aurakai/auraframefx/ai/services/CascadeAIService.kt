...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Supported request types ("state", "context", "vision", "processing") are handled by dedicated internal flows. For other types, emits a default response acknowledging the query.
     *
     ...
     *
     * The response presents the current state as a formatted string with a confidence score of 1.0.
     *
     ...
     *
     * The response content includes both services' outputs, and the confidence score is the average of their individual confidences.
     *
