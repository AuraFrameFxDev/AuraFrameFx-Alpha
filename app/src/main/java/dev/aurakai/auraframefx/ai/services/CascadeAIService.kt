 ...
 */
     ...
     *
     * Delegates to specialized flows for "state", "context", "vision", or "processing" types; emits a default response for other or missing types.
     *
     * @param request The AI request containing a context map with an optional "type" key.
