...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Supports "state", "context", "vision", and "processing" request types with specialized response flows. For unrecognized types, emits a default acknowledgment response with moderate confidence.
     *
     ...
     *
     * The response content concatenates the query and context for direct, non-streaming processing.
     *
