 ...
 *
 * This identifies the agent as a Cascade-type composite agent.
 *
 ...
 */
     ...
     *
     * Delegates processing to specialized flows for "state", "context", "vision", or "processing" types. Emits a default response flow for unrecognized or unspecified types.
     *
