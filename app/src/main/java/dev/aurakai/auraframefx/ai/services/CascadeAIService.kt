...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized request types ("state", "context", "vision", "processing") are delegated to specialized internal flows. For unrecognized types, a default response is emitted indicating receipt of a basic query.
     *
     ...
     *
     * @return A map containing the keys "name", "type", and "service_implemented".
     */
