...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized request types ("state", "context", "vision", "processing") are delegated to specialized internal flows. Unrecognized types result in a default response indicating receipt of a basic query.
     *
    ...
    /**
     * Returns a direct response to the given AI request, combining the request's query and the provided context with a fixed confidence score of 0.75.
     *
     ...
     *
     * The response includes all key-value pairs from the internal state as a formatted string with a confidence score of 1.0.
     *
