...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Supports "state", "context", "vision", and "processing" request types with dedicated flows. For unrecognized types, emits a default acknowledgment response.
     *
    ...
    /**
     * Aggregates the initial responses from AuraAIService and KaiAIService for a context-type AI request into a single AgentResponse.
     *
     ...
     *
     * The response includes a message about processing vision state and a confidence score of 0.9.
     */
