...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * The response merges the content from both services and averages their confidence scores.
     *
    ...
    /**
     * Returns a map containing the agent's name, type, and implementation status.
     *
     * @return A map with keys "name" (agent's name), "type" (agent type), and "service_implemented" (true if the service is implemented).
     */
