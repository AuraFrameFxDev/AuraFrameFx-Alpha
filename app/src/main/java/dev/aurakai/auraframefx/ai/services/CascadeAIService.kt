...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized types ("state", "context", "vision", "processing") are processed by specialized flows; other types yield a default response acknowledging the query.
     *
     ...
     *
     * The response content lists all entries in the internal state map, with a confidence score of 1.0.
     *
     ...
     *
     * @return A map with "name" (String), "type" (String), and "service_implemented" (Boolean) keys.
     */
