...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Processes an AI request and emits agent responses as a flow, routing to specialized handlers based on request type.
     *
     * Delegates "state", "context", "vision", and "processing" requests to internal handlers; emits a default response for other types.
     *
    ...
    /**
     * Generates a direct response to the given AI request, incorporating the provided context.
     *
     ...
     *
     * The response contains a formatted string listing all key-value pairs from the internal state map with full confidence.
     *
     ...
     *
     * @return A flow emitting an AgentResponse with a message about processing a state transition and a confidence score of 0.9.
     */
    ...
    /**
     * Returns a map containing metadata about this agent's capabilities.
     *
     * @return A map with the agent's name ("Cascade"), type ("CASCADE"), and a flag indicating the service is implemented.
     */
