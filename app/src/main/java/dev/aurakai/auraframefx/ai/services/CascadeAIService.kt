...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Delegates handling to specialized internal flows for "state", "context", "vision", and "processing" request types. Emits a default response for unrecognized types.
     *
     ...
     *
     * Emits a single response that combines the content and averages the confidence scores from the two services.
     *
     * @param request The AI request to process.
     * @return A flow emitting the combined agent response.
     */
