...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Returns a flow emitting a response that indicates vision state processing is underway.
     *
     * @return A [Flow] emitting a single [AgentResponse] with a vision processing message and confidence score of 0.9.
     */
     ...
     *
     * @return A map containing the agent's name, type, and a flag indicating if the service is implemented.
     */
