...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Delegates handling to specialized internal flows for recognized request types ("state", "context", "vision", "processing").
     * Emits a default response for unrecognized types.
     *
     ...
     *
     * The response contains all key-value pairs from the internal state map with full confidence.
     *
