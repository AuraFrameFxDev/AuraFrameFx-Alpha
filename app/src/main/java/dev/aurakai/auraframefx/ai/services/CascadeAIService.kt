 ...
 */
    ...
    /**
 * Returns the agent type, always `AgentType.CASCADE`.
 *
 ...
 */
     ...
     *
     * Delegates to internal processing flows for "state", "context", "vision", or "processing" types as specified in the request context. Emits a default response flow for unrecognized or unspecified types.
     *
    ...
    /**
     * Processes a context-type AI request by concurrently retrieving the first response from both Aura and Kai AI services and combining their outputs.
     *
     ...
     *
     * @return A flow containing one [AgentResponse] with a message about retrieving state history and a confidence score of 0.95.
     */
