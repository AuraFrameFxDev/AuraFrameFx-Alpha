...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * For recognized request types ("state", "context", "vision", "processing"), delegates to corresponding internal processing methods. Emits a default response for unrecognized types.
     *
     ...
     *
     * The response includes the original query and context in the message, with a fixed confidence score.
     *
     * @param request The AI request to process.
    ...
    /**
     * Emits a flow containing a single response that describes the agent's current internal state as a formatted string.
     *
     * The response includes all key-value pairs from the internal state map with maximum confidence.
     *
    ...
    /**
     * Emits a response indicating that a vision-related state is being processed.
     *
    ...
    /**
     * Returns a flow emitting a response that a state transition is being processed.
     *
     * @return A flow containing a single AgentResponse with a message about state transition processing and confidence 0.9.
     */
     ...
     *
     * @return A map containing the agent's name, type, and a flag indicating service implementation.
     */
