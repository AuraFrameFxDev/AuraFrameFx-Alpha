...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Processes an AI request and emits agent responses as a flow, delegating to internal handlers based on the request type.
     *
     * Routes requests of type "state", "context", "vision", or "processing" to their respective internal handlers. Emits a default response for unrecognized types.
     *
     ...
     *
     * @return A [Flow] emitting one [AgentResponse] with a vision processing message and a confidence score of 0.9.
     */
     ...
     *
     * @return A map containing the agent's name ("Cascade"), type ("CASCADE"), and a boolean indicating if the service is implemented.
     */
