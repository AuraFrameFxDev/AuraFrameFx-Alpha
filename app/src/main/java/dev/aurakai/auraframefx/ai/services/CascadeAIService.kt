...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * @return A [Flow] emitting one [AgentResponse] with a vision processing message and confidence score of 0.9.
     */
    ...
    /**
     * Retrieves a map detailing the agent's capabilities, including its name, type, and implementation status.
     *
