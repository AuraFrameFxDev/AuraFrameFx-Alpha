 ...
 */
    ...
    /**
 * Returns the agent type for this instance.
 *
 ...
 */
    ...
    /**
     * Returns a direct agent response to an AI request, combining the request's query with the provided context.
     *
     ...
     *
     * The response content lists the current state entries as a formatted string with maximum confidence.
     *
    ...
    /**
     * Processes a context-type AI request by concurrently querying Aura and Kai AI services and aggregating their responses.
     *
