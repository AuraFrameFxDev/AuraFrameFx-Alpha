...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized request types ("state", "context", "vision", "processing") are delegated to specialized internal flows. For unrecognized types, a default response indicating a basic query is emitted.
     *
     ...
     *
     * @return A flow emitting one AgentResponse representing the current state summary.
     */
    ...
    /**
     * Emits a single AgentResponse for a context-type AI request by combining the first responses from AuraAIService and KaiAIService.
     *
