 ...
 */
     ...
     *
     * Delegates to specialized internal methods for "state", "context", "vision", or "processing" request types. Emits a default response flow for unrecognized types.
     *
     * @param request The AI request to process.
     * @return A flow emitting agent responses based on the request type.
     */
     ...
     *
     * The response content lists the current state entries as a formatted string with full confidence.
     *
