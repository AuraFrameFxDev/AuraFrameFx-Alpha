 ...
 */
     ...
     *
     * Determines the processing path based on the "type" value in the request's context map, delegating to specialized handlers for "state", "context", "vision", or "processing". Emits a default response for unrecognized or missing types.
     *
