...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * Recognized request types ("state", "context", "vision", "processing") are processed by dedicated internal flows. Requests with unrecognized types receive a default acknowledgment response.
     *
    ...
    /**
     * Returns a direct response to the given AI request, combining the request's query and the provided context.
     *
     ...
     *
     * The response includes all entries from the internal state map and is assigned a confidence score of 1.0.
     *
