 ...
 */
    ...
    /**
 * Retrieves the agent type for this service.
 *
 ...
 */
    ...
    /**
     * Routes an AI request to the appropriate handler based on its context type and emits agent responses as a flow.
     *
     * Delegates to specialized internal methods for "state", "context", "vision", or "processing" types. Emits a default response for unrecognized or missing types.
     *
     ...
     *
     * The response includes a formatted string of all key-value pairs in the internal state map with full confidence.
     *
