 ...
 *
 * @return The `AgentType.CASCADE` enum value representing this agent's type.
 */
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * @return A flow with an [AgentResponse] message "Processing vision state..." and a confidence score of 0.9.
     */
