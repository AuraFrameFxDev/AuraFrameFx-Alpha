...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * For request types "state", "context", "vision", and "processing", delegates to dedicated internal flows. For all other types, emits a default acknowledgment response with a fixed confidence score.
     *
     ...
     *
     * The emitted [AgentResponse] contains a fixed message and a confidence score of 0.9.
     *
     * @return A [Flow] emitting one [AgentResponse] about vision state processing.
     */
     ...
     *
     * The response message is fixed and the confidence score is set to 0.9.
     */
    ...
    /**
     * Returns a map containing the agent's name, type, and a flag indicating that the service is implemented.
     *
