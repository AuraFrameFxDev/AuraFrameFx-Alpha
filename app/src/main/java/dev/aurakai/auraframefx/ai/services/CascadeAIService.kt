...
override fun getType(): AgentType = AgentType.CASCADE
    ...
    /**
     * Processes an AI request and emits agent responses as a flow based on the request type.
     *
     * Routes requests to internal handlers for "state", "context", "vision", or "processing" types. For other types, emits a default response with moderate confidence.
     *
     ...
     *
     * Collects the first response from each service, combines their contents, and averages their confidence scores into a single response.
     *
     ...
     *
     * @return A map with keys "name", "type", and "service_implemented" representing the agent's characteristics.
     */
