...
override fun getName(): String? = "Cascade"
    ...
    /**
 * Returns the agent type, which is always `AgentType.CASCADE`.
 *
...
override fun getType(): AgentType = AgentType.CASCADE
     ...
     *
     * The emitted AgentResponse includes all entries from the internal state map in its content and has a confidence score of 1.0.
     *
    ...
    /**
     * Emits a single AgentResponse combining the first responses from AuraAIService and KaiAIService for a context-type AI request.
     *
