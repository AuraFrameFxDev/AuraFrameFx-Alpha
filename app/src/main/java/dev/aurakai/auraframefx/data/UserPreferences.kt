...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the string value associated with the given key from user preferences, or returns the specified default if the key is not present.
     *
    ...
    /**
     * Sets or updates the string value for a given key in the in-memory user preferences.
     *
