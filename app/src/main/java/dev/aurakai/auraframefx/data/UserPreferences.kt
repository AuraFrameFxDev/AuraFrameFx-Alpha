...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the value for the specified key from in-memory preferences, or returns the provided default if the key is not present.
     *
     * @param key The key to look up in preferences.
     * @param defaultValue The value to return if the key does not exist.
     * @return The value associated with the key, or defaultValue if the key is absent.
     */
