...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the value associated with the given key from in-memory preferences, or returns the specified default if the key is not present.
     *
     * @param key The key to look up in the preferences.
     * @param defaultValue The value to return if the key is not found.
     * @return The value for the key, or defaultValue if the key does not exist.
     */
