...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the stored string value for the given key, or returns the specified default if the key is not found.
     *
     * @param key The preference key to look up.
     * @param defaultValue The value to return if the key is not present in preferences.
     * @return The stored value for the key, or the provided default value if the key is absent.
     */
    ...
    /**
     * Sets or updates the string value for the specified preference key in memory.
     *
