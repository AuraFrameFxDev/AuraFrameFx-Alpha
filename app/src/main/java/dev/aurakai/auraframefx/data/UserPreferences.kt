...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the stored string value for a given key from user preferences, or returns the specified default if the key is absent.
     *
     * @param key The key identifying the preference to retrieve.
     * @param defaultValue The value to return if the key does not exist in preferences.
     * @return The stored value associated with the key, or the default value if not found.
     */
    ...
    /**
     * Sets or updates the string value for a given key in the in-memory preferences.
     *
