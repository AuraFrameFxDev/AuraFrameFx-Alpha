...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the value for the specified key from in-memory user preferences, returning the provided default if the key is not found.
     *
    ...
    /**
     * Sets or updates a preference value for the specified key in memory.
     *
