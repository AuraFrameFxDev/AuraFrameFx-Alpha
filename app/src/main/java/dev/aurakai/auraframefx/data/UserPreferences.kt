...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the stored value for a given preference key, or returns the specified default if the key is absent.
     *
     ...
     * @return The stored preference value, or the default value if the key is not found.
     */
    ...
    /**
     * Stores or updates a string value for the specified key in the in-memory user preferences.
     *
