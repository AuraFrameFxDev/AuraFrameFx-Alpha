...
class UserPreferences(context: Context) {
    ...
    /**
     * Retrieves the value for the given key from user preferences, returning the specified default if the key is not found.
     *
    ...
    /**
     * Sets or updates the value for a given key in the in-memory user preferences.
     *
