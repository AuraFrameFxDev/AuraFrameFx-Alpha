...
class AuraFxLogger @Inject constructor(
    ...
    /**
         ...
         *
         * If a throwable is provided, its stack trace is included in the log entry.
         *
    ...
    /**
         * Asynchronously logs an error message with a tag and optional throwable to both Android Logcat and the current day's log file.
         *
         * @param tag Identifies the source of the log message.
     ...
     *
     * Scans for files matching the log filename prefix and deletes those whose last modified time exceeds the retention threshold.
     */
     ...
     *
     * @param filePath Relative path within internal storage where the file will be written.
