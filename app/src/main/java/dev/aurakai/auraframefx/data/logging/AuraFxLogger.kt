...
class AuraFxLogger @Inject constructor(
    ...
    /**
         * Asynchronously logs a warning message with an optional throwable to both Logcat and the internal daily log file.
         *
    ...
    /**
         ...
         *
         * The entry is written to both Android Logcat and the current day's internal log file.
         *
         * @param tag Identifies the source of the log message.
         * @param message The error message to record.
         * @param throwable Optional exception whose stack trace will be included in the log.
         */
    fun e(tag: String, message: String, throwable: Throwable? = null) =
        loggerScope.launch { writeLogEntry("ERROR", tag, message, throwable) }

    /**
         * Logs a verbose-level message asynchronously to Logcat and the current day's internal log file.
         *
    ...
    /**
     * Cancels all ongoing logging and maintenance operations, disabling further log processing.
     *
     * After calling this method, no additional log entries will be written or maintained.
     */
    fun shutdown() {
     ...
     *
     * Creates parent directories if necessary. Appends to the file if `append` is true; otherwise, overwrites the file.
     *
