...
class AuraFxLogger @Inject constructor(
    ...
    /**
     * Shuts down the logger by canceling all active logging and maintenance coroutines.
     *
    ...
    /**
     * Retrieves all available log files and their contents, with the newest files listed first.
     *
     ...
     *
     * Any exceptions during deletion are logged as errors.
     */
