...
class AuraFxLogger @Inject constructor(
     ...
     * @return A list of log lines for the given date, or an empty list if the log file is missing or unreadable.
     */
     ...
     *
     * @return A map where each key is a log filename and each value is the file's content, sorted with the newest files first.
     */
