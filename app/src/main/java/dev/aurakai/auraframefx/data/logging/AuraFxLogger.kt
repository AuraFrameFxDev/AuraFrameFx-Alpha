...
class AuraFxLogger @Inject constructor(
     ...
     *
     * Scans for files with the log filename prefix and deletes those whose last modified time exceeds the configured retention period.
     */
    ...
    /**
     * Removes all log files from the internal logs directory that begin with the log filename prefix.
     *
     * Logs an error if any exception occurs during the deletion process.
     */
