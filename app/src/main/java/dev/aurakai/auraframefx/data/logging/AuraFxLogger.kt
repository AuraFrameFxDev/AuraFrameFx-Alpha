...
class AuraFxLogger @Inject constructor(
    ...
    /**
         * Asynchronously logs an error message with the given tag and optional throwable to both Android Logcat and the current day's log file.
         *
         * @param tag Identifies the source of the log message.
     ...
     *
     * Scans the log directory for files with the log filename prefix and deletes those whose last modified time exceeds the retention threshold.
     */
     ...
     *
     * After calling this method, the logger will no longer process or persist any log entries.
     */
    fun shutdown() {
