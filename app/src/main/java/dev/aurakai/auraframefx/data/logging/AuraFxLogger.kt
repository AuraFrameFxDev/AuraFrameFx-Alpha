...
class AuraFxLogger @Inject constructor(
     ...
     *
     * Only files matching the log filename prefix are considered for deletion. Logs the number of files deleted or warnings if the directory is missing or deletion fails.
     */
