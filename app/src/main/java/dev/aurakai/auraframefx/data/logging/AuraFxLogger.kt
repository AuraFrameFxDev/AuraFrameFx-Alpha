...
class AuraFxLogger @Inject constructor(
    ...
    /**
         * Asynchronously logs a warning-level message to both Android Logcat and the internal daily log file.
         *
    ...
    /**
     * Writes content to a file within the app's internal storage.
     *
     * Creates parent directories if they do not exist. Appends to the file if `append` is true; otherwise, overwrites the file.
     *
     * @param filePath The relative path to the file within the internal storage directory.
