...
class AmbientMusicService @Inject constructor() : Service() {
    ...
    /**
     * Handles a request to start the service and indicates that it should not be restarted automatically if terminated.
     *
     ...
     *
     * Intended to halt the current audio stream if playback is active.
     */
    fun pause() {
