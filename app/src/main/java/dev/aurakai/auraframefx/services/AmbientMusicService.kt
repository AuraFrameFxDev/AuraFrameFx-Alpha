...
class AmbientMusicService @Inject constructor() : Service() {
    ...
    /**
     * Specifies that the service should not be restarted automatically if terminated by the system.
     *
     * @return `START_NOT_STICKY` to indicate the service will not be recreated after being killed.
     */
    ...
    /**
     * Pauses music playback if currently active.
     *
     * Intended to halt the current audio stream.
     */
    fun pause() {
