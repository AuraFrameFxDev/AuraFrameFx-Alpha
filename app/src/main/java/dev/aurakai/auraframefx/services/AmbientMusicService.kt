...
class AmbientMusicService @Inject constructor() : Service() {
     ...
     *
     * Override this method to set up resources or perform setup tasks needed by the service.
     */
     ...
     *
     * Use this method to perform cleanup before the service is terminated.
     */
