...
class AmbientMusicService @Inject constructor() : Service() {
     ...
     *
     * Intended for initialization logic required before the service starts handling commands.
     */
     ...
     *
     * This method is intended to halt the current track without stopping the service.
     */
    fun pause() {
