 ...
 * Applies a cyber edge glow effect to the modifier using the specified primary and secondary colors.
 *
 * @param primaryColor The main color for the glow effect.
 * @param secondaryColor The secondary color blended with the glow.
