...
sealed class NavDestination(val route: String, val title: String, val icon: ImageVector?) {
    ...
    object AiChat : NavDestination("ai_chat", "AI Chat", Icons.Filled.Home)
    ...
    object OracleDriveControl : NavDestination("oracle_drive_control", "Oracle Drive", Icons.Filled.Home)
