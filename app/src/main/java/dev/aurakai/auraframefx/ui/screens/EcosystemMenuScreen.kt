 ...
 *
 * @param transitionType The type of transition animation to display in the digital transition row.
 * @param showHologram Whether to show the hologram transition effect around the screen content.
 */
@Composable
