...
/**
     ...
     *
     * Adds an 8.dp elevation shadow and a 1.dp semi-transparent neon blue border with 4.dp rounded corners.
     * The effect is designed to evoke a luminous, futuristic edge highlight.
     */
...
/**
     ...
     *
     * Adds a 4.dp elevation shadow and a 2.dp border with 2.dp rounded corners, both using neon purple coloring. The border is rendered at 80% opacity to create a cyberpunk glitch visual style.
     */
...
/**
     ...
     *
     * This effect adds a 6.dp elevation shadow and a 1.dp border with slightly rounded 1.dp corners, using a neon teal color at 70% opacity to create a digital pixel visual style.
     */
