...
/**
     ...
     */
    /**
     * Applies a neon blue edge glow effect with a shadow and semi-transparent border to the UI element.
     *
     * The effect uses rounded corners and enhances the cyberpunk aesthetic of the component.
     */
...
/**
     ...
     *
     * Adds a 4.dp elevation shadow and a 2.dp border with rounded corners, both using a neon purple color for a cyberpunk glitch appearance.
     */
...
/**
     ...
     *
     * Adds a 6.dp shadow and a 1.dp border with NeonTeal color at 70% opacity and slightly rounded corners, creating a digital pixel visual style for Compose UI components.
     */
