...
/**
     ...
     */
    /**
     * Applies a neon blue edge glow effect with a soft shadow and semi-transparent border to the modifier.
     *
     * The effect uses rounded corners and is suitable for creating a cyberpunk-inspired UI appearance.
     */
...
/**
     ...
     *
     * Adds a 6.dp shadow and a 1.dp border with NeonTeal color at 70% opacity and slightly rounded corners for a digital pixelated appearance.
     */
