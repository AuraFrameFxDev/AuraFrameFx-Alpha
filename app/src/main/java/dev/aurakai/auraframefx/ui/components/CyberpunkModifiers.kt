...
/**
     ...
     * Applies a neon blue edge glow effect with a soft shadow and semi-transparent border to the UI element.
     *
     * @return The modified [Modifier] with the cyberpunk edge glow styling applied.
     */
...
/**
     ...
     *
     * Adds a 4.dp elevation shadow and a 2.dp border with slightly rounded corners, both using neon purple for a cyberpunk glitch appearance.
     *
...
/**
     * Applies a pixelated neon teal effect with a soft shadow and border to the modifier.
     *
     * Adds a 6.dp neon teal shadow and a 1.dp border with slightly rounded corners for a digital pixel cyberpunk appearance.
     *
