...
/**
     ...
     *
     * Adds a shadow with 8.dp elevation and rounded corners of 4.dp radius using a neon blue color, and overlays a 1.dp border in neon blue at 60% opacity for a cyberpunk-inspired appearance.
     */
