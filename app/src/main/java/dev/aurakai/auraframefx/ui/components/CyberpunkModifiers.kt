...
/**
     ...
     */
    /**
     * Applies a neon blue edge glow effect with a shadow and semi-transparent border to the UI component.
     *
     * Adds a shadow with 8.dp elevation and rounded corners, and a 1.dp border with NeonBlue color at 60% opacity.
     */
...
/**
     ...
     *
     * Creates a digital pixelated visual style for Compose UI components using a 6.dp shadow and a 1.dp border with NeonTeal color at 70% opacity and slightly rounded corners.
     */
