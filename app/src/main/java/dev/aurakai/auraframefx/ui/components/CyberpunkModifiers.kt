...
/**
     ...
     * Suitable for creating a cyberpunk or digital glitch aesthetic in Compose UI components.
     */
...
/**
     * Applies a cyberpunk-inspired pixel effect to the modifier, featuring a teal shadow and border with minimal rounded corners.
     *
     * This effect uses a 6.dp elevation shadow and a 1.dp border in NeonTeal with 70% opacity, both with slightly rounded corners, to create a digital pixelated appearance.
     */
