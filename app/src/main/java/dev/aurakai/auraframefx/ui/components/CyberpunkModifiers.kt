...
/**
     ...
     */
    /**
     * Applies a neon blue edge glow effect with a shadow and semi-transparent border to the modifier.
     *
     * Returns a modifier with an 8.dp neon blue shadow and a 1.dp neon blue border at 60% opacity, both with rounded corners.
     */
...
/**
     ...
     *
     * The effect features a 4.dp elevation shadow and a 2.dp border with rounded corners, both using a neon purple color.
     * @return The modifier with the digital glitch visual effect applied.
     */
...
/**
     ...
     *
     * Adds a 6.dp shadow and a 1.dp border using NeonTeal with 70% opacity and slightly rounded corners, creating a digital pixelated visual style for Compose UI components.
     */
