...
/**
     ...
     *
     * Adds a blue shadow and a semi-transparent blue border with rounded corners for a cyberpunk appearance.
     */
...
/**
     * Applies a pixelated cyberpunk effect with a teal neon shadow and border to the modifier.
     *
