...
/**
     ...
     *
     * This effect adds a 4.dp elevation shadow and a 2.dp border with 2.dp rounded corners, both using neon purple coloring at 80% opacity, to create a cyberpunk glitch aesthetic.
     */
...
/**
     ...
     *
     * This effect adds a 6.dp shadow and a 1.dp border with slightly rounded 1.dp corners, using NeonTeal at 70% opacity to create a digital pixel visual style.
     */
