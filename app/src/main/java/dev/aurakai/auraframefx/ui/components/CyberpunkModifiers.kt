...
/**
     ...
     *
     * Adds a shadow with 8.dp elevation and rounded 4.dp corners using NeonBlue, and overlays a 1.dp border in NeonBlue at 60% opacity for a cyberpunk-inspired appearance.
     */
...
/**
     * Applies a neon purple digital glitch visual effect to the modifier.
     *
     * Adds a 4.dp elevation shadow and a 2.dp border with 2.dp rounded corners, both in neon purple at 80% opacity, to create a cyberpunk glitch aesthetic.
     */
...
/**
     ...
     *
     * Adds a 6.dp shadow and a 1.dp border with slightly rounded 1.dp corners, using NeonTeal at 70% opacity to create a digital pixel visual style.
     */
