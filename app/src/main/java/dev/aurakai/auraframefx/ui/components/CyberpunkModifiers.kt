...
/**
     ...
     *
     * Adds a shadow with 8.dp elevation and rounded corners of 4.dp using NeonBlue for both ambient and spot shadows, and overlays a 1.dp border with NeonBlue at 60% opacity for a cyberpunk-inspired appearance.
     */
...
/**
     ...
     *
     * Adds a 4.dp shadow and a 2.dp border with 2.dp rounded corners, both using neon purple coloring at 80% opacity for a cyberpunk glitch appearance.
     */
