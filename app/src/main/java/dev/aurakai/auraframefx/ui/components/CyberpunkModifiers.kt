...
/**
     ...
     *
     * The effect features an 8.dp elevation shadow and a 1.dp border with rounded corners, using the NeonBlue color.
     */
...
/**
     ...
     *
     * The effect features a 4.dp elevation shadow and a 2.dp border with rounded corners, both using a neon purple color for a cyberpunk visual style.
     * 
...
/**
     ...
     *
     * Creates a digital pixelated appearance using a 6.dp shadow and a 1.dp border with NeonTeal color at 70% opacity and slightly rounded corners.
     */
