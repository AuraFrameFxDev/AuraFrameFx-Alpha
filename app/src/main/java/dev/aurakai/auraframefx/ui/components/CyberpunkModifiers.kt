...
/**
     ...
     *
     * Adds a shadow with 8.dp elevation and rounded corners of 4.dp radius, using NeonBlue for both ambient and spot colors. A 1.dp border with the same corner radius and NeonBlue at 60% opacity is also applied, creating a cyberpunk-inspired glowing appearance.
     */
...
/**
     ...
     *
     * This effect adds a 4.dp elevation shadow and a 2.dp border with 2.dp rounded corners, both using neon purple coloring at 80% opacity for a cyberpunk glitch aesthetic.
     */
...
/**
     ...
     *
     * Adds a 6.dp shadow and a 1.dp border with slightly rounded corners, using NeonTeal at 70% opacity to create a digital pixel visual style.
     */
