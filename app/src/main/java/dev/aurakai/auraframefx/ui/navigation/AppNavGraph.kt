 ...
 *
 * Sets up navigation routes and associates each route with its corresponding composable screen.
 * The navigation graph includes Home, AI Chat, Profile, Settings, and Oracle Drive Control screens.
 *
