 ...
 *
 * Defines the available composable destinations and their routes, including Home, AI Chat, Profile, Settings, and a placeholder for Oracle Drive Control. The navigation graph uses the provided navigation controller to manage navigation between screens.
 *
 * @param navController The navigation controller used to manage app navigation.
 */
@Composable
