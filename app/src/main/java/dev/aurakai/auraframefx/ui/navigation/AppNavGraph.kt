 ...
 */
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Navigation Compose.
 *
 * Defines the available composable destinations and their routes, including Home, AI Chat, Profile, Settings, and a placeholder for Oracle Drive Control. The navigation graph uses the provided navigation controller and specifies the Home screen as the start destination.
 */
@Composable
