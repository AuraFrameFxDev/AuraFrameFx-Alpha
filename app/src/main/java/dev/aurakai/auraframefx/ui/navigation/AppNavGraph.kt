 ...
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Configures navigation routes for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, enabling navigation between these primary sections of the app.
 *
 * @param navController The navigation controller used to manage app navigation state.
 */
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines composable destinations for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, enabling navigation between these sections via the provided navigation controller.
 */
>>>>>>> pr458merge
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Configures navigation routes for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, enabling navigation between these destinations via the provided navigation controller.
 *
 * @param navController The navigation controller used to manage navigation between composable destinations.
 */
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines composable destinations for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, using the provided navigation controller to manage navigation state.
 */
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines composable destinations for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, managing navigation via the provided NavHostController.
 */
/**
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines composable destinations for Home, AI Chat, Profile, Settings, and Oracle Drive Control screens, managing navigation state via the provided NavHostController.
 */
@Composable
