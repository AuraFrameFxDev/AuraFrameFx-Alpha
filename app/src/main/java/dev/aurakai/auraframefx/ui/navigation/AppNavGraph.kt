 ...
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines the navigation routes and associated composable screens, enabling transitions between Home, AI Chat, Profile, Settings, and Oracle Drive Control screens.
 *
