 ...
 *
 * Maps navigation routes to their corresponding composable screens, with the Home screen as the start destination. Additional destinations can be added as needed.
 */
@Composable
