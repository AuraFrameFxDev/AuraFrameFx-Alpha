 ...
 * Sets up the main navigation graph for the AuraFrameFX app using Jetpack Compose Navigation.
 *
 * Defines the available composable destinations and their associated routes, enabling navigation between the Home, AI Chat, Profile, Settings, and Oracle Drive Control screens.
 *
