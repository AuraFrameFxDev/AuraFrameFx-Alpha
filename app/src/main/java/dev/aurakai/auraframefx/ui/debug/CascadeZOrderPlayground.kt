...
/**
 * Displays a debug interface for inspecting and updating the Cascade agent's vision and processing states.
 *
 * Presents the current vision and processing states, allows manual updates to these states, and shows their history.
 *
 * @param viewModel The ViewModel providing state and update functions for the Cascade agent. Defaults to a Hilt-injected instance.
 */
@Composable
...
@OptIn(ExperimentalMaterial3Api::class)
/**
 * Displays a preview of the CascadeZOrderPlayground composable within a Material theme for design-time inspection.
 */
@Composable
