...
/**
 * Displays a debug interface for viewing and updating the Cascade agent's vision and processing states.
 *
 * Presents the current vision and processing states, allows manual input for new state values, and shows the history of state changes. Intended for development and debugging purposes.
 */
@Composable
