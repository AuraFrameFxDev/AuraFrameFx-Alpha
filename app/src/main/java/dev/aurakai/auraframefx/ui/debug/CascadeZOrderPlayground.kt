 ...
 *
 * Presents the current vision and processing states, allows manual updates to each state, and shows their respective histories. Intended for development and debugging purposes.
 */
@Composable
