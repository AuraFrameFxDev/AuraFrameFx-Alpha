...
/**
 * Displays a selectable menu item with customizable text for Jetpack Compose UI.
 *
 * The menu item visually indicates its selection state and triggers a callback when clicked.
 *
