...
/**
 * Renders a continuous hexagonal tiling pattern by drawing staggered rows of hexagon outlines across the canvas.
 *
 * Each hexagon is outlined with the specified color, and every other row is horizontally offset to ensure seamless tiling.
 *
