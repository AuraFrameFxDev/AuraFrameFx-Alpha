...
/**
 * Renders a staggered hexagon grid pattern as a background on a Canvas.
 *
 * The grid consists of hexagon outlines tiled across the canvas, with rows horizontally offset to create a continuous hexagonal pattern. The color and opacity of the hexagons can be customized.
 *
