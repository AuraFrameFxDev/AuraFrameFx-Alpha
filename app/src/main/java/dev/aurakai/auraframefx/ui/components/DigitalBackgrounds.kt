 ...
 */
/**
 * Composable that renders a digital landscape grid background using a Canvas.
 *
 * Draws evenly spaced vertical and horizontal lines to create a grid pattern, with customizable color and modifier.
 */
/**
 * Renders a digital landscape grid background using a Canvas.
 *
 * Draws evenly spaced vertical and horizontal lines across the composable area, creating a digital grid effect. The grid color and transparency can be customized.
 *
 * @param modifier Modifier to be applied to the Canvas.
...
/**
 * Displays a background composed of a hexagon grid pattern using the specified color and opacity.
 *
 * @param alpha The opacity of the hexagon grid, where 1.0 is fully opaque and 0.0 is fully transparent.
...
/**
 * Draws a grid of evenly spaced vertical and horizontal lines across the canvas to create a digital landscape background.
 *
 ...
 *
 * Each row is horizontally offset to create a seamless hexagonal tiling pattern.
 *
 ...
 *
 * The hexagon is formed by connecting six vertices spaced at 60-degree intervals around the center point.
 *
