...
/**
 * Draws a grid of evenly spaced vertical and horizontal lines across the canvas using the specified color.
 *
...
/**
 * Draws a continuous hexagonal tiling pattern by rendering staggered rows of hexagon outlines across the canvas.
 *
 * Each hexagon is outlined with the specified color, and rows are horizontally offset to ensure seamless tiling.
 *
