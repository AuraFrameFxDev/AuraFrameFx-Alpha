...
/**
 * Renders a staggered hexagon grid as a background using a Canvas.
 *
 * The grid consists of hexagon outlines tiled continuously across the canvas. The color and opacity of the hexagons can be customized.
 *
