...
/**
 * Draws a hexagon grid pattern across the canvas, offsetting every other row to create a continuous tiling effect.
 *
 * Each hexagon is outlined with the specified color.
 *
