...
object KineticIdentity {
     ...
     *
     * The resulting animation spec has a total duration equal to the pause plus the duration of the provided action spec (if available), and uses a dramatic cubic bezier easing.
     *
