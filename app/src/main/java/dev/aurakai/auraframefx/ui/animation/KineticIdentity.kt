...
object KineticIdentity {
     ...
     *
     * The animation transitions a value between its initial state and [targetValue] in a continuous in-and-out motion using linear easing.
     *
...
/**
     ...
     *
     * The total duration is the sum of the delay and the estimated duration of the original animation spec. For spring specs, the duration is estimated as 1000 ms; for tween specs, the original duration is used; otherwise, a standard duration is applied.
     *
