...
object KineticIdentity {
     ...
     *
     * The animation transitions a value between its initial state and [targetValue] using linear easing,
     ...
     *
     * The resulting animation spec has a total duration equal to the pause plus the action's duration, and uses a dramatic cubic bezier easing for effect.
     *
...
/**
     ...
     *
     * @param repeatMode The repeat mode, either restart or reverse. Defaults to [RepeatMode.Restart].
 ...
 *
 * If this animation spec is a tween, a new tween spec is created with the same duration and the provided easing.
 * For non-tween specs, the original animation spec is returned unchanged.
 *
