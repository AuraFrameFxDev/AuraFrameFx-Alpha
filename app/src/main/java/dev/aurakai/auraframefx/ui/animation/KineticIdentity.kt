...
object KineticIdentity {
     ...
     *
     * The resulting animation delays for the given pause duration, then performs the action with a combined duration and a dramatic cubic bezier easing curve.
     *
