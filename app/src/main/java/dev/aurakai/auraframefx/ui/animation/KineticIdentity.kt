...
object KineticIdentity {
     ...
     * @return An animation spec suitable for glitch or shake-style animations.
     */
     ...
     *
     * The animation delays for the specified pause duration, then performs the action using a dramatic cubic bezier easing. The total duration combines the pause and the action's duration (estimated if not a tween).
     *
     * @param pauseDurationMillis Length of the pause before the action, in milliseconds.
...
/**
     ...
     *
     * @param repeatMode The mode determining how the animation repeats (restart or reverse). Defaults to [RepeatMode.Restart].
