...
object KineticIdentity {
    ...
    /**
     * Returns an infinite repeatable animation spec for a smooth breathing or pulsing effect.
     *
     * The animation cycles a float value between its initial state and [targetValue] over [durationMillis] milliseconds, repeating in reverse to create a continuous in-and-out motion.
     *
     ...
     *
     * The resulting animation consists of a pause for the specified duration, followed by the action animation's duration, using a dramatic cubic bezier easing curve.
     *
