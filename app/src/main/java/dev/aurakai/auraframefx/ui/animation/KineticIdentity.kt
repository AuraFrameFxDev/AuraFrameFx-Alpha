...
object KineticIdentity {
     ...
     *
     * The `intensity` parameter is present for API consistency but does not affect the animation.
     *
    ...
    /**
     * Creates an animation spec that introduces a dramatic pause before executing the specified action animation, using a dramatic cubic bezier easing.
     *
...
/**
     * Creates an infinite repeatable animation spec from this animation spec.
     *
     * The resulting animation will repeat indefinitely using the specified repeat mode.
     *
     * @param repeatMode The repeat mode to use for repetition. Defaults to [RepeatMode.Restart].
     * @return An [InfiniteRepeatableSpec] that repeats this animation spec infinitely.
     */
...
/**
 * Returns a tween animation spec with the specified easing if the current spec is a tween; otherwise, returns the original animation spec unchanged.
 *
