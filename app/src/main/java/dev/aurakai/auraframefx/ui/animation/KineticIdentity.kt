...
object KineticIdentity {
    ...
    /**
     * Returns an infinite repeatable animation spec that smoothly pulses a float value between its initial and target value using linear easing and reverse repeat mode.
     *
     ...
     * @return An [AnimationSpec] for animating float values in glitch or shake animations.
     */
    ...
    /**
     * Returns an animation spec that introduces a pause before performing the specified action animation.
     *
     * The animation delays for the given pause duration, then executes the action animation with a combined duration and a dramatic cubic bezier easing curve.
     *
