...
object KineticIdentity {
    ...
    /**
     * Returns an infinite repeatable animation spec that pulses a float value between its initial and target value.
     *
    ...
    /**
     * Returns an animation spec that adds a pause before starting the specified action animation.
     *
