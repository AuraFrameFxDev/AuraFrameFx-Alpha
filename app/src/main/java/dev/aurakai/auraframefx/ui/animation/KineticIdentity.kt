...
object KineticIdentity {
    ...
    /**
     * Returns a linear tween animation spec for creating glitch or shake effects.
     *
     ...
     * @return A linear tween [AnimationSpec] suitable for glitch or shake animations.
     */
     ...
     *
     * The resulting animation spec combines a pause of the specified duration with the duration of the provided action animation, using a cubic bezier easing for dramatic effect.
     *
...
/**
 * Returns a tween animation spec with the specified easing if this is a tween; otherwise, returns the original animation spec unchanged.
 *
