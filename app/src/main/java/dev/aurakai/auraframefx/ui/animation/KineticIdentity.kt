...
object KineticIdentity {
     ...
     *
     * The resulting animation delays the start by the given pause duration, then performs the action using a combined duration and a dramatic cubic bezier easing curve.
     *
