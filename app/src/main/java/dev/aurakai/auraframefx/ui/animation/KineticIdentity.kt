...
object KineticIdentity {
     ...
     *
     * The resulting animation delays the start of the action by the specified pause duration, then performs the action with a dramatic cubic bezier easing. The total duration is the sum of the pause and the action's duration.
     *
     * @param pauseDurationMillis The duration of the pause before the action, in milliseconds.
     * @param actionSpec The animation spec for the action to follow the pause.
