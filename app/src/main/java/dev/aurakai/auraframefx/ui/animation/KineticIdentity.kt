...
object KineticIdentity {
     ...
     * @return An [AnimationSpec] suitable for rapid glitch or shake animations.
     */
    ...
    /**
     * Returns an animation spec that adds a dramatic pause before performing an action.
     *
     * The animation consists of a pause for the specified duration, followed by the action animation, using a dramatic cubic bezier easing curve.
     *
...
/**
     * Creates a tween animation spec that starts after a specified delay, combining the delay with the original animation's duration.
     *
     * For spring-based specs, the duration is estimated as 1000 ms; for other types, the original or standard duration is used.
     *
     * @param delayMillis The delay in milliseconds before the animation begins.
     * @return A tween animation spec with the total duration of delay plus the original animation's duration.
     */
...
/**
 * Returns a tween animation spec with the specified easing if this spec is a tween; otherwise, returns the original spec.
 *
 * @param easing The easing function to use if this is a tween animation spec.
