...
object KineticIdentity {
     ...
     *
     * @param pauseDurationMillis The duration of the initial pause in milliseconds before the action animation begins.
     * @param actionSpec The animation spec to perform after the pause.
     * @return An animation spec with a total duration equal to the pause plus the action, applying dramatic easing throughout.
     */
