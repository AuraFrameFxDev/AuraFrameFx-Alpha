...
object KineticIdentity {
     ...
     * @return An infinite repeatable animation spec for Compose float animations.
     */
    ...
    /**
     * Returns an animation spec that adds a dramatic pause before performing the specified action animation.
     *
     * The resulting animation spec combines a pause of the given duration with the duration of the provided action animation, using a dramatic cubic bezier easing curve.
     *
