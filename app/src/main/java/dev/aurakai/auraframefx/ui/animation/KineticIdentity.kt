...
object KineticIdentity {
     ...
     *
     * The animation transitions a value between its initial state and [targetValue], repeating in reverse to create a continuous rhythmic motion.
     *
     ...
     * @return A tween animation spec suitable for rapid, linear glitch or shake animations.
     */
     ...
     *
     * The resulting animation has a total duration equal to the pause plus the action's duration, and uses a dramatic cubic bezier easing.
     *
     ...
     * @return An animation spec with combined pause and action duration, using dramatic easing.
     */
...
/**
     ...
     *
     * The resulting animation has a total duration equal to the specified delay plus the estimated duration of the original spec. For spring-based specs, the duration is estimated as 1000 ms; for other types, a standard duration is used.
     *
...
/**
     ...
     *
     * @param repeatMode The repeat mode to use (restart or reverse). Defaults to [RepeatMode.Restart].
