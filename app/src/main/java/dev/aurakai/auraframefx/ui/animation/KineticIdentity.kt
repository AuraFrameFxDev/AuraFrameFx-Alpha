...
object KineticIdentity {
     ...
     *
     * The animation cycles a value between its initial state and [targetValue] using linear easing, repeating in reverse for a seamless in-and-out motion.
     *
     ...
     *
     * The resulting animation has a total duration equal to the pause plus the action's duration, using a dramatic cubic bezier easing.
     *
