...
object KineticIdentity {
     ...
     * @return An [AnimationSpec] for animating float values with a linear, glitch-like motion.
     */
    ...
    /**
     * Returns an animation spec that introduces a pause before starting the specified action animation.
     *
     * The animation delays for the given pause duration, then performs the action with a combined duration and a dramatic cubic bezier easing curve.
     *
