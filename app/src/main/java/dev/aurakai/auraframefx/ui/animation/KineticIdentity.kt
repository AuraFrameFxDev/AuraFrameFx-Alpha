...
object KineticIdentity {
     ...
     *
     * The animation delays for the specified pause duration, then performs the action using a cubic bezier easing curve. The total duration combines the pause and the action's duration (estimated if not a tween).
     *
