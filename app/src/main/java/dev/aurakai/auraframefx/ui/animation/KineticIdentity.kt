...
object KineticIdentity {
     ...
     * @param intensity Intended shake intensity (for caller reference; not used in the spec).
     * @return An animation spec suitable for driving glitch or shake-style UI effects.
     */
     ...
     * @return An animation spec that sequences a pause followed by the action with dramatic easing.
     */
