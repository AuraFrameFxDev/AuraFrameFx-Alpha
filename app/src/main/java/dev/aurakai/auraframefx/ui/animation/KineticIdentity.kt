...
object KineticIdentity {
     ...
     *
     * The animation delays for the specified pause duration, then performs the action using a dramatic cubic bezier easing. The total duration is the sum of the pause and the action's duration.
     *
...
/**
     ...
     *
     * @param repeatMode The repeat mode to use for repetition (restart or reverse). Defaults to [RepeatMode.Restart].
...
/**
 * Returns a tween animation spec with the specified easing if the original spec is a tween; otherwise, returns the original spec unchanged.
 *
