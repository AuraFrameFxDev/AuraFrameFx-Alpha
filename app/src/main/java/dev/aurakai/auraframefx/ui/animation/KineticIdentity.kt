...
object KineticIdentity {
    ...
    /**
     * Returns an animation spec that adds a pause before performing the specified action animation.
     *
     * The animation delays for the given pause duration, then executes the action animation using a combined duration and a dramatic cubic bezier easing curve.
     *
