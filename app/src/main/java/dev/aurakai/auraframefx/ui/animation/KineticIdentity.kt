...
object KineticIdentity {
    ...
    /**
     * Creates an infinite repeatable animation spec that pulses a float value between its initial state and a target value.
     *
    ...
    /**
     * Creates an animation spec that introduces a pause before executing the specified action animation.
     *
     * The returned animation spec first delays for the given pause duration, then performs the action with a combined duration and a dramatic cubic bezier easing.
     *
