 ...
 *
 * Presents the app's name, a subtitle, and a status message in a vertically centered layout.
 * Includes buttons to navigate to the AI chat screen and a placeholder for future settings navigation.
 *
...
/**
 * Displays the AI chat interface screen with a centered layout, including a headline and a status message.
 */
@Composable
