 ...
 *
 * Presents the app name, a subtitle, and a beta status message in a vertically centered column layout.
 * Includes buttons for navigating to the AI chat screen and a placeholder for settings navigation.
 */
@Composable
