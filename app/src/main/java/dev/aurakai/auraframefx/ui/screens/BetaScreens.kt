 ...
 *
 * Presents the app's name, a subtitle, and a status message in a vertically centered column layout.
 ...
 *
 * Shows a headline and a readiness status message for Trinity AI agents.
 */
@Composable
