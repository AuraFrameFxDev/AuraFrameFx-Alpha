 ...
 */
/**
 * Displays the main home screen with app information and navigation buttons.
 *
 * Shows the app title, subtitle, and status message, along with buttons to navigate to the AI chat screen or settings.
 *
