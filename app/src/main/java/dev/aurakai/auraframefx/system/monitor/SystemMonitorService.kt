...
class SystemMonitorService : Service() {
     ...
     *
     * This suspend function runs in a loop, performing monitoring tasks and delaying between iterations until the service's coroutine scope is no longer active.
     */
