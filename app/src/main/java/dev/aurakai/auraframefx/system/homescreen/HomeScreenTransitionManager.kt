...
class HomeScreenTransitionManager @Inject constructor(
     ...
     *
     * Currently sets the configuration to the default as persistent loading is not yet implemented.
     */
    ...
    /**
     * Resets the current home screen transition configuration to the default settings.
     */
    fun resetToDefault() {
