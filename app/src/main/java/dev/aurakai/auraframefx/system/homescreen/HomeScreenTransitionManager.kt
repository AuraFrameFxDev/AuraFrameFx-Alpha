...
class HomeScreenTransitionManager @Inject constructor(
    ...
    /**
     * Loads the home screen transition configuration, defaulting to the preset configuration.
     *
     * Currently, this method sets the configuration to the default as persistent loading is not implemented.
     */
    ...
    /**
     * Resets the home screen transition configuration to its default settings.
     */
    fun resetToDefault() {
