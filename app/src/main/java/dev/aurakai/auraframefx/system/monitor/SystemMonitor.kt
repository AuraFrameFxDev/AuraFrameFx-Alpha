...
class SystemMonitor @Inject constructor(
    ...
    /**
     * Calculates and returns a normalized system health score between 0.0 (poor) and 1.0 (optimal), based on current CPU usage and available memory.
     *
     * The score is the average of the inverted CPU usage ratio (capped at 100%) and the available memory ratio (with a minimum threshold of 0.1).
     *
    ...
    /**
     * Retrieves a detailed snapshot of current system performance metrics and status.
     *
    ...
    /**
     * Updates the available and used memory state flows with the latest system memory information.
     *
