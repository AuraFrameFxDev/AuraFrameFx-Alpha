...
class SystemMonitor @Inject constructor(
     ...
     *
     * Disables periodic metric updates and halts ongoing monitoring activities.
     */
    fun stopMonitoring() {
    ...
    /**
     * Returns a map of current system performance metrics for a specified component.
     *
     ...
     *
     * Suspends execution while refreshing all monitored system metrics.
     */
    ...
    /**
     * Refreshes available and used memory metrics by querying the system's current memory status.
     *
     * Updates internal state flows with the latest available and used memory values. If memory information cannot be retrieved, previous metric values are retained.
     */
