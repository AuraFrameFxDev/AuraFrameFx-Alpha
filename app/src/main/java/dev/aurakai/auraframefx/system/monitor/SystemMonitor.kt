...
class SystemMonitor @Inject constructor(
     ...
     *
     * The score ranges from 0.0 (poor health) to 1.0 (optimal health), calculated as the average of an inverted CPU usage ratio (capped at 100%) and a minimum-threshold available memory ratio.
     *
     ...
     *
     * The report includes CPU usage, memory usage and availability, memory usage percentage, network activity, system health score, stress status, process and thread information, heap size, used heap, and a timestamp.
     *
     * @return A `SystemPerformanceReport` containing the latest snapshot of system metrics and health.
     */
     ...
     *
     * This method sequentially refreshes all monitored system metrics to provide up-to-date performance data.
     */
     ...
     *
     * If CPU usage calculation fails, logs a warning.
     */
     ...
     *
     * Retrieves current memory statistics from the Android system and updates internal state flows for available and used memory. If retrieval fails, logs a warning and retains previous metric values.
     */
     ...
     *
     * This is a placeholder implementation; replace with actual system data retrieval for production use.
     *
     ...
     *
     * @return The memory usage as a percentage of total system memory.
     */
