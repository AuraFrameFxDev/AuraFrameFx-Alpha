...
class SystemMonitor @Inject constructor(
     ...
     *
     * Launches a background coroutine that updates system metrics at the specified interval in milliseconds. If an error occurs during metric updates, the next attempt is delayed by twice the interval.
     *
     ...
     *
     * @return A `SystemPerformanceReport` containing all monitored system metrics and health indicators at the time of invocation.
     */
     ...
     *
     * This function suspends while sequentially refreshing all monitored system metrics.
     */
     ...
     *
     * Queries the Android ActivityManager for memory information and updates the available and used memory values. If retrieval fails, logs a warning and leaves previous values unchanged.
     */
