...
class SystemMonitor @Inject constructor(
     ...
     *
     * @return The current system health score.
     */
     ...
     *
     * The returned report includes CPU usage, memory usage and availability, memory usage percentage, network metrics, system health score, stress status, process and thread information, JVM heap statistics, and a timestamp.
     *
     * @return A `SystemPerformanceReport` containing the latest system metrics and overall system status.
     */
     ...
     *
     * Intended for future implementation with actual network monitoring logic.
     */
     ...
     *
     * @return The percentage of memory used, or 0f if unavailable.
     */
    ...
    /**
     * Stops monitoring and releases all resources used by the system monitor.
     *
     * Cancels ongoing monitoring activities and the internal coroutine scope to ensure proper cleanup.
     */
    fun cleanup() {
