...
class SystemMonitor @Inject constructor(
     ...
     *
     * The score ranges from 0.0 (poor health) to 1.0 (optimal health), averaging an inverted CPU usage ratio (capped at 100%) and a minimum-threshold ratio of available memory to total memory.
     *
     ...
     *
     * Queries the Android ActivityManager for memory information and updates the available and used memory values. If retrieval fails, logs a warning and retains previous values.
     */
