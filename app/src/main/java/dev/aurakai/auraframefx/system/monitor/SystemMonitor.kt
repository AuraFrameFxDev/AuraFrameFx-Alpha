...
class SystemMonitor @Inject constructor(
    ...
    /**
     * Returns a snapshot report of current system performance metrics and status.
     *
     ...
     *
     * This function suspends while collecting and updating all monitored system metrics.
     */
     ...
     *
     * Queries the Android ActivityManager for memory information and updates available and used memory values. If retrieval fails, logs a warning and retains previous values.
     */
