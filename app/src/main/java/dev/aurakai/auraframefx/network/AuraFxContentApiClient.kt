...
class AuraFxContentApiClient @Inject constructor(
     ...
     * @param temperature Controls randomness of the output; defaults to 0.7 if not specified.
    ...
    /**
     * Generates an AI-powered description for a given image URL, optionally incorporating additional context.
     *
