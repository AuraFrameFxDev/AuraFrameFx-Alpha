...
class AuraFxContentApiClient @Inject constructor(
    ...
    /**
     * Generates AI-powered text asynchronously from the provided prompt.
     *
    ...
    /**
         * Generates an AI-powered description for the image at the given URL, optionally using additional context to guide the output.
         *
