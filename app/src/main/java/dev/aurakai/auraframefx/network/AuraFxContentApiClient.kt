...
class AuraFxContentApiClient @Inject constructor(
    ...
    /**
     * Asynchronously generates an AI description for an image at the specified URL, optionally using additional context.
     *
     * @param imageUrl The URL of the image to be described.
     * @param context Optional text to guide or influence the generated description.
