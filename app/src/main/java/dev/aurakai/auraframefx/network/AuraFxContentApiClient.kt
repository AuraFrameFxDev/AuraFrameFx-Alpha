...
class AuraFxContentApiClient @Inject constructor(
    ...
    /**
     * Generates AI-powered text asynchronously based on the provided prompt.
     *
     * @param prompt The input text that guides the AI text generation.
     * @param maxTokens Optional maximum number of tokens to generate; defaults to 500 if not specified.
     * @param temperature Optional value controlling randomness of the output; defaults to 0.7 if not specified.
    ...
    /**
     * Generates an AI-powered description for an image at the given URL, optionally using additional context to influence the output.
     *
