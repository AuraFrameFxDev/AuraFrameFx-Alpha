...
class AuraFxContentApiClient @Inject constructor(
    ...
    /**
     * Generates AI-powered text asynchronously from a given prompt.
     *
     * @param prompt The text prompt to use for generation.
     * @param maxTokens The maximum number of tokens to generate; defaults to 500 if not provided.
     * @param temperature Controls randomness of the generated text; defaults to 0.7 if not provided.
