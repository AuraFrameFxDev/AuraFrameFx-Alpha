...
class AuraFxContentApiClient @Inject constructor(
     ...
     *
     * @param prompt The prompt used to guide text generation.
     * @param maxTokens Optional maximum number of tokens for the generated text; defaults to 500 if not specified.
     * @param temperature Optional value controlling randomness in the output; defaults to 0.7 if not specified.
    ...
    /**
         * Asynchronously requests an AI-generated description for the specified image URL, optionally using additional context to refine the result.
         *
         * @param imageUrl The URL of the image to describe.
         * @param context Optional information to provide further context for the description.
