...
class AuraFxContentApiClient @Inject constructor(
     ...
     * @param temperature Optional value controlling randomness in the output. Defaults to 0.7 if not provided.
    ...
    /**
     * Generates an AI-powered description for a given image URL, optionally influenced by additional context.
     *
