...
class AuraFxContentApiClient @Inject constructor(
    ...
    /**
     * Generates AI-powered text asynchronously from the specified prompt.
     *
    ...
    /**
         * Generates an AI-powered description for an image at the given URL, optionally using additional context to refine the result.
         *
