...
class AuraFxContentApiClient @Inject constructor(
     ...
     * @param maxTokens The maximum number of tokens for the generated text, or null to use the default (500).
     * @param temperature The randomness parameter for text generation, or null to use the default (0.7).
