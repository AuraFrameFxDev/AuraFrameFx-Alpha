 ...
 *
 * Uses the provided model path to set up the language identification system. If the model path is null, initialization is skipped.
 *
 * @param modelPath Java string representing the path to the language model.
 * @return jstring Returns the version string "1.2.0" on successful initialization, or an empty string if modelPath is null.
 */
JNIEXPORT jstring
 ...
 *
 * Cleans up resources associated with the specified language identifier handle if it is non-zero.
 *
