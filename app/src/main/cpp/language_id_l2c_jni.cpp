...
/**
 * @brief Initializes the language identifier with the given model path.
 *
 ...
 *
 * Logs cleanup for the provided handle if it is non-zero. Does not perform explicit resource deallocation.
 *
