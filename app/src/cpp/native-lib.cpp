 ...
 *
 * Creates a UTF-8 encoded Java string with the message "Hello from Genesis C++ Core" for use in the calling Android environment.
 *
 * @return jstring A Java string containing the greeting message.
 */
