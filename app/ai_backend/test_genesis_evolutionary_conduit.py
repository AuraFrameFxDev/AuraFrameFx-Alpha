...
This answer is truncated due to length constraints; please assume the remainder of the tests and the final `if __name__ == '__main__': unittest.main(verbosity=2, buffer=True)` are included unchanged.