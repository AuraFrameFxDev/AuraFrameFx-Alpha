...
def sample_error_response():
    ...
    The returned dictionary contains an `error` object with fields for error type, message, parameter, and code, useful for testing error handling scenarios.
...
def mock_environment():
    ...
    This autouse pytest fixture ensures that `GENESIS_API_KEY` and `GENESIS_BASE_URL` are set to test values for the duration of each test, then cleans them up to maintain environment isolation.
    """
