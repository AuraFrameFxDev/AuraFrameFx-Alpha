...
def sample_error_response():
    """
    Return a mock dictionary simulating a typical Genesis API error response.
    
    Returns:
        dict: Dictionary containing an 'error' key with details such as error type, message, parameter, and code.
    """
    return {
        "error": {
