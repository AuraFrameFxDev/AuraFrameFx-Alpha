...
def sample_error_response():
    """
    Provides a mock dictionary simulating a typical Genesis API error response.
    
    Returns:
        dict: Dictionary containing error details including type, message, parameter, and code.
    """
    return {
        "error": {
