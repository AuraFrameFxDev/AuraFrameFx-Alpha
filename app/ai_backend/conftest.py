...
def mock_base_url():
    """
    Returns a mock Genesis API base URL string for testing purposes.
    """
...
def sample_api_response():
    ...
    Returns:
        dict: A simulated API response including metadata, assistant message, finish reason, and token usage details.
    """
    return {
        "id": "test_response_id",
...
def mock_environment():
    ...
    This autouse fixture ensures that `GENESIS_API_KEY` and `GENESIS_BASE_URL` are set to test values before each test and removed afterward to maintain test isolation.
    """
