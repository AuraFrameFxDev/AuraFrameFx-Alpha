...
def mock_base_url():
    """
    Returns a static mock base URL for the Genesis API used in integration tests.
...
def sample_error_response():
    ...
    The returned dictionary contains an `error` object with fields for type, message, parameter, and code, suitable for testing error handling in Genesis API integration tests.
...
def mock_environment():
    ...
    This autouse pytest fixture ensures that `GENESIS_API_KEY` and `GENESIS_BASE_URL` are assigned test values at the start of each test and deleted afterward, maintaining environment isolation for Genesis API integration tests.
    """
