...
class GenesisBridgeServer:
    ...
    def start(self):
        ...
        Launches a background thread to handle queued requests and enters a loop to read, parse, and enqueue incoming JSON requests. Handles invalid JSON input gracefully and supports shutdown via keyboard interruption.
        """
        self.running = True
    ...
    def _process_requests(self):
        ...
        Ensures each request is handled by the appropriate method and maintains server responsiveness by catching and reporting errors.
        """
        while self.running:
            try:
