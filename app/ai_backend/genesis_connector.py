...
class GenesisBridgeServer:
    ...
    def start(self):
        ...
        Continuously reads JSON requests from standard input, enqueues them for background processing, and handles invalid input gracefully. Supports shutdown via keyboard interruption.
        """
        self.running = True
    ...
    def _process_requests(self):
        ...
        Ensures continuous request handling and error reporting to maintain server responsiveness.
        """
        while self.running:
            try:
