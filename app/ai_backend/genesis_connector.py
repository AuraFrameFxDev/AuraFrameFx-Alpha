...
class GenesisBridgeServer:
    ...
    def start(self):
        ...
        Launches a background thread for request handling and continuously reads, parses, and enqueues incoming JSON requests. Handles invalid JSON input gracefully and supports server shutdown on keyboard interruption.
        """
        self.running = True
