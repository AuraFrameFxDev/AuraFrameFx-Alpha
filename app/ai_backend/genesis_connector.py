...
class GenesisBridgeServer:
    ...
    def _process_requests(self):
        ...
        Each request is handled by the appropriate method, and any processing errors are caught and reported to maintain server responsiveness.
        """
        while self.running:
            try:
    ...
    def _handle_request(self, request):
        """
        Routes a JSON-decoded request dictionary to the appropriate handler based on its "requestType" and returns the handler's response.
        
        Parameters:
            request (dict): The incoming request containing a "requestType" field and optional additional data.
