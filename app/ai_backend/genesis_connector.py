...
class GenesisBridgeServer:
    ...
    def _process_requests(self):
        """
        Processes queued requests in a background thread and sends responses to the client.
        
        Continuously retrieves requests from the internal queue, delegates handling to the appropriate method, and outputs responses. Catches and reports errors to ensure uninterrupted server operation.
        """
        while self.running:
            try:
