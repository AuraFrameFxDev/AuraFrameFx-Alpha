...
class GenesisBridgeServer:
    ...
    def start(self):
        ...
        Continuously reads and enqueues incoming JSON requests, launches a background thread for request handling, and gracefully handles invalid input and shutdown via keyboard interruption.
        """
        self.running = True
