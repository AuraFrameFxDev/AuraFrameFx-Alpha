...
# print_error prints a message with a red [ERROR] prefix to indicate an error condition.
print_error() {
    echo -e "${RED}[ERROR]${NC} $1"
}

# print_genesis prints a message with a purple [GENESIS] prefix for Genesis Layer notifications.
print_genesis() {
