...
# print_status prints an informational message to standard output with a blue [INFO] prefix.
print_status() {
    echo -e "${BLUE}[INFO]${NC} $1"
}

# print_success prints a message to standard output with a green [SUCCESS] prefix, indicating a successful operation.
print_success() {
...
# print_genesis prints a Genesis Layer notification to standard output with a purple [GENESIS] prefix.
print_genesis() {
