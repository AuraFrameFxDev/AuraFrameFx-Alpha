...
# print_warning prints a warning message prefixed with a yellow [WARNING] label.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error prints a message to stdout prefixed with a red [ERROR] label to indicate an error condition.
print_error() {
