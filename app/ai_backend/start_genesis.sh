...
# print_success prints a message to stdout with a green [SUCCESS] prefix to indicate success.
print_success() {
...
# print_error prints an error message with a red [ERROR] prefix to stdout.
print_error() {
