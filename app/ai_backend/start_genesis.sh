...
# print_error prints an error message in red color to stdout.
print_error() {
    echo -e "${RED}[ERROR]${NC} $1"
}

# print_genesis prints a message prefixed with [GENESIS] in purple color for Genesis Layer-specific output.
print_genesis() {
