...
# print_status prints an informational message in blue with an [INFO] label to stdout.
print_status() {
...
# print_warning prints a warning message in yellow to the terminal.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error prints an error message prefixed with a red [ERROR] label to standard output.
print_error() {
