...
# print_status prints an informational message with a blue [INFO] label.
print_status() {
...
# print_warning prints a message with a yellow [WARNING] label to indicate a warning.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error prints a message with a red [ERROR] label to indicate an error.
print_error() {
