...
# print_warning prints a warning message to stdout with a yellow [WARNING] label prefix.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error prints an error message to the terminal, prefixed with a red [ERROR] label.
print_error() {
