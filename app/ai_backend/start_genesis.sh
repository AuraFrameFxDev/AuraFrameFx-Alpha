...
# print_warning prints a warning message to stdout prefixed with a yellow [WARNING] label.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error prints an error message prefixed with a red [ERROR] label.
print_error() {
