...
# print_success outputs a message labeled [SUCCESS] in green to indicate a successful operation.
print_success() {
    echo -e "${GREEN}[SUCCESS]${NC} $1"
}

# print_warning displays a message with a yellow [WARNING] label to indicate a warning.
print_warning() {
    echo -e "${YELLOW}[WARNING]${NC} $1"
}

# print_error displays a message labeled with a red [ERROR] tag to indicate an error.
print_error() {
