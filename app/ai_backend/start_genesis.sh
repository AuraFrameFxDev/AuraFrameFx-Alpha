...
# print_status prints an informational message in blue color to stdout.
print_status() {
    echo -e "${BLUE}[INFO]${NC} $1"
}

# print_success prints a success message in green with a [SUCCESS] label.
print_success() {
    echo -e "${GREEN}[SUCCESS]${NC} $1"
}

# print_warning prints a warning message in yellow with a [WARNING] label.
print_warning() {
...
# print_genesis prints a message with the [GENESIS] label in purple for Genesis Layer-specific output.
print_genesis() {
