...
# print_status prints an informational message with a blue [INFO] prefix to stdout.
print_status() {
    echo -e "${BLUE}[INFO]${NC} $1"
}

# print_success prints a message prefixed with [SUCCESS] in green color to stdout.
print_success() {
...
# print_error prints the given message as an error in red color to stdout.
print_error() {
    echo -e "${RED}[ERROR]${NC} $1"
}

# print_genesis prints a message with a [GENESIS] prefix in purple color for Genesis-specific output.
print_genesis() {
