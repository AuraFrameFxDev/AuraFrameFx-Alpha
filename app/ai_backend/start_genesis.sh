...
# print_error prints an error message in red to stdout.
print_error() {
    echo -e "${RED}[ERROR]${NC} $1"
}

# print_genesis prints a message prefixed with a colored [GENESIS] tag for Genesis-specific status output.
print_genesis() {
