...
# print_error prints an error message with a red [ERROR] label for error notifications.
print_error() {
    echo -e "${RED}[ERROR]${NC} $1"
}

# print_genesis prints a message prefixed with a purple [GENESIS] label to indicate Genesis Layer notifications.
print_genesis() {
