...
def create_mock_response(status_code=200, json_data=None, headers=None, text=None):
    """
    Return a mock HTTP response object with customizable status code, JSON data, headers, and text content for testing purposes.
...
def create_test_connector(config_overrides=None):
    ...
    Returns:
        GenesisConnector: An instance configured with the merged test and override settings.
    """
