...
def create_mock_response(status_code=200, json_data=None, headers=None, text=None):
    ...
    Parameters:
        ...
        json_data (any, optional): Data to return from the mock's .json() method. If not provided, .json() raises a ValueError.
...
def create_test_connector(config_overrides=None):
    """
    Instantiate and return a GenesisConnector for testing, using default configuration with optional overrides.
