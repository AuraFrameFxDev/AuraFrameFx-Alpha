...
def create_test_connector(config_overrides=None):
    """
    Create and return a GenesisConnector instance configured for testing, with optional configuration overrides.
    
    Parameters:
        config_overrides (dict, optional): Dictionary of configuration values to override the default test settings.
    
    Returns:
        GenesisConnector: An instance initialized with the merged test configuration.
    """
