...
def create_mock_response(status_code=200, json_data=None, headers=None, text=None):
    """
    Generate a mock HTTP response object with customizable status code, headers, text, and optional JSON data for testing purposes.
    ...
    Parameters:
        ...
        text (str, optional): Text content for the response body. Defaults to an empty string.
