...
class EthicalGovernor:
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        The provided evaluator will be invoked to assess the ethical compliance of actions matching the given type, allowing for tailored evaluation logic.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects which ethical principles are directly violated by an action based on its context.
        
        Returns:
            List[str]: Names of ethical principles violated, such as "privacy", "security", or "autonomy".
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects potential ethical concerns in the action context that warrant monitoring, such as lack of transparency or safety risks.
        
        Returns:
            List of ethical principle names that are potentially at risk in the given context.
        """
        concerns = []
