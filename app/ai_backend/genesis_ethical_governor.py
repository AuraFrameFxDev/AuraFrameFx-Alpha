...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: A dictionary suitable for serialization or logging, containing all EthicalDecision fields with enums converted to their string values and the timestamp formatted as an ISO 8601 string.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Return a dictionary mapping ethical principles to their assigned weights, prioritizing those present in the Genesis ethical foundation and filling in defaults for any missing principles.
        
        Returns:
            Dict[str, float]: Mapping of ethical principle names to their weight values.
        """
        weights = {}
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action against core ethical principles, and returns the resulting decision. If an error occurs during evaluation, returns a critical BLOCK decision to maintain system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action within its context to determine ethical compliance and returns an appropriate ethical decision.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            A list of principle names (e.g., "privacy", "security", "autonomy") that are violated based on the action type and context.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Return a list of ethical principles that raise concerns and require monitoring for the specified action context.
        ...
        Returns:
            List[str]: Ethical principles (e.g., "transparency", "safety") that are of concern for the action.
        """
        concerns = []
