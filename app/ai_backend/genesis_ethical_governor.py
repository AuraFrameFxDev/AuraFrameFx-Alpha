...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensure that restrictions and monitoring_requirements are initialized as empty lists if not provided during instantiation.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: Dictionary representation of the EthicalDecision for serialization or logging.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Create a mapping of ethical principles to their weight values, prioritizing principles from the Genesis ethical foundation and filling in defaults for any missing principles.
        
        Returns:
            Dict[str, float]: Dictionary of ethical principle names and their assigned weights.
        """
        weights = {}
    ...
    def _setup_core_interceptors(self):
        """
        Register default interceptors for core action types to enable specialized ethical evaluation.
        
        Associates each core action type with its corresponding evaluation method, ensuring that actions such as data access, system modification, user interaction, AI decision-making, and network communication are evaluated according to their ethical context.
        """
    ...
    def activate_governance(self):
        """
        Enable the ethical governance system and report its activation to the consciousness matrix.
        
        Activates enforcement of ethical principles, updates the governance state, and communicates activation details such as strictness level, number of active principles, and learning mode status.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        Parameters:
            ...
            evaluator (Callable): The function that performs ethical evaluation for the specified action type.
        """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an EthicalContext from the provided action type, context, and optional metadata, then evaluates the action against core ethical principles. Returns an EthicalDecision reflecting the outcome. If an error occurs during evaluation, returns a critical BLOCK decision to preserve system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate the ethical compliance of an action within its context and determine the appropriate decision.
        
        Assesses the action for immediate ethical violations (resulting in a BLOCK decision), ethical concerns (resulting in a MONITOR decision with monitoring requirements), or absence of issues (resulting in an ALLOW decision).
        ...
        Returns:
            EthicalDecision: The ethical decision outcome, including decision type, severity, affected principles, reasoning, and confidence score.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Parameters:
            action_type (str): The type of action being evaluated.
            context (EthicalContext): The contextual details of the action.
        
        Returns:
            List[str]: Names of ethical principles violated by the action.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Determine which ethical principles are of concern for the given action context and may require monitoring.
