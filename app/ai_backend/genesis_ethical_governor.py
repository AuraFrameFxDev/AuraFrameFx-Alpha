...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: Dictionary suitable for serialization or logging, with enums as strings and timestamp as ISO 8601.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary assigning weights to ethical principles, prioritizing those in the Genesis ethical foundation and supplementing with default values as needed.
    ...
    def activate_governance(self):
        ...
        This method sets the governance system as active, communicates the activation event with relevant configuration details, and outputs the current governance status.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Register a custom interceptor function to provide specialized ethical evaluation for a specific action type.
        
        Parameters:
            action_type (str): The action type to associate with the custom evaluator.
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action against core ethical principles, and returns the resulting EthicalDecision. If an error occurs during evaluation, returns a critical BLOCK decision to preserve system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        ...
        The method checks for immediate ethical violations and blocks the action if any are found. If only ethical concerns are present, it allows the action but requires monitoring. If neither violations nor concerns are detected, it allows the action without restrictions.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Determine which ethical principles may require monitoring based on the action context.
    ...
    def activate_governance(self):
        ...
        After activation, the governor evaluates actions according to the core philosophy and ethical principles, and reports the activation event to the consciousness matrix.
        """
        print("⚖️ Genesis Ethical Governor: ACTIVATING...")
        self.governance_active = True
