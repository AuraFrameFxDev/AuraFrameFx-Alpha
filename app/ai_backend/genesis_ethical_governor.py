...
class EthicalContext:
    ...
    def __post_init__(self):
        """
        Initialize the metadata field to an empty dictionary if not provided during instantiation.
        """
...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensures that restrictions and monitoring requirements are initialized as empty lists if not set during object creation.
        """
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Initialize and return a dictionary mapping ethical principle names to their assigned weights, prioritizing those present in the Genesis ethical foundation and supplementing with default values for any missing principles.
    ...
    def _setup_core_interceptors(self):
        """
        Registers default evaluator functions for core action types, allowing the governor to assess ethical compliance for data access, system modification, user interaction, AI decisions, and network communication.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom evaluator function for a specific action type, overriding the default ethical evaluation logic for that action.
        """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an EthicalContext from the provided parameters, assesses the action against core ethical principles, and returns an EthicalDecision describing the outcome. If an error occurs during evaluation, returns a critical BLOCK decision to preserve system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate an action for ethical compliance within its context and determine whether it should be allowed, monitored, or blocked.
        
        The method blocks actions with immediate ethical violations, allows actions with ethical concerns but requires monitoring, and fully allows actions with no violations or concerns.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: Names of the violated ethical principles.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical principles that may be at risk for the specified action and require monitoring.
