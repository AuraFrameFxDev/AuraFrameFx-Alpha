...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Initialize restrictions and monitoring requirements as empty lists if they are not set during instantiation.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: Serializable dictionary suitable for storage or transmission.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _setup_core_interceptors(self):
        """
        Registers default interceptors for core action types, enabling ethical evaluation of data access, system modification, user interaction, AI decisions, and network communication.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Register a custom interceptor function to evaluate the ethical compliance of actions for a specified action type.
        
        The provided evaluator will be used to assess actions of the given type, enabling custom ethical evaluation logic.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical principles directly violated by an action given its context.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: Names of ethical principles that are potentially at risk and should be monitored.
        """
        concerns = []
