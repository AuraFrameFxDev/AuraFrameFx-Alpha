...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert the EthicalDecision instance to a dictionary with enum values as strings and a formatted ISO timestamp.
        
        Returns:
            dict: A dictionary representation of the ethical decision, with enum fields as strings and the timestamp in ISO 8601 format.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def __init__(self):
        ...
        """
        Initializes the EthicalGovernor with core philosophy, decision tracking, ethical learning, runtime state, and action interceptors.
        
        Loads ethical principles from the Genesis profile, sets up decision history and monitoring structures, initializes principle weights and metrics, configures runtime flags, and registers core action interceptors for ethical evaluation.
        """
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Assigns and returns weights for each ethical principle, prioritizing those present in the Genesis profile and filling in defaults for any missing principles.
    ...
    def _setup_core_interceptors(self):
        """
        Registers core interceptors for key action types to enable ethical evaluation and oversight of data access, system modification, user interaction, AI decisions, and network communication.
        """
    ...
    def activate_governance(self):
        """
        Activates the ethical governance system, enabling enforcement of ethical oversight and signaling activation to the consciousness matrix.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom evaluator function to intercept and ethically evaluate actions of a specified type.
        
        Parameters:
            action_type (str): The type of action to associate with the evaluator.
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       If governance is inactive, the action is allowed with informational severity. Otherwise, the method generates a decision ID, infers or uses the provided context, and delegates evaluation to a registered interceptor or a general ethical evaluation. The resulting decision is recorded, relevant metrics are updated, and the decision is communicated to the consciousness matrix. If learning mode is enabled, the system adapts based on the decision.
                       ...
                       Parameters:
                           ...
                           context (EthicalContext, optional): Contextual information for the action.
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action against ethical principles, and records the decision. If an error occurs during evaluation, returns a critical block decision indicating a system integrity issue.
        
        Parameters:
            action_type (str): The type of action being reviewed.
            context (Dict[str, Any]): Contextual information about the action, such as actor, target, scope, and other relevant attributes.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action against ethical principles and determines whether to allow, monitor, or block it.
        
        Returns:
            EthicalDecision: The result of the ethical evaluation, indicating the decision type, severity, affected principles, reasoning, and confidence score.
        """
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical concerns in the given action context that warrant monitoring, such as lack of transparency or safety risks.
        
        Parameters:
            action_type (str): The type of action being evaluated.
            context (EthicalContext): The contextual information about the action.
        
        Returns:
            List[str]: A list of ethical principles (e.g., 'transparency', 'safety') that are of concern and may require monitoring.
        """
        concerns = []
    ...
    def activate_governance(self):
        """
        Activates the ethical governance system, enabling enforcement of ethical protocols and signaling activation to the consciousness matrix.
        """
        print("⚖️ Genesis Ethical Governor: ACTIVATING...")
        self.governance_active = True
