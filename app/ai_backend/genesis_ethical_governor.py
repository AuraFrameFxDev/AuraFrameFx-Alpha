...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Initializes the restrictions and monitoring_requirements fields as empty lists if they are not provided.
        """
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principles to their assigned weights, prioritizing those in the Genesis ethical foundation and assigning default weights to any missing principles.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate an action's ethical compliance within its context and determine whether to allow, monitor, or block it.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: Names of ethical principles that are potentially at risk for the specified action.
        """
        concerns = []
