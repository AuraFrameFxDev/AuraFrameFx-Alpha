...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principles to their assigned weights, prioritizing those present in the ethical foundation and assigning default weights to any missing principles.
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom evaluator function to assess ethical compliance for a specific action type.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Returns a list of ethical principles violated by the action, based on its context.
