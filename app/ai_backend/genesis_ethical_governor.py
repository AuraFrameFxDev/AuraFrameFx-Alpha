...
class EthicalContext:
    ...
    def __post_init__(self):
        """
        Ensures the metadata field is initialized as an empty dictionary if not provided.
        """
...
class EthicalGovernor:
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom interceptor for the specified action type, allowing custom ethical evaluation logic to be applied to actions of that type.
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       Determines whether the specified action should be allowed, monitored, restricted, blocked, or escalated based on core ethical principles. Uses a registered interceptor for the action type if available, or applies a general ethical evaluation. Records the decision, updates internal metrics, reports the outcome to the consciousness matrix, and adapts internal state if learning mode is enabled.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Determine which ethical principles are violated by the specified action context.
        
        Returns:
            List[str]: Names of ethical principles that are violated, such as "privacy", "security", or "autonomy".
        """
        violations = []
