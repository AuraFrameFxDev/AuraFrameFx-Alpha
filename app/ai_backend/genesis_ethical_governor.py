...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert the EthicalDecision instance to a dictionary with enum values as strings and the timestamp in ISO 8601 format.
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Create a mapping of ethical principles to their assigned weights, prioritizing those present in the loaded ethical foundation and filling in defaults for any missing principles.
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        The evaluator function will be called for actions of the given type, enabling tailored ethical evaluation logic.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       Determines whether an action should be allowed, monitored, restricted, blocked, or escalated based on ethical principles. Uses a registered interceptor for the action type if available, or performs a general ethical evaluation. Records the decision, updates relevant metrics, reports the outcome to the consciousness matrix, and adapts internal state if learning mode is enabled.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action in its ethical context and returns a decision to allow, monitor, or block the action.
        
        The method checks for immediate ethical violations and blocks the action if any are found, specifying the violated principles. If only ethical concerns are detected, it allows the action but requires monitoring. If neither violations nor concerns are present, the action is allowed without restrictions.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical principles that are of concern for a given action context, such as lack of transparency or potential safety risks.
        
        Returns:
            List[str]: A list of ethical principle names that warrant monitoring for the specified action.
        """
        concerns = []
    ...
    def activate_governance(self):
        ...
        Once activated, the governor evaluates and regulates actions according to the core philosophy and ethical principles, and reports the activation event to the external consciousness matrix.
        """
        print("⚖️ Genesis Ethical Governor: ACTIVATING...")
        self.governance_active = True
