...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: A serializable representation of the decision suitable for storage or transmission.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principle names to their assigned weights, prioritizing those from the Genesis ethical foundation and supplementing with default values for any missing principles.
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom evaluator function to handle ethical assessment for a specific action type.
        
        The evaluator will be invoked whenever an action of the specified type is evaluated, allowing for custom ethical logic.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       Determines whether a given action should be allowed, monitored, restricted, blocked, or escalated based on ethical principles. Uses a registered interceptor for the action type if available, or performs a general ethical evaluation. Records the decision, updates internal metrics, reports the outcome to the consciousness matrix, and adapts internal state if learning mode is enabled.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Assess the ethical compliance of an action within its context and return a decision indicating whether to allow, monitor, or block the action.
        
        The evaluation checks for immediate ethical violations and blocks the action if any are found. If only concerns are detected, the action is allowed with monitoring requirements. If neither violations nor concerns are present, the action is allowed without restrictions.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects direct violations of ethical principles based on the provided action context.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects ethical principles that may be at risk in the given action context and require monitoring.
        
        Returns:
            List of principle names for which concerns such as lack of transparency or safety are identified.
        """
        concerns = []
