...
class EthicalGovernor:
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate an action within its ethical context and return a decision indicating whether to allow, monitor, or block the action.
        
        Checks for direct ethical violations and blocks the action if any are found. If only ethical concerns are present, allows the action with monitoring requirements. If neither violations nor concerns exist, allows the action without restrictions.
