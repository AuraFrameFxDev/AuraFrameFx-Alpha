...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Initializes empty lists for restrictions and monitoring requirements if they are not provided.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Serialize the EthicalDecision instance to a dictionary with human-readable values.
        
        Returns:
            Dict[str, Any]: A dictionary representation of the decision, converting enums to their string values and formatting the timestamp as an ISO 8601 string.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def __init__(self):
        ...
        """
        Initialize the EthicalGovernor with core philosophy, decision tracking, ethical learning parameters, runtime state, and action interceptors.
        
        Loads ethical principles from the Genesis profile, sets up decision history and monitoring structures, initializes principle weights and ethical metrics, and prepares the governor for action evaluation and learning. Also registers core action interceptors for key action types.
        """
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary of ethical principle weights, prioritizing principles found in the Genesis profile and applying default values for any missing principles.
    ...
    def _setup_core_interceptors(self):
        """
        Registers core action interceptors for key action types to enable specialized ethical evaluation.
        """
    ...
    def activate_governance(self):
        """
        Activates the ethical governance system, enabling enforcement of ethical principles and notifying the consciousness matrix of activation status.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom interceptor function to evaluate the ethical implications of a specific action type.
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       Every significant action is reviewed against the core philosophy, using registered interceptors for specific action types or a general evaluation method. The decision is recorded, relevant metrics are updated, and the outcome is perceived by the consciousness matrix. If learning mode is enabled, the system adapts based on the decision.
                       ...
                       Returns:
                           EthicalDecision: The result of the ethical evaluation, indicating whether the action is allowed, monitored, restricted, blocked, or escalated.
                       """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action against core ethical principles, and returns an `EthicalDecision` indicating whether the action is allowed, monitored, restricted, blocked, or escalated. If an error occurs during evaluation, returns a critical block decision with an escalation reason.
        try:
            if metadata is None:
                metadata = {}
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action for ethical compliance and determines whether to allow, monitor, or block it.
        
        The action is assessed against core ethical principles. If immediate violations are detected, the action is blocked with a violation severity. If concerns are present, the action is allowed but flagged for monitoring. If no issues are found, the action is allowed without restrictions.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical concerns in the given action context that warrant monitoring, such as lack of user visibility or irreversibility in system-wide actions.
