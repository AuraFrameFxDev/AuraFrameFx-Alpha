...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Serialize the EthicalDecision instance to a dictionary, converting enums to their string values and formatting the timestamp in ISO 8601.
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principles to their assigned weights, prioritizing those defined in the ethical foundation and supplementing with default values for any missing principles.
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        Associates the specified action type with a custom evaluator function, allowing tailored ethical assessment for actions of that type.
        """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        """
        Constructs an ethical context from the provided action details and evaluates the action for compliance with core ethical principles.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action within its ethical context and determines whether to allow, monitor, or block it based on compliance with core ethical principles.
        
        If direct ethical violations are detected, the action is blocked. If ethical concerns are present, the action is allowed with monitoring requirements. Actions with no issues are permitted without restrictions.
        
        Returns:
            EthicalDecision: The outcome of the ethical evaluation, detailing the decision type, severity, affected principles, reasoning, and confidence score.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Returns a list of ethical principles directly violated by the specified action context.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: A list of ethical principles (e.g., "transparency", "safety") that are of concern based on the action's characteristics and context.
        """
        concerns = []
