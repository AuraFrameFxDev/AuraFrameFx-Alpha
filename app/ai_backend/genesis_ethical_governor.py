...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        ...
        Returns:
            Dict[str, float]: A dictionary where each key is an ethical principle name and each value is its corresponding weight.
        """
        weights = {}
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        The provided evaluator replaces the default evaluation logic for the specified action type, allowing tailored ethical assessments.
        """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an EthicalContext from the provided action type, context, and optional metadata, then evaluates the action against core ethical principles. If evaluation fails due to an error, returns a critical BLOCK decision to preserve system integrity.
        
        Parameters:
            action_type (str): The type of action to review.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        ...
        Checks for immediate ethical violations and blocks the action if any are found. If only ethical concerns are present, allows the action with monitoring requirements. If neither violations nor concerns exist, allows the action without restrictions.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify which ethical principles are violated by an action given its context.
        ...
        Returns:
            List[str]: The names of violated ethical principles.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: Names of ethical principles that are potentially at risk and should be monitored for this action.
        """
        concerns = []
