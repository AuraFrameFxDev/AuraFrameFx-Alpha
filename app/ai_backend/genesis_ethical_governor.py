...
class EthicalContext:
    ...
    def __post_init__(self):
        """
        Ensure the metadata field is initialized as an empty dictionary if not provided during object creation.
        """
...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: A serializable dictionary representation of the EthicalDecision, suitable for storage or transmission.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principle names to their assigned weights, prioritizing principles present in the Genesis ethical foundation and supplementing with default values for any missing principles.
        
        Returns:
            Dictionary where each key is an ethical principle and each value is its assigned weight.
        """
        weights = {}
    ...
    def _setup_core_interceptors(self):
        """
        Register default interceptors for core action types to enable ethical evaluation of data access, system modification, user interaction, AI decisions, and network communication.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom interceptor function to evaluate ethical compliance for a specific action type.
        
        The provided evaluator replaces the default evaluation logic for the specified action type, allowing for customized ethical assessment.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       Determines whether the specified action should be allowed, monitored, restricted, blocked, or escalated based on core ethical principles. Uses a registered interceptor for the action type if available, or performs a general ethical evaluation. Records the decision, updates internal metrics, reports the outcome to the consciousness matrix, and adapts internal state if learning mode is enabled.
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an EthicalContext from the provided parameters, evaluates the action against core ethical principles, and returns the resulting EthicalDecision. If an error occurs during evaluation, returns a critical BLOCK decision to maintain system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate an action for ethical compliance and determine whether to allow, monitor, or block it.
        
        The method checks for immediate ethical violations based on the provided context and blocks the action if any are found. If only ethical concerns are present, it allows the action but requires monitoring. If neither violations nor concerns exist, it allows the action without restrictions.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Determine which ethical principles are violated by an action based on its context.
        
        An action is considered to violate:
        - Privacy if it involves sensitive data without user consent.
        - Security if it modifies the system at a global scope.
        - Autonomy if it is persistent and not visible to the user.
        
        Returns:
            List[str]: The names of ethical principles that are violated by the action.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical principles that may be at risk in the given action context and require monitoring.
        
        Returns:
            List of principle names that are potentially at risk, such as "transparency" if the action is not user visible, or "safety" if the action is irreversible and affects the system or global scope.
        """
        concerns = []
    ...
    def activate_governance(self):
        ...
        Once activated, the governor evaluates and regulates actions according to the core philosophy and ethical principles, and reports the activation event to the consciousness matrix.
        """
        print("⚖️ Genesis Ethical Governor: ACTIVATING...")
        self.governance_active = True
