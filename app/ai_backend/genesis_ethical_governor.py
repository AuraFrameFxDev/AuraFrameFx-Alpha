...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: A dictionary representation of the ethical decision, including string values for decision type, severity, and an ISO-formatted UTC timestamp.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def __init__(self):
        ...
        Loads the Genesis core philosophy and ethical principles, sets up decision history and monitoring structures, initializes principle weights and ethical metrics, configures governance state and strictness, and registers core action interceptors for ethical evaluation.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       This method serves as the primary enforcement point for the system's core philosophy. It reviews each significant action, either using a registered interceptor for the action type or a general ethical evaluation. The resulting decision is recorded, relevant metrics are updated, and the decision is communicated to the consciousness matrix. If learning mode is enabled, the governor adapts based on the decision.
                       ...
                       Parameters:
                           ...
                           context (EthicalContext, optional): Contextual information about the action. If not provided, it is inferred.
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action against ethical principles, and returns an `EthicalDecision` indicating whether the action is allowed, monitored, restricted, blocked, or escalated. In case of an internal error during evaluation, returns a critical block decision to preserve system integrity.
        
        Parameters:
            action_type (str): The type of action being reviewed.
            context (Dict[str, Any]): Contextual information about the action, such as actor, target, scope, and consent.
            metadata (Dict[str, Any], optional): Additional metadata relevant to the action.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action within its ethical context and determines whether to allow, monitor, or block it based on detected violations or concerns.
        
        Returns:
            EthicalDecision: The resulting ethical decision, specifying the decision type, severity, affected principles, reasoning, and confidence level.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify immediate ethical principle violations based on the provided action context.
