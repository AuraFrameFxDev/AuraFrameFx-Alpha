...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensure that `restrictions` and `monitoring_requirements` are initialized as empty lists if not set during object creation.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Dictionary representation of the ethical decision, suitable for serialization or logging.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary assigning weights to ethical principles, prioritizing those in the Genesis ethical foundation and supplementing with default values for any missing principles.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action in its context to determine ethical compliance, returning a decision to allow, monitor, or block the action.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List[str]: Names of violated ethical principles, including "privacy" if sensitive data is used without consent, "security" if a global system modification occurs, and "autonomy" if a persistent action is not visible to the user.
        """
        violations = []
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Determine which ethical principles require monitoring based on the action context, such as insufficient transparency or potential safety risks.
        
        Returns:
            List[str]: Names of ethical principles that present concerns and warrant monitoring.
        """
        concerns = []
