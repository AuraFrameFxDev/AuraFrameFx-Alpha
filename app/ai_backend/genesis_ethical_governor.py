...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensures that `restrictions` and `monitoring_requirements` are set to empty lists if they are not provided during initialization.
        """
...
class EthicalGovernor:
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        ...
        The method blocks actions with immediate ethical violations, allows actions with ethical concerns but requires monitoring, and allows actions without concerns or violations.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects ethical principles that warrant monitoring for an action based on transparency or safety concerns in the provided context.
