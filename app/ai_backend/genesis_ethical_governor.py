...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Initializes `restrictions` and `monitoring_requirements` as empty lists if they are not provided during instantiation.
        """
...
class EthicalGovernor:
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        Parameters:
            ...
            evaluator (Callable): The function to be used for ethical evaluation of actions of this type.
        """
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluates an action for ethical compliance within its context and returns an appropriate ethical decision.
        
        The method blocks actions with immediate ethical violations, allows actions with monitoring if ethical concerns are present, and permits actions without restrictions if no issues are detected.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify ethical principles that present concerns for a given action and context.
