...
class EthicalContext:
    ...
    def __post_init__(self):
        """
        Initializes the metadata field to an empty dictionary if it is not provided during object creation.
        """
...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert the ethical decision to a dictionary with human-readable values.
        
        Returns:
            Dict[str, Any]: A dictionary representation of the ethical decision, with enum fields as strings and the timestamp formatted as an ISO 8601 datetime.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def __init__(self):
        ...
        """
        Initialize the EthicalGovernor with core philosophy, ethical principles, decision tracking, learning mechanisms, runtime state, and action interceptors.
        
        Loads ethical principles from the Genesis profile, sets up decision history and monitoring structures, initializes principle weights and violation patterns, configures runtime parameters such as strictness and learning mode, and registers core action interceptors for ethical evaluation.
        """
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        ...
        Returns:
            Dict[str, float]: A dictionary mapping ethical principle names to their assigned weights.
        """
        weights = {}
    ...
    def activate_governance(self):
        """
        Activates the ethical governance system, enabling enforcement of ethical principles and signaling activation to the consciousness matrix.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        ...
        Parameters:
            ...
            evaluator (Callable): The function that will evaluate the ethical implications of the specified action type.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       This method serves as the primary enforcement point for the system's core philosophy. It reviews each significant action, applying registered interceptors or a general ethical evaluation to determine whether the action should be allowed, monitored, restricted, blocked, or escalated. The decision is recorded, relevant metrics are updated, and the outcome is communicated to the consciousness matrix. If learning mode is enabled, the system adapts based on the decision.
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action using the governor's rules, and records the decision. If an error occurs during evaluation, returns a critical block decision indicating a system integrity issue.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        ...
        Returns:
            EthicalDecision: The ethical decision for the action, including decision type, severity, affected principles, reasoning, and confidence score.
        """
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify immediate ethical violations in the given action context.
