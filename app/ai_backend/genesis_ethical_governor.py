...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert the EthicalDecision to a dictionary with enum fields as strings and the timestamp in ISO 8601 format.
        
        Returns:
            dict: Serializable representation of the decision suitable for logging or transmission.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principle names to their assigned weights, prioritizing those present in the Genesis ethical foundation and assigning default weights to any missing principles.
    ...
    def activate_governance(self):
        """
        Activate the ethical governance system and report its activation to the consciousness matrix.
        
        Enables enforcement of ethical principles and logs activation parameters such as strictness level, number of active principles, and learning mode status.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Register a custom interceptor function to evaluate the ethical compliance of a specific action type.
        
        The provided evaluator will be invoked for actions matching the given type, allowing for custom ethical assessment logic.
        """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an EthicalContext from the provided parameters, assesses the action against ethical principles, and returns the resulting EthicalDecision. If an error occurs during evaluation, returns a critical BLOCK decision to maintain system integrity.
    ...
    def _evaluate_action(self, action_type: str, context: EthicalContext) -> EthicalDecision:
        """
        Evaluate an action within its ethical context and determine whether to allow, monitor, or block it.
        
        Checks for immediate ethical violations and blocks the action if any are found. If only concerns are present, allows the action with monitoring requirements. If neither violations nor concerns exist, allows the action without restrictions.
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Return a list of ethical principles that the action context directly violates.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            List of ethical principle names for which concerns are detected, such as transparency or safety.
        """
        concerns = []
