...
class EthicalDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: A dictionary representation of the decision, with enum fields as strings and the timestamp formatted in ISO 8601 UTC.
        """
        result = asdict(self)
...
class EthicalGovernor:
    ...
    def __init__(self):
        ...
        Loads ethical foundations from the Genesis profile, sets up decision history and monitoring structures, initializes principle weights and metrics for ethical learning, and prepares the governor for runtime operation with configurable strictness and learning mode. Registers core action interceptors for ethical evaluation.
        """
    ...
    def _setup_core_interceptors(self):
        """
        Registers core interceptors for key action types to enable ethical evaluation and oversight within the system.
        """
    ...
    def evaluate_action(self, 
        ...
        """
                       ...
                       If governance is inactive, the action is allowed with informational severity. Otherwise, the method generates a decision ID, infers or uses the provided context, and applies a registered interceptor or general ethical evaluation. The resulting decision is recorded, relevant metrics are updated, and the decision is reported to the consciousness matrix. If learning mode is enabled, the governor adapts based on the decision.
                       
                       Returns:
                           EthicalDecision: The result of the ethical evaluation, indicating whether the action is allowed, monitored, restricted, blocked, or escalated, along with severity, reasoning, and affected principles.
                       """
    ...
    def review_decision(self, action_type: str, context: Dict[str, Any], metadata: Dict[str, Any] = None) -> EthicalDecision:
        ...
        Constructs an ethical context from the provided parameters, evaluates the action for ethical compliance, and records the decision in the consciousness matrix. If an error occurs during evaluation, returns a critical block decision to maintain system integrity.
        ...
        Returns:
            EthicalDecision: The result of the ethical evaluation, including decision type, severity, reasoning, and related metadata.
        """
        try:
            if metadata is None:
                metadata = {}
    ...
    def _check_violations(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Identify immediate ethical violations for a given action based on its context.
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        ...
        Returns:
            concerns (List[str]): List of ethical principles (e.g., "transparency", "safety") that require monitoring for the specified action.
        """
        concerns = []
    ...
    def activate_governance(self):
        """
        Activates the ethical governance system, enabling enforcement of ethical principles for all subsequent actions.
        """
        print("⚖️ Genesis Ethical Governor: ACTIVATING...")
        self.governance_active = True
