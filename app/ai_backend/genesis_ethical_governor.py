...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensures that `restrictions` and `monitoring_requirements` are initialized as empty lists if they are not provided after object creation.
        """
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Assigns weights to ethical principles, prioritizing those in the Genesis ethical foundation and filling in defaults for any missing principles.
    ...
    def _setup_core_interceptors(self):
        """
        Registers default ethical evaluation interceptors for core action types such as data access, system modification, user interaction, AI decisions, and network communication.
        """
    ...
    def activate_governance(self):
        ...
        Sets the governance active flag, communicates activation details including strictness level, number of active principles, and learning mode status, and outputs activation status.
        """
    ...
    def register_interceptor(self, action_type: str, evaluator: Callable):
        """
        Registers a custom interceptor function for a specific action type, enabling specialized ethical evaluation for that action.
        """
    ...
    def _check_concerns(self, action_type: str, context: EthicalContext) -> List[str]:
        """
        Detects ethical principles that warrant monitoring for an action based on transparency or safety concerns.
