...
class EthicalDecision:
    ...
    def __post_init__(self):
        """
        Ensures that restrictions and monitoring requirements are set to empty lists if they are not provided during initialization.
        """
...
class EthicalGovernor:
    ...
    def _initialize_principle_weights(self) -> Dict[str, float]:
        """
        Generate a dictionary mapping ethical principles to their assigned weights, prioritizing those in the Genesis ethical foundation and filling in defaults for any missing principles.
