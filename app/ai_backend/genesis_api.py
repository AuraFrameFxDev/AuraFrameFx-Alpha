...
class GenesisAPI:
    ...
    async def shutdown(self):
        ...
        After shutdown, sets `is_running` to False. Errors encountered during shutdown are logged.
        """
        try:
...
def reset_session():
    ...
    Returns:
        Response: A JSON response indicating whether the reset was successful, including status, message, and timestamp on success, or an error message with HTTP 500 status on failure.
    """
    try:
