...
class GenesisAPI:
    ...
    async def shutdown(self):
        ...
        After shutdown, the `is_running` attribute is set to False. Any errors encountered during shutdown are logged.
        """
        try:
...
def get_status():
    ...
    Returns:
        Response: Flask JSON response with the Genesis Layer's status information, or an error message with HTTP 500 status code if retrieval fails.
    """
    try:
