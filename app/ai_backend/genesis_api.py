...
def run_async(coro):
    ...
    Intended for use in synchronous contexts, such as Flask route handlers, to facilitate integration with asynchronous backend operations.
...
def initialize_app():
    """
    Asynchronously initializes the Genesis Layer before handling the first client request.
    """
